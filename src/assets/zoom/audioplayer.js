    ...
    $.fn.audioplayer = function(o) {
        ...
        this.each(function() {
            ...
            function setup_playlist_inner(pargs) {
                ...
                console.info('setup_playlist_inner() dzsap_list_for_sync_players -4 ',dzsap_list_for_sync_players,margs);
            ...
            function check_multisharer(){
                ...
                if(sw_enable_multisharer){
                    setTimeout(function(){
                        ...
                        // console.info('window.dzsap_multisharer_assets_loaded - ',window.dzsap_multisharer_assets_loaded);
...
//                            console.info(auxa);
    ...
    window.dzsap_init = function(selector, settings) {
        ...
        if(typeof(settings) != "undefined"  && typeof(settings.construct_player_list_for_sync) != "undefined"  && settings.construct_player_list_for_sync=='on'){
            ...
            // console.info('dzsap_list_for_sync_players -5 ',dzsap_list_for_sync_players);
...
jQuery(document).ready(function($) {
    ...
    function open_dzsap_lightbox(pargs) {
        ...
        // console.info('open_dzsap_lightbox() _c -> ',_c_mc, _c_mc.find('.social-networks-con'), 'margs - ',margs);
        ...
        if(window.dzsap_box_main_con){
            ...
            console.info('window.dzsap_box_main_con - ',window.dzsap_box_main_con);
            ...
            // console.info(' o - ',o, cthis,'dzsap_currplayer_from_share - ',dzsap_currplayer_from_share);
            if(window.dzsap_currplayer_from_share && dzsap_currplayer_from_share.data('embed_code') ){

                console.info('o.embed_code - ',dzsap_currplayer_from_share.data('embed_code'));
    ...
    $(document).on('click','.dzsap-like-but',function (e){
        ...
        var _t = $(this);
        window.dzsap_submit_like(_t.attr('data-post_id'),e);

        return false;
    })

    $(document).on('click','.dzsap-rectract-like-but',function (e){
...
window.dzsap_wp_send_contor_60_secs = function(argcthis, argtitle){
    ...
    // console.info('dzsap_wp_send_contor_60_secs()',argcthis,argtitle);
