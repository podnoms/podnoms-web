...
function dzsap_generate_keyboard_tooltip(keyboard_controls, lab) {
    ...
    var fout =
        '<span class="dzstooltip arrow-from-start transition-slidein arrow-bottom skin-black" style="width: auto;  white-space:nowrap;">' +
        'Shortcut' +
        ': ' +
        keyboard_controls[lab] +
        '</span>';
    // left: 5px;
        ...
        $.fn.audioplayer = function(o) {
            var defaults = {
                ...
                skinwave_comments_avatar:
                    'http://www.gravatar.com/avatar/00000000000000000000000000000000?s=20', // -- default image
            ...
            this.each(function() {
                ...
                var animation_flip = true,
                    ...
                    animation_play =
                        'M11,10 L17,10 17,26 11,26 M20,10 L26,10 26,26 20,26';
                ...
                o.settings_trigger_resize = parseInt(
                ...
                settings_extrahtml_in_float_right =
                    o.settings_extrahtml_in_float_right;

                if (
                    cthis.children('.extra-html-in-controls-right').length > 0
                ) {
                    settings_extrahtml_in_float_right += cthis
                ...
                if (
                    cthis.children('.extra-html-in-controls-left').length > 0 &&
                    o.settings_extrahtml_in_float_left == ''
                ) {
                    o.settings_extrahtml_in_float_left = cthis
                ...
                if (settings_extrahtml_in_float_right) {
                    ...
                    settings_extrahtml_in_float_right = String(
                        settings_extrahtml_in_float_right
                    ).replace(/{{svg_share_icon}}/g, svg_share_icon);
                }
                ...
                function settle_sample_times() {
                    ...
                    if (
                        isNaN(Number(o.sample_time_start)) == false &&
                        ...
                        if (Number(o.sample_time_end) > 0) {
                            ...
                            if (Number(o.sample_time_total) > 0) {
                                ...
                                sample_perc_start =
                                    sample_time_start / sample_time_total;
                                sample_perc_end =
                                    sample_time_end / sample_time_total;
                            }
                        }
                    }
                    ...
                    if (
                        (sample_time_total && sample_time_start) ||
                        (pseudo_sample_time_start && pseudo_sample_time_end)
                    ) {
                        is_sample = true;
                    } else {
                        is_sample = false;
                ...
                function init() {
                    ...
                    if (cthis.attr('data-userstarrating')) {
                        starrating_alreadyrated = Number(
                            cthis.attr('data-userstarrating')
                        );
                    }
                    ...
                    if (cthis.attr('data-playerid')) {
                        ...
                        // console.log('the_player_id - ',the_player_id);
                        if (the_player_id == '') {
                            the_player_id = dzs_clean_string(
                    ...
                    if (
                        o.mobile_disable_fakeplayer == 'on' &&
                        dzsap_is_mobile()
                    ) {
                    ...
                    if (cthis.attr('data-fakeplayer')) {
                        ...
                        if (_c.length == 0) {
                            _c = $(
                                String(cthis.attr('data-fakeplayer')).replace(
                                    '#',
                                    '.'
                                )
                            );
                    ...
                    if (
                        cthis.children('.extra-html').length > 0 &&
                        o.settings_extrahtml == ''
                    ) {
                        o.settings_extrahtml = cthis
                            .children('.extra-html')
                            .eq(0)
                            .html();
                        ...
                        if (
                            re_ratesubmitted.test(String(o.settings_extrahtml))
                        ) {
                            re_ratesubmitted.lastIndex = 0;
                            var auxa = re_ratesubmitted.exec(
                                String(o.settings_extrahtml)
                            );

                            starrating_alreadyrated = auxa[1];

                            o.settings_extrahtml = String(
                                o.settings_extrahtml
                            ).replace(re_ratesubmitted, '');

                            if (
                                o.parentgallery &&
                                $(o.parentgallery).get(0) != undefined &&
                    ...
                    if (o.construct_player_list_for_sync == 'on') {
                        if (dzsap_list_for_sync_sw_built == false) {
                            ...
                            $(
                                ...
                                if (
                                    _t23.attr('data-do-not-include-in-list') !=
                                    'on'
                                ) {
                            ...
                            dzsap_list_for_sync_inter_build = setTimeout(
                                function() {
                    ...
                    if (playfrom == 'off' || playfrom == '') {
                        if (get_query_arg(window.location.href, 'audio_time')) {
                            playfrom = sanitize_from_point_time(
                                get_query_arg(
                    ...
                    if (pcm_identifier == 'dzs_footer') {
                        pcm_identifier = dzs_clean_string(
                            cthis.attr('data-source')
                        );
                    }
                    ...
                    if (type == 'normal' || type == 'audio') {
                        if (
                            cthis.attr('data-streamtype') &&
                            cthis.attr('data-streamtype') != 'off'
                        ) {
                            type_normal_stream_type = cthis.attr(
                                'data-streamtype'
                            );
                    ...
                    if (
                        cthis.find('.the-comments').length > 0 &&
                        cthis
                            .find('.the-comments')
                            .eq(0)
                            .children().length > 0
                    ) {
                        _commentsChildren = cthis
                            .find('.the-comments')
                            .eq(0)
                            .children();
                    } else {
                    ...
                    if (
                        cthis.attr('data-source') != undefined &&
                        String(cthis.attr('data-source')).indexOf(
                    ...
                    if (
                        ...
                        (type == 'audio' ||
                            type == 'soundcloud' ||
                            type == 'fake') &&
                        o.skinwave_comments_enable == 'on'
                    ) {
                        var str_comments_holder =
                            '<div class="comments-holder">';

                        if (o.skinwave_comments_links_to) {
                            str_comments_holder +=
                                '<a href="' +
                                o.skinwave_comments_links_to +
                                '" target="_blank" class="the-bg"></a>';
                        } else {
                            str_comments_holder +=
                                '<div class="the-comments-holder-bg"></div>';
                        }
                        ...
                        _commentsWriter
                            .find('.cancel-ap-comment')
                            .bind('click', click_cancel_comment);
                        _commentsWriter
                            .find('.submit-ap-comment')
                            .bind('click', click_submit_comment);
                    }
                    ...
                    if (o.settings_extrahtml != '') {
                        ...
                        if (
                            _feed_extra_html &&
                            _feed_extra_html.attr('data-playerid')
                        ) {
                            _extra_html = _feed_extra_html.attr(
                                'data-playerid'
                            );
                        }
                        ...
                        if (
                            _feed_extra_html &&
                            _feed_extra_html.attr('data-posttype')
                        ) {
                            _extra_html = _feed_extra_html.attr(
                                'data-posttype'
                            );
                        ...
                        if (o.cue == 'on' && type != 'soundcloud') {
                            ...
                            if (dataSrc.indexOf('{{generatenonce}}') > -1) {
                                ...
                                if (type_normal_stream_type != 'icecast') {
                                    ...
                                    if (
                                        type_normal_stream_type == 'shoutcast'
                                    ) {
                            ...
                            cthis
                                .find('.playbtn')
                                .bind('click', click_for_setup_media);
                            cthis
                                .find('.scrubbar')
                                .bind('click', click_for_setup_media);
                            handleResize();
                    ...
                    if (_sticktobottom) {
                        ...
                        _sticktobottom.addClass(
                            'dzsap-sticktobottom-for-' + o.design_skin
                        );
                        _sticktobottom
                            .prev()
                            .addClass(
                    ...
                    cthis.get(
                        0
                    ).api_click_for_setup_media = click_for_setup_media; // -- play the media
                    ...
                    cthis.get(
                        0
                    ).api_change_visual_target = change_visual_target; // -- play the media, but only visually
                    cthis.get(
                        0
                    ).api_change_design_color_highlight = change_design_color_highlight; // -- play the media, but only visually
                    ...
                    cthis.get(
                        0
                    ).api_sync_players_goto_next = sync_players_goto_next;
                    cthis.get(
                        0
                    ).api_sync_players_goto_prev = sync_players_goto_prev;
                        ...
                        if (pseudo_sample_time_start == 0) {
                            if (sample_time_start > 0) {
                                time_curr_for_visual =
                                    sample_time_start + time_curr_for_visual;
                            }
                        }
                    ...
                    cthis.on(
                        'click',
                        '.dzsap-repeat-button,.dzsap-loop-button,.btn-zoomsounds-download,.zoomsounds-btn-step-backward,.zoomsounds-btn-step-forward,.zoomsounds-btn-go-beginning,.zoomsounds-btn-slow-playback,.zoomsounds-btn-reset, .playlist-menu-item, .tooltip-indicator--btn-footer-playlist',
                        handle_mouse
                    );
                    ...
                    if (_scrubbar && _scrubbar.get(0)) {
                        _scrubbar.get(0).addEventListener(
                            'touchstart',
                            function(e) {
                                if (player_playing) {
                    ...
                    if (
                        type_normal_stream_type == 'icecast' ||
                        type_normal_stream_type == 'shoutcast'
                    ) {
                        icecast_shoutcast_get_data();
                    }
                    ...
                    if (o.skinwave_comments_mode_outer_selector) {
                        _commentsSelector = $(
                            o.skinwave_comments_mode_outer_selector
                        );
                        ...
                        if (_commentsSelector.data) {
                            ...
                            if (
                                ...
                                o.skinwave_comments_account != 'none'
                            ) {
                                _commentsSelector
                                    .find('.comment_email,*[name=comment_user]')
                                    .remove();
                            }

                            _commentsSelector.on(
                                'click',
                ...
                function icecast_shoutcast_get_data() {
                    ...
                    if (type_normal_stream_type == 'shoutcast') {
                        url = add_query_arg(
                            o.settings_php_handler,
                            'action',
                            'dzsap_shoutcast_get_streamtitle'
                        );
                ...
                function check_every_05_secs() {
                    ...
                    if (cthis.hasClass('first-played') == false) {
                        if (
                            !cthis.attr('data-playfrom') ||
                            cthis.attr('data-playfrom') == '0'
                        ) {
                ...
                function comments_selector_event(e) {
                    ...
                    if (
                        _t
                            .parent()
                            .parent()
                            .hasClass('zoomsounds-comment-wrapper')
                    ) {
                    ...
                    if (e.type == 'focusin') {
                        ...
                        var spx =
                            (time_curr / time_total) * _commentsHolder.width();
                        spx += 'px';
                        // console.log(spx);
                ...
                function calculate_dims_time() {
                    var reflection_size = parseFloat(
                        o.skinwave_wave_mode_canvas_reflection_size
                    );
                    ...
                    if (o.design_skin == 'skin-wave') {
                        ...
                        if (_commentsHolder) {
                            if (reflection_size == 0) {
                                ...
                                _commentsHolder.css(
                                    'top',
                                    _scrubbar.offset().top -
                                        cthis.offset().top +
                                        scrubbarh * reflection_size -
                                        _commentsHolder.height()
                                );
                            } else {
                ...
                function change_design_color_highlight(arg) {
                    ...
                    if (o.skinwave_wave_mode == 'canvas') {
                        draw_canvas(
                            _scrubbarbg_canvas.get(0),
                            cthis.attr('data-pcm'),
                            '#' + o.design_wave_color_bg,
                            { call_from: 'canvas_change_pcm_bg' }
                        );
                        draw_canvas(
                            _scrubbarprog_canvas.get(0),
                            cthis.attr('data-pcm'),
                ...
                function change_media(arg, pargs) {
                    ...
                    if (margs.fakeplayer_is_feeder == 'on') {
                        ...
                        if (_feed_fakePlayer.attr('data-watermark-volume')) {
                            margs.watermark_volume = _arg.attr(
                                'data-watermark-volume'
                            );
                        }
                        if (_feed_fakePlayer.attr('data-sample_time_start')) {
                            cthis.attr(
                                'data-sample_time_start',
                                _arg.attr('data-sample_time_start')
                            );
                        } else {
                            cthis.attr('data-sample_time_start', '');
                        }
                        if (_feed_fakePlayer.attr('data-sample_time_end')) {
                            cthis.attr(
                                'data-sample_time_end',
                                _arg.attr('data-sample_time_end')
                            );
                        } else {
                            cthis.attr('data-sample_time_end', '');
                        }
                        if (
                            _feed_fakePlayer.attr(
                        ...
                        if (
                            _feed_fakePlayer.attr('data-pseudo-sample_time_end')
                        ) {
                            cthis.attr(
                        ...
                        if (_feed_fakePlayer.attr('data-sample_time_total')) {
                            cthis.attr(
                                ...
                                _arg.attr('data-sample_time_total')
                            );
                        } else {
                            cthis.attr('data-sample_time_total', '');
                        }
                    ...
                    if (_arg) {
                        ...
                        if (
                            _arg.find('.meta-artist').length > 0 ||
                            _arg.find('.meta-artist-con').length > 0
                        ) {
                            margs.artist = _arg
                                .find('.the-artist')
                                .eq(0)
                                .html();
                            margs.song_name = _arg
                                .find('.the-name')
                                .eq(0)
                                .html();
                        }
                        ...
                        if (
                            _arg.find('.feed-song-name').length > 0 ||
                            _arg.find('.feed-artist-name').length > 0
                        ) {
                            margs.artist = _arg
                                .find('.feed-artist-name')
                                .eq(0)
                                .html();
                            margs.song_name = _arg
                                .find('.feed-song-name')
                    ...
                    if (_feed_fakePlayer) {
                        if (_feed_fakePlayer.attr('data-playerid')) {
                            pcm_identifier = _feed_fakePlayer.attr(
                                'data-playerid'
                            );
                        } else {
                    ...
                    if (_playlistTooltip) {
                        var ind = 0;
                        var _cach = _playlistTooltip.children(
                            '.dzstooltip--inner'
                        );
                    ...
                    if (_feed_fakePlayer) {
                        ...
                        if (
                            _feed_fakePlayer.find(
                                '.feed-dzsap-for-extra-html-right'
                            ).length
                        ) {
                            cthis
                                .find('.extrahtml-in-float-right')
                                .eq(0)
                                .html(
                                    _feed_fakePlayer
                                        .find(
                    ...
                    if (
                        original_type == 'soundcloud' &&
                        margs.source.indexOf('api.soundcloud') == -1
                    ) {
                            ...
                            if (o.skinwave_comments_process_in_php == 'on') {
                                if (
                                    ...
                                    if (
                                        ...
                                        _c.find('.dzstooltip').before(
                                            _c.find('.tooltip-indicator')
                                        );
                ...
                function click_for_setup_media(e, pargs) {
                    ...
                    cthis
                        .find('.playbtn')
                        .unbind('click', click_for_setup_media);
                    cthis
                        .find('.scrubbar')
                        .unbind('click', click_for_setup_media);
                ...
                function click_menu_state(e) {
                    if (
                        o.parentgallery &&
                        typeof o.parentgallery.get(0) != 'undefined'
                    ) {
                ...
                function click_comments_bg(e) {
                    ...
                    if (
                        o.skinwave_comments_allow_post_if_not_logged_in ==
                            'off' &&
                        o.skinwave_comments_account == 'none'
                    ) {
                        return false;
                    ...
                    _commentsHolder.children().each(function() {
                        ...
                        if (Math.abs(lmx2 - lmx) < 20) {
                            _commentsHolder
                                .find('.dzstooltip-con.placeholder')
                                .remove();
                            sw = false;
                    ...
                    var comments_offset =
                        _commentsHolder.offset().left - cthis.offset().left;

                    var aux3 =
                        lmx + comments_offset - _commentsWriter.width() / 2 + 7;
                    ...
                    if (aux3 < comments_offset) {
                        ...
                        if (
                            aux3 >
                            tw - comments_offset - _commentsWriter.width() / 2
                        ) {
                            aux4 =
                                lmx -
                                (_commentsWriter.offset().left -
                                    cthis.offset().left) +
                                _commentsWriter.width() / 3;
                            aux3 =
                                tw -
                                comments_offset -
                                _commentsWriter.width() / 2;
                ...
                function add_comments_placeholder(sposarg) {
                    ...
                    _commentsHolder.append(
                        '<style class="dzsap-style-comments">.dzstooltip-con:not(.placeholder) { opacity: 0.5; }</style>'
                    );
                    _commentsHolder
                        .find('.dzstooltip-con.placeholder')
                        .remove();
                ...
                function comment_submit(
                    ...
                    if (comment_email) {
                        ...
                        if (_commentsSelector) {
                            _commentsSelector
                                .find(
                                    '*[name=comment_email],*[name=comment_user]'
                                )
                                .remove();
                        }
                    ...
                    if (o.skinwave_comments_process_in_php != 'on') {
                        ...
                        aux +=
                            '<span class="dzstooltip-con zoomsounds-comment" style="left:' +
                            sposarg +
                            '"><div class="the-avatar tooltip-indicator" style="background-image: url(' +
                            o.skinwave_comments_avatar +
                            ')"></div><span class="dzstooltip arrow-bottom style-rounded color-dark-light talign-start  transition-slidein arrow-bottom " style="width: 250px;"><span class="dzstooltip--inner"><span class="the-comment-author">@' +
                            comm_author +
                            '</span> says:<br>';
                    ...
                    cthis
                        .find('*[name=comment-text]')
                        .eq(0)
                        .val('');

                    cthis
                        .find(
                            '.comments-writter-temp-css,.dzsap-style-comments'
                        )
                        .remove();
                ...
                function hide_comments_writer() {
                    ...
                    if (
                        o.parentgallery &&
                        $(o.parentgallery).get(0) != undefined &&
                        $(o.parentgallery).get(0).api_handleResize != undefined
                    ) {
                        $(o.parentgallery)
                            .get(0)
                            .api_handleResize();
                                ...
                                if (is_safari()) {
                                    if (_cmedia.readyState >= 1) {
                                        ...
                                        if (o.action_audio_loaded_metadata) {
                                            o.action_audio_loaded_metadata(
                                                cthis
                                            );
                                        }
                                    }
                                ...
                                success: function(response) {
                                    ...
                                    if (response) {
                                        if (
                                            ...
                                            init_generate_wave_data({
                                                call_from:
                                                    'no response from pcm ajax, generate it'
                                            });
                                        }
                                        ...
                                        if (o.cue == 'on') {
                                            ...
                                            init_generate_wave_data({
                                                call_from:
                                                    'pcm_data_try_to_generate .. no data-pcm'
                                            });
                                        } else {
                                            pcm_promise_generate_on_meta_load = true; // -- we are promising generating on meta load
                                            if (
                                                o.pcm_data_try_to_generate_wait_for_real_pcm ==
                                                'on'
                                            ) {
                    ...
                    if (window.WaveSurfer) {
                        ...
                        for (var i23 in scripts) {
                            if (scripts[i23] && scripts[i23].src) {
                                if (
                                    scripts[i23].src.indexOf('audioplayer.js') >
                                    -1
                                ) {
                                    break;
                                }
                        ...
                        if (dzsap_wavesurfer_load_attempt > 2) {
                            url =
                                'https://unpkg.com/wavesurfer.js@2.1.3/dist/wavesurfer.min.js';
                        }
                ...
                function send_pcm(ar_str) {
                    ...
                    console.log(
                        '%c pcm_identifier before- ',
                        'color: #dd0022; background-color: #eee;',
                        pcm_identifier,
                        cthis
                    );
                    if (pcm_identifier == '') {
                ...
                function generate_wave_data(pargs) {
                    ...
                    wavesurfer.on('ready', function() {
                        ...
                        if (wavesurfer && wavesurfer.exportPCM) {
                            ar_str = wavesurfer.exportPCM(
                                o.wavesurfer_pcm_length,
                                accuracy,
                                true
                            );
                        } else {
                ...
                function generate_wave_data_animate(argpcm) {
                    ...
                    _scrubbar
                        .find('.scrub-bg-img,.scrub-prog-img')
                    ...
                    _scrubbarbg_canvas = cthis.find(
                        '.scrub-bg-img.transitioning-in'
                    );
                    _scrubbarprog_canvas = cthis.find(
                    ...
                    draw_canvas(
                        ...
                        {
                            call_from:
                                'canvas_generate_wave_data_animate_pcm_bg'
                        }
                    );
                    draw_canvas(
                        _scrubbarprog_canvas.get(0),
                        ...
                        {
                            call_from:
                                'canvas_generate_wave_data_animate_pcm_prog'
                        }
                    );
                ...
                function struct_generate_thumb() {
                    ...
                    if (cthis.attr('data-thumb')) {
                        ...
                        if (cthis.children('.the-thumb-con').length) {
                            aux_thumb_con_str = cthis
                                .children('.the-thumb-con')
                                .eq(0);
                        }
                        ...
                        _theThumbCon = _audioplayerInner
                            .children('.the-thumb-con')
                            .eq(0);
                    } else {
                        cthis.removeClass('has-thumb');
                ...
                function apply_skinwave_mode_class() {
                    ...
                    if (o.design_skin == 'skin-wave') {
                        ...
                        cthis.addClass(
                            'skin-wave-wave-mode-' + o.skinwave_wave_mode
                        );
                        ...
                        cthis.addClass(
                            'skin-wave-wave-mode-canvas-mode-' +
                ...
                function playlist_goto_item(arg, pargs) {
                    ...
                    if (_playlistTooltip) {
                        ...
                        var _cach = $(
                            '.audioplayer[data-playerid="' +
                                playerid +
                                '"],.audioplayer-tobe[data-playerid="' +
                                playerid +
                                '"]'
                        );
                        ...
                        if (
                            ...
                            _cach.length &&
                            _cach.eq(0).get(0) &&
                            _cach.eq(0).get(0).api_play_media
                        ) {
                            $('.audioplayer[data-playerid="' + playerid + '"]')
                                .eq(0)
                                .get(0)
                                .api_play_media({
                ...
                function setup_playlist_inner(pargs) {
                    ...
                    if (_playlistTooltip) {
                        ...
                        for (var lab in dzsap_list_for_sync_players) {
                            ...
                            if (
                                _c.hasClass('number-wrapper') ||
                                _c.hasClass('for-number-wrapper')
                            ) {
                                continue;
                            }
                            ...
                            aux +=
                                '<div class="pi-thumb divimage" style="background-image: url(' +
                                _c.attr('data-thumb') +
                                ')">';
                            aux += '</div>';
                            aux += '</div>';
                        ...
                        $(document).on(
                            ...
                            function(e) {
                                if (window.dzsap_moving_playlist_item) {
                                    ...
                                    dzsap_playlist_item_moving.css(
                                        'top',
                                        my - 20
                                    );

                                    dzsap_playlist_item_target
                                        .parent()
                                        .children(
                                            ':not(".target-playlist-item"):not(".cloner")'
                                        )
                                        .each(function() {
                                            var _t = $(this);
                        ...
                        $(document).on('mouseup.dzsap_playlist_item', function(
                            e
                        ) {
                            if (window.dzsap_moving_playlist_item) {
                                window.dzsap_moving_playlist_item = false;

                                dzsap_playlist_item_moving
                                    .parent()
                                    .children('.cloner')
                                    .remove();
                                dzsap_playlist_item_target.removeClass(
                ...
                function setup_structure(pargs) {
                    ...
                    if (margs.setup_inner_player) {
                        ...
                        _audioplayerInner = cthis.children(
                            '.audioplayer-inner'
                        );
                    }

                    if (margs.setup_media) {
                        _audioplayerInner.append(
                            '<div class="the-media"></div>'
                        );
                        _theMedia = _audioplayerInner
                            .children('.the-media')
                            .eq(0);
                    }
                    ...
                    _apControls = _audioplayerInner
                        .children('.ap-controls')
                        .eq(0);
                    ...
                    if (o.settings_extrahtml_before_play_pause) {
                        struct_con_playpause +=
                            o.settings_extrahtml_before_play_pause;
                    }
                    ...
                    if (cthis.find('.feed-dzsap-before-playpause').length) {
                        struct_con_playpause += cthis
                            .find('.feed-dzsap-before-playpause')
                            .eq(0)
                            .html();
                    ...
                    struct_con_playpause += '">';
                    if (keyboard_controls.show_tooltips == 'on') {
                        struct_con_playpause += dzsap_generate_keyboard_tooltip(
                            keyboard_controls,
                            'pause_play'
                        );
                    }
                    ...
                    struct_con_playpause +=
                        '<div class="playbtn"><div class="the-icon-bg"></div><div class="dzsap-play-icon">';

                    var has_svg_icons = false;

                    if (
                        cthis.hasClass('button-aspect-noir') ||
                        cthis.hasClass('skin-pro') ||
                        cthis.hasClass('skin-silver') ||
                        cthis.hasClass('skin-redlights') ||
                        cthis.hasClass('skin-default')
                    ) {
                        has_svg_icons = true;
                    }
                    ...
                    struct_con_playpause +=
                        '><div class="the-icon-bg"></div><div class="pause-icon"><div class="pause-part-1"></div><div class="pause-part-2"></div>';
                    ...
                    if (cthis.find('.feed-dzsap-after-playpause').length) {
                        struct_con_playpause += cthis
                            .find('.feed-dzsap-after-playpause')
                            .eq(0)
                            .html();
                    ...
                    if (
                        ...
                        aux_str_con_controls =
                            ...
                            '<div class="ap-controls-right">' +
                            aux_str_con_volume +
                            '<div class="extrahtml-in-float-right for-skin-wave-small">' +
                            settings_extrahtml_in_float_right +
                            '</div></div>';
                        ...
                        if (
                            ...
                            if (o.design_skin == 'skin-silver') {
                                ...
                                if (keyboard_controls.show_tooltips == 'on') {
                                    aux_str_con_controls += dzsap_generate_keyboard_tooltip(
                                        keyboard_controls,
                                        'pause_play'
                                    );
                                }
                                ...
                                aux_str_con_controls +=
                                    '<div class="playbtn"><div class="dzsap-play-icon">' +
                                    playbtn_svg +
                                    '</div><div class="play-icon-hover"></div></div><div class="pausebtn" ';
                            ...
                            if (
                                cthis.find('.feed-dzsap-after-playpause').length
                            ) {
                                aux_str_con_controls += cthis
                                    .find('.feed-dzsap-after-playpause')
                                    .eq(0)
                                    .html();
                            ...
                            if (cthis.hasClass('skin-wave-mode-alternate')) {
                                ...
                                _apControls.append(
                                    aux_str_scrubbar + aux_str_con_controls
                                );
                            }
                        }
                    }
                    ...
                    if (_apControls.find('.ap-controls-left').length > 0) {
                        _apControlsLeft = _apControls
                            .find('.ap-controls-left')
                            .eq(0);
                    }

                    if (o.design_skin == 'skin-pro') {
                        _apControlsRight = cthis
                            .find('.con-controls--right')
                            .eq(0);
                    }
                    ...
                    if (settings_extrahtml_in_float_right) {
                        ...
                        if (
                            String(settings_extrahtml_in_float_right).indexOf(
                                'dzsap-multisharer-but'
                            ) > -1
                        ) {
                        ...
                        if (
                            ...
                            finstring +=
                                '<div class="extrahtml-in-float-right from-setup_structure from-js-setup_structure">' +
                                settings_extrahtml_in_float_right +
                                '</div>';
                        }
                    ...
                    if (o.footer_btn_playlist == 'on') {
                        if (
                            _apControlsRight.find('.btn-footer-playlist')
                                .length == 0
                        ) {
                            _apControlsRight.append(
                                '<div class="btn-footer-playlist for-hover dzstooltip-con player-but"> <div class="tooltip-indicator tooltip-indicator--btn-footer-playlist"><div class="the-icon-bg"></div> <svg class="svg-icon" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="13.25px" height="13.915px" viewBox="0 0 13.25 13.915" enable-background="new 0 0 13.25 13.915" xml:space="preserve"> <path d="M1.327,4.346c-0.058,0-0.104-0.052-0.104-0.115V2.222c0-0.063,0.046-0.115,0.104-0.115H11.58 c0.059,0,0.105,0.052,0.105,0.115v2.009c0,0.063-0.046,0.115-0.105,0.115H1.327z"/> <path d="M1.351,8.177c-0.058,0-0.104-0.051-0.104-0.115V6.054c0-0.064,0.046-0.115,0.104-0.115h10.252 c0.058,0,0.105,0.051,0.105,0.115v2.009c0,0.063-0.047,0.115-0.105,0.115H1.351z"/> <path d="M1.351,12.182c-0.058,0-0.104-0.05-0.104-0.115v-2.009c0-0.064,0.046-0.115,0.104-0.115h10.252 c0.058,0,0.105,0.051,0.105,0.115v2.009c0,0.064-0.047,0.115-0.105,0.115H1.351z"/> </svg>    </div><div class="dzstooltip playlist-tooltip style-default color-light-dark arrow-bottom talign-end transition-scaleup active2"><div class="dzstooltip--inner"> </div></div></div>'
                            );
                    ...
                    if (cthis.find('.feed-dzsap-after-con-controls').length) {
                        _apControls.append(
                            cthis
                                .find('.feed-dzsap-after-con-controls')
                                .eq(0)
                                .html()
                        );
                    ...
                    if (o.controls_external_scrubbar) {
                        _scrubbar = $(o.controls_external_scrubbar)
                            .children('.scrubbar')
                            .eq(0);
                    } else {
                    ...
                    if (!_metaArtistCon || margs.call_from == 'reconstruct') {
                        ...
                        _metaArtistCon = _audioplayerInner
                            .find('.meta-artist-con')
                            .eq(0);

                        if (o.design_skin == 'skin-wave') {
                            if (cthis.find('.dzsap-repeat-button').length) {
                                cthis
                                    .find('.dzsap-repeat-button')
                                    .after(_metaArtistCon);
                            } else {
                                if (
                                    cthis.find('.dzsap-loop-button').length &&
                                    cthis
                                        .find('.dzsap-loop-button')
                                        .eq(0)
                                        .parent()
                                        .hasClass(
                                            'feed-dzsap-for-extra-html-right'
                    ...
                    if (
                        ...
                        _metaArtistCon.find('.the-name').length &&
                        _metaArtistCon
                            .find('.the-name')
                            .eq(0)
                            .text().length > 0
                    ...
                    if (
                        o.design_skin == 'skin-wave' &&
                        o.parentgallery &&
                        typeof o.parentgallery != 'undefined' &&
                        o.design_menu_show_player_state_button == 'on'
                    ) {
                        if (o.design_skin == 'skin-wave') {
                            if (_apControlsRight) {
                    ...
                    if (o.settings_extrahtml_after_artist) {
                        _metaArtistCon
                            .find('.the-artist')
                            .append(o.settings_extrahtml_after_artist);
                    }
                    ...
                    if (
                        typeof o.parentgallery != 'undefined' &&
                        o.disable_player_navigation != 'on'
                    ) {
                    ...
                    if (cthis.hasClass('skin-minion')) {
                        if (cthis.find('.menu-description').length > 0) {
                            ...
                            _conPlayPause.prepend(
                                '<span class="dzstooltip" style="left:-7px;">' +
                                    cthis.find('.menu-description').html() +
                                    '</span>'
                            );
                    ...
                    if (o.player_navigation == 'default') {
                        ...
                        if (
                            o.parentgallery &&
                            o.parentgallery.hasClass('mode-showall')
                        ) {
                    ...
                    if (o.player_navigation == 'on') {
                        ...
                        if (
                            ...
                            if (o.design_skin == 'skin-wave') {
                                ...
                                if (o.player_navigation == 'on') {
                                    _conPlayPauseCon.prependOnce(
                                        prev_btn_str,
                                        '.prev-btn'
                                    );
                                    _conPlayPauseCon.appendOnce(
                                        next_btn_str,
                                        '.next-btn'
                                    );
                                }
                                ...
                                if (
                                    _apControlsLeft.children('.the-thumb-con')
                                        .length > 0
                                ) {
                    ...
                    if (o.settings_extrahtml != '') {
                        ...
                        if (
                            String(o.settings_extrahtml).indexOf(
                                '{{get_likes}}'
                            ) > -1
                        ) {
                        ...
                        o.settings_extrahtml = String(
                            o.settings_extrahtml
                        ).replace('{{heart_svg}}', svg_heart_icon);
                        o.settings_extrahtml = String(
                            o.settings_extrahtml
                        ).replace('{{embed_code}}', o.embed_code);
                        ...
                        setTimeout(function() {
                            ...
                            if (cthis.find('.float-left').length == 0) {
                                cthis
                                    .find('.extra-html')
                                    .append(cthis.find('.extra-html-extra'));
                            } else {
                                cthis
                                    .find('.extra-html .float-left')
                                    .append(cthis.find('.extra-html-extra'));
                            }
                            ...
                            if (
                                cthis
                                    .find('.extra-html')
                                    .html()
                                    .indexOf('dzsap-multisharer-but') > -1
                            ) {
                                sw_enable_multisharer = true;
                            }
                        }, 2000);
                    ...
                    if (cthis.find('.con-after-playpause').length) {
                        _conPlayPause.after(
                            cthis.find('.con-after-playpause').eq(0)
                        );
                    }

                    if (
                        cthis.hasClass('zoomsounds-wrapper-bg-bellow') &&
                        cthis.find('.dzsap-wrapper-buts').length == 0
                    ) {
                        ...
                        cthis
                            .find('.temp-wrapper')
                            .append(settings_extrahtml_in_float_right);
                        cthis
                            .find('.temp-wrapper')
                            .children('*:not(.dzsap-wrapper-but)')
                            .remove();
                        cthis
                            .find('.temp-wrapper > .dzsap-wrapper-but')
                            .unwrap();
                        cthis
                            .children('.dzsap-wrapper-but')
                            .each(function() {
                                var aux = $(this).html();
                                // console.log('aux - ',aux);
                    ...
                    if (cthis.hasClass('skinvariation-wave-bigtitles')) {
                        if (
                            cthis.find('.controls-volume').length &&
                            _metaArtistCon.find('.controls-volume').length == 0
                        ) {
                            _metaArtistCon.append('<br>');
                            _metaArtistCon.append(
                                cthis.find('.controls-volume')
                            );
                        }
                    ...
                    if (o.design_skin == 'skin-redlights') {
                        _apControlsRight.append(
                            '<div class="ap-controls-right--top"></div>'
                        );
                        _apControlsRight.append(
                            '<div class="ap-controls-right--bottom"></div>'
                        );
                        _apControlsRight
                            .find('.ap-controls-right--top')
                            .append(_apControlsRight.find('.meta-artist-con'));
                        _apControlsRight
                            .find('.ap-controls-right--top')
                            .append(_apControlsRight.find('.controls-volume'));
                        _apControlsRight
                            .find('.ap-controls-right--bottom')
                            .append(_apControlsRight.find('.scrubbar'));
                    }

                    if (margs.call_from == 'reconstruct') {
                        if (cthis.hasClass('skin-silver')) {
                            _apControlsLeft.append(
                                cthis.find('.con-playpause')
                            );
                        }
                    }
                    ...
                    if (sw_enable_multisharer) {
                        setTimeout(function() {
                            ...
                            if (window.dzsap_multisharer_assets_loaded) {
                                ...
                                if (
                                    window.dzsap_multisharer_assets_loaded !=
                                        true &&
                                    o.settings_php_handler &&
                                    ...
                                    setTimeout(function() {
                                        if (dzsap_box_main_con == null) {
                                            $('body').append(
                                                '<div class="dzsap-main-con skin-default gallery-skin-default transition-slideup "> <div class="overlay-background"></div> <div class="box-mains-con"> <div class="box-main box-main-for-share" style=""> <div class="box-main-media-con transition-target"> <div class="close-btn-con"> <svg enable-background="new 0 0 40 40" id="" version="1.1" viewBox="0 0 40 40" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M28.1,26.8c0.4,0.4,0.4,1,0,1.4c-0.2,0.2-0.5,0.3-0.7,0.3s-0.5-0.1-0.7-0.3l-6.8-6.8l-6.8,6.8c-0.2,0.2-0.5,0.3-0.7,0.3 s-0.5-0.1-0.7-0.3c-0.4-0.4-0.4-1,0-1.4l6.8-6.8l-6.8-6.8c-0.4-0.4-0.4-1,0-1.4c0.4-0.4,1-0.4,1.4,0l6.8,6.8l6.8-6.8 c0.4-0.4,1-0.4,1.4,0c0.4,0.4,0.4,1,0,1.4L21.3,20L28.1,26.8z"></path></g><g><path d="M19.9,40c-11,0-20-9-20-20s9-20,20-20c4.5,0,8.7,1.5,12.3,4.2c0.4,0.3,0.5,1,0.2,1.4c-0.3,0.4-1,0.5-1.4,0.2 c-3.2-2.5-7-3.8-11-3.8c-9.9,0-18,8.1-18,18s8.1,18,18,18s18-8.1,18-18c0-3.2-0.9-6.4-2.5-9.2c-0.3-0.5-0.1-1.1,0.3-1.4 c0.5-0.3,1.1-0.1,1.4,0.3c1.8,3.1,2.8,6.6,2.8,10.2C39.9,31,30.9,40,19.9,40z"></path></g></svg></div> <div class="box-main-media type-inlinecontent" style="width: 530px; height: 280px;"><div class=" real-media" style=""><div class="hidden-content share-content" > <div class="social-networks-con"></div> <div class="share-link-con"></div> <div class="embed-link-con"></div> </div> </div> </div> <div class="box-main-under"></div> </div> </div> </div><!-- end .box-mains-con--> </div>'
                                            );
                            ...
                            $(document).on(
                                'click.dzsap',
                                '.dzsap-main-con .close-btn-con,.dzsap-main-con .overlay-background',
                                function() {
                ...
                function setup_pcm_random_for_now(pargs) {
                    ...
                    if (o.pcm_data_try_to_generate == 'on') {
                        if (
                            o.pcm_data_try_to_generate_wait_for_real_pcm != 'on'
                        ) {
                ...
                function setup_structure_scrub() {
                    if (o.skinwave_enableSpectrum != 'on') {
                        ...
                        _scrubBgCanvasCtx = _scrubBgCanvas
                            .get(0)
                            .getContext('2d');
                    }
                }
                ...
                function draw_canvas(_arg, pcm_arr, hexcolor, pargs) {
                    ...
                    var bar_len = parseInt(
                        o.skinwave_wave_mode_canvas_waves_number
                    );
                    var bar_space = parseFloat(
                        o.skinwave_wave_mode_canvas_waves_padding
                    );
                    ...
                    for (var i = 0; i < bar_len; i++) {
                        ...
                        var barh_normal = Math.abs(
                            ar[searched_index] * chh * normal_size_ratio
                        );
                        ...
                        var y = Math.ceil(
                            chh * normal_size_ratio - barh_normal
                        );
                        if (o.skinwave_wave_mode_canvas_mode == 'reflecto') {
                            // y +=1 ;
                            barh_normal++;
                        ...
                        if (is_progress) {
                            ...
                            if (progress_hexcolors.length) {
                                ...
                                gradient.addColorStop(
                                    0,
                                    '#' + progress_hexcolors[0]
                                );
                                gradient.addColorStop(
                                    1,
                                    '#' + progress_hexcolors[1]
                                );
                            ...
                            if (is_sample) {
                                ...
                                if (
                                    ...
                                    if (
                                        margs.call_from.indexOf('pcm_prog') > -1
                                    ) {
                                        sw_draw = false;
                                    }
                                }
                    ...
                    if (reflection_size > 0) {
                        for (var i = 0; i < bar_len; i++) {
                            ...
                            var barh = Math.abs(ar[searched_index] * chh);
                            var barh_ref = Math.abs(
                                ar[searched_index] * chh * reflection_size
                            );
                            ...
                            if (is_progress) {
                                ...
                                if (
                                    margs.call_from == 'canvas_normal_pcm_prog'
                                ) {
                    ...
                    if (o.settings_php_handler) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                cthis
                                    .find(
                                        '.extra-html .counter-rates .the-number'
                                    )
                                    .eq(0)
                                    .html(starrating_nrrates);
                                index_extrahtml_toloads--;

                                cthis
                                    .find('.star-rating-set-clip')
                                    .width(
                                        auxresponse[0] *
                                            (parseInt(
                                                cthis
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (increment_views == 1) {
                                    ...
                                    response =
                                        Number(response) + increment_views;
                                    //console.log(response);
                                    increment_views = 2;
                                }
                            ...
                            success: function(response) {
                                ...
                                var aux =
                                    cthis
                                        .find('.star-rating-set-clip')
                                        .outerWidth() /
                                    cthis.find('.star-rating-bg').outerWidth();
                                var nrrates = parseInt(
                                    cthis
                                        .find('.counter-rates .the-number')
                                        .html(),
                                    10
                                );
                                ...
                                setTimeout(function() {
                                    cthis
                                        .find('.star-rating-con')
                                        .removeClass('just-rated');
                                }, 100);
                                cthis
                                    .find('.counter-rates .the-number')
                                    .html(resp_arr.number);

                                cthis
                                    .find('.star-rating-con')
                                    .attr(
                                        'data-initial-rating-index',
                                        Number(resp_arr.index) / 5
                                    );
                                cthis
                                    .find('.star-rating-con .rating-prog')
                                    .css(
                                        'width',
                                        (Number(resp_arr.index) / 5) * 100 + '%'
                                    );
                ...
                function skinwave_comment_publish(argp) {
                    ...
                    var data = {
                        ...
                        skinwave_comments_process_in_php:
                            o.skinwave_comments_process_in_php,
                    ...
                    if (o.settings_php_handler) {
                        $.ajax({
                            ...
                            success: function(response) {
                                if (
                                    response.charAt(response.length - 1) == '0'
                                ) {
                                ...
                                var aux = '';
                                if (
                                    o.skinwave_comments_process_in_php != 'on'
                                ) {
                                    // -- process the comment now, in javascript
                                    aux = data.postdata;
                                } else {
                                ...
                                _commentsHolder.children().each(function() {
                                    ...
                                    if (
                                        _t2.hasClass('dzstooltip-con') == false
                                    ) {
                ...
                function setup_media(pargs) {
                    ...
                    if (type == 'youtube') {
                        if (
                            o.settings_exclude_from_list != 'on' &&
                            dzsap_list &&
                            dzsap_list.indexOf(cthis) == -1
                        ) {
                            if (dzsap_list) {
                                if (
                                    cthis.attr('data-do-not-include-in-list') !=
                                    'on'
                                ) {
                    ...
                    if (
                        ...
                        str_audio_element =
                            str_open_audio_tag + aux_source + aux9;
                        ...
                        if (margs.call_from == 'change_media') {
                            ...
                            if (is_ios() || is_android()) {
                                if (
                                    margs.call_from == 'retrieve_soundcloud_url'
                                ) {
                                    setTimeout(function() {
                                        pause_media();
                                    }, 500);
                        ...
                        if (cthis.attr('data-soft-watermark')) {
                            ...
                            _theMedia.append(
                                '<audio class="the-watermark" preload="metadata" loop><source src="' +
                                    cthis.attr('data-soft-watermark') +
                                    '" /></audio>'
                            );
                            _cwatermark = _theMedia
                                .find('.the-watermark')
                                .get(0);

                            if (_cwatermark.volume) {
                                _cwatermark.volume =
                                    defaultVolume * o.watermark_volume;
                            }
                        ...
                        if (
                            ...
                            _cmedia.addEventListener(
                                ...
                                function(e) {
                                    ...
                                    if (
                                        noSourcesLoaded &&
                                        dzsap_is_mobile() == false
                                    ) {
                                        if (
                                            cthis.hasClass('errored-out') ==
                                            false
                                        ) {
                                            console.log(
                                                '%c could not load audio source - ',
                                                'color:#ff2222;',
                                                cthis.attr('data-source')
                                            );
                            ...
                            _cmedia.addEventListener(
                                ...
                                function(e) {
                                    ...
                                    if (margs.call_from == 'change_media') {
                                        if (
                                            cthis.hasClass('init-loaded') ==
                                            false
                                        ) {
                                            init_loaded({
                                                call_from:
                                                    'force_reload_change_media'
                                            });
                                        }
                                    }
                                },
                    ...
                    if (type != 'youtube') {
                        ...
                        if (
                            o.design_skin == 'skin-customcontrols' ||
                            o.design_skin == 'skin-customhtml'
                        ) {
                            cthis
                                .find('.custom-play-btn,.custom-pause-btn')
                                .off('click');
                            cthis
                                .find('.custom-play-btn,.custom-pause-btn')
                                .on('click', click_playpause);
                        }
                ...
                function setup_listeners() {
                    ...
                    if (o.settings_trigger_resize > 0) {
                        inter_trigger_resize = setInterval(
                            handleResize,
                            o.settings_trigger_resize
                        );
                    }
                ...
                function init_loaded(pargs) {
                    ...
                    if (_vc_tta_panel) {
                        ...
                        var _c = _vc_tta_panel
                            .parent()
                            .parent()
                            .parent()
                            .parent();
                        // console.log("_c - ",_c);
                        _c.find('.vc_tta-tab,.vc_tta-panel-heading').data(
                            'parent-tabs',
                            _c
                        );
                        ...
                        _c.on(
                            'click',
                            '.vc_tta-tab,.vc_tta-panel-heading',
                            function() {
                                var _t2 = $(this);
                    ...
                    if (
                        type != 'fake' &&
                        margs.call_from != 'force_reload_change_media'
                    ) {
                        if (
                            o.settings_exclude_from_list != 'on' &&
                            dzsap_list &&
                        ...
                        if (o.type_audio_stop_buffer_on_unfocus == 'on') {
                            cthis.data(
                                'type_audio_stop_buffer_on_unfocus',
                                'on'
                            );
                    ...
                    if (o.design_skin == 'skin-wave') {
                        if (o.skinwave_enableSpectrum == 'on') {
                            ...
                            if (audioCtx) {
                                ...
                                //if(!)
                                if (
                                    typeof audioCtx.createJavaScriptNode !=
                                    'undefined'
                                ) {
                                    javascriptNode = audioCtx.createJavaScriptNode(
                                        2048,
                                        1,
                                        1
                                    );
                                ...
                                if (
                                    typeof audioCtx.createScriptProcessor !=
                                    'undefined'
                                ) {
                                ...
                                if (is_android()) {
                                    ...
                                    if (javascriptNode) {
                                        ...
                                        if (type == 'audio') {
                                            ...
                                            var frameCount =
                                                audioCtx.sampleRate * 2.0;
                                            var audioCtx_buffer = audioCtx.createBuffer(
                                                2,
                                                frameCount,
                                                audioCtx.sampleRate
                                            );
                            ...
                            if (localStorage != null && the_player_id) {
                                ...
                                if (
                                    localStorage.getItem(
                                        'dzsap_last_volume_' + the_player_id
                                    )
                                ) {
                                    defaultVolume = localStorage.getItem(
                                        'dzsap_last_volume_' + the_player_id
                                    );
                                } else {
                                    defaultVolume = 1;
                    ...
                    if (margs.do_not_autoplay != true) {
                        if (o.autoplay == 'on' && o.cue == 'on') {
                            ...
                            play_media({
                                call_from:
                                    'do not autoplay not true ( init_loaded() ) '
                            });
                        }
                    }
                ...
                function handle_mouse(e) {
                    ...
                    if (e.type == 'click') {
                        ...
                        if (
                            _t.hasClass(
                                'tooltip-indicator--btn-footer-playlist'
                            )
                        ) {
                            _t.parent()
                                .find('.dzstooltip')
                            ...
                            var drawMeter = function() {
                                ...
                                if (debug_var) {
                                    ...
                                    if (
                                        lastarray[0] == 0 &&
                                        lastarray[
                                            Math.round(lastarray.length / 4)
                                        ] == 0 &&
                                        lastarray[
                                            Math.round(lastarray.length / 2)
                                        ] == 0 &&
                                        lastarray[
                                            Math.round(lastarray.length / 3 / 4)
                                        ] == 0
                                    ) {
                                        if (sw_spectrum_fakeit == 'auto') {
                                            sw_spectrum_fakeit = 'on';
                                            sw_spectrum_fakeit_decided =
                                                'lastarray0';
                                        }
                                    } else {
                                        if (
                                ...
                                if (lastarray && lastarray.length) {
                                    ...
                                    if (last_lastarray) {
                                        for (
                                            var i3 = 0;
                                            i3 < last_lastarray.length;
                                            i3++
                                        ) {
                                            begin_viy = last_lastarray[i3]; // -- last value
                                            change_viy =
                                                lastarray[i3] - begin_viy; // -- target value - last value
                                            duration_viy = 3;
                                            lastarray[i3] = Math.easeIn(
                                                1,
                                                begin_viy,
                                                change_viy,
                                                duration_viy
                                    ...
                                    var step = Math.round(
                                        lastarray.length / meterNum
                                    ); //sample limited data from the total array

                                    draw_canvas(
                                        _scrubBgCanvas.get(0),
                                        lastarray,
                                        '' + o.design_wave_color_bg,
                                        {
                                            call_from: 'spectrum'
                ...
                function draw_scrub_prog() {
                    ...
                    if (o.fakeplayer) {
                        if (
                            time_curr_for_visual > 0 &&
                            time_total_for_visual > 0
                        ) {
                            spos =
                                (time_curr_for_visual / time_total_for_visual) *
                                sw;
                        }
                ...
                function check_time(pargs) {
                    ...
                    if (
                        margs.fire_only_once == false &&
                        sw_suspend_enter_frame
                    ) {
                        requestAnimFrame(check_time);
                    ...
                    if (o.design_skin == 'skin-wave') {
                        if (o.skinwave_comments_displayontime == 'on') {
                            var timer_curr_perc =
                                Math.round(
                                    (real_time_curr / real_time_total) * 100
                                ) / 100;

                            if (type == 'fake') {
                                timer_curr_perc =
                                    Math.round((time_curr / time_total) * 100) /
                                    100;
                            }
                    ...
                    if (pseudo_sample_time_start) {
                        ...
                        if (pseudo_sample_time_end) {
                            if (time_curr > pseudo_sample_time_end) {
                                var args = {
                                    call_from:
                                        'time_curr>pseudo_sample_time_end'
                                };
                                handle_end(args);
                    ...
                    if (o.fakeplayer == null) {
                        if (pseudo_sample_time_start == 0) {
                            if (sample_time_start > 0) {
                                time_curr_for_visual =
                                    sample_time_start + time_curr_for_real;
                            }
                        }
                    }
                    ...
                    if (_feed_fakePlayer) {
                        ...
                        if (
                            _feed_fakePlayer.get(0) &&
                            _feed_fakePlayer.get(0).api_seek_to_visual
                        ) {
                        ...
                        if (!dzsap_can_canvas) {
                            ...
                            if (player_playing || first_drawn_canvas == false) {
                                if (skin_minimal_canvasplay) {
                                    var ctx_minimal = skin_minimal_canvasplay.getContext(
                                        '2d'
                                    );
                                    //console.log(ctx);
                                    ...
                                    spos =
                                        Math.PI * 2 * (time_curr / time_total);
                    ...
                    if (time_total > 1 && time_curr >= time_total - 0.07) {
                        var args = {
                            call_from:
                                'time_total > 0 && time_curr >= time_total - 0.07 ... '
                        };
                ...
                function click_playpause(e) {
                        ...
                        var it3 = setInterval(function() {
                            ...
                            if (
                                ...
                                if (_totalTime) {
                                    // console.error("ENTER HERE 9057");
                                    _totalTime.html(
                                        formatTime(time_total_for_visual)
                                    );
                                }
                    ...
                    if (o.design_skin == 'skin-minimal') {
                        var center_x =
                            _t.offset().left + skin_minimal_button_size / 2;
                        var center_y =
                            _t.offset().top + skin_minimal_button_size / 2;
                        var mouse_x = e.pageX;
                        var mouse_y = e.pageY;
                        ...
                        var AB = Math.sqrt(
                            Math.pow(mouse_x - center_x, 2) +
                                Math.pow(mouse_y - center_y, 2)
                        );
                        var AC = Math.sqrt(
                            Math.pow(pzero_x - center_x, 2) +
                                Math.pow(pzero_y - center_y, 2)
                        );
                        var BC = Math.sqrt(
                            Math.pow(pzero_x - mouse_x, 2) +
                                Math.pow(pzero_y - mouse_y, 2)
                        );

                        var angle = Math.acos((AB + AC + BC) / (2 * AC * AB));
                        var angle2 = Math.acos(
                            (mouse_x - center_x) /
                                (skin_minimal_button_size / 2)
                        );
                        ...
                        if (
                            Math.abs(mouse_y - center_y) > 20 ||
                            Math.abs(mouse_x - center_x) > 20
                        ) {
                            // console.log('perc - ',perc);
                            seek_to_perc(perc, {
                ...
                function sync_players_goto_prev() {
                    ...
                    if (
                        _playlistTooltip &&
                        _playlistTooltip.children('.dzstooltip--inner').length
                    ) {
                        ...
                        if (dzsap_list_for_sync_players.length > 0) {
                            for (var i24 in dzsap_list_for_sync_players) {
                                ...
                                if (
                                    dzsap_list_for_sync_players[i24].get(0) ==
                                    _ctarget.get(0)
                                ) {
                                    ...
                                    i24 = parseInt(i24, 10);
                                    if (i24 > 0) {
                                        var _c_ = dzsap_list_for_sync_players[
                                            i24 - 1
                                        ].get(0);
                ...
                function sync_players_goto_next() {
                    ...
                    if (
                        _playlistTooltip &&
                        _playlistTooltip.find('.playlist-menu-item').length
                    ) {
                        var tempNr = playlist_inner_currNr + 1;
                        ...
                        if (dzsap_list_for_sync_players.length > 0) {
                            for (var i24 in dzsap_list_for_sync_players) {
                                ...
                                if (
                                    ...
                                    if (
                                        tempNr >
                                        dzsap_list_for_sync_players.length - 1
                                    ) {
                                        // tempNr = 0;
                                    }
                                    ...
                                    if (
                                        tempNr <
                                        dzsap_list_for_sync_players.length
                                    ) {
                                        var _c_ = dzsap_list_for_sync_players[
                                            tempNr
                                        ].get(0);
                ...
                function handle_end(pargs) {
                    ...
                    setTimeout(function() {
                        ...
                        if (
                            _feed_fakePlayer &&
                            (_feed_fakePlayer.hasClass('is-single-player') ||
                                _feed_fakePlayer.hasClass(
                ...
                function handleResize(e, pargs) {
                    ...
                    if (
                        _scrubBgCanvas &&
                        typeof _scrubBgCanvas.width == 'function'
                    ) {
                        canw = _scrubBgCanvas.width();
                        canh = _scrubBgCanvas.height();
                    }
                    ...
                    if (o.design_skin == 'skin-wave') {
                        ...
                        if (_commentsHolder) {
                            ...
                            if (_scrubbar && cthis && _scrubbar.offset()) {
                                aux =
                                    _scrubbar.offset().left -
                                    cthis.offset().left;
                            } else {
                                console.log(
                                    'no scrubbar or cthis',
                                    _scrubbar,
                                    cthis
                                );
                            }
                    ...
                    if (res_thumbh == true) {
                        ...
                        if (o.design_skin == 'skin-default') {
                            ...
                            if (
                                typeof cthis.attr('data-initheight') ==
                                    'undefined' &&
                                cthis.attr('data-initheight') != ''
                            ) {
                                cthis.attr(
                                    'data-initheight',
                                    _audioplayerInner.height()
                                );
                            } else {
                                cthis_height = Number(
                                    cthis.attr('data-initheight')
                    ...
                    if (o.design_skin == 'skin-wave') {
                        ...
                        if (
                            _metaArtistCon &&
                            _metaArtistCon.css('display') != 'none'
                        ) {
                            if (
                                !(
                                    o.design_skin == 'skin-wave' &&
                        ...
                        if (
                            _controlsVolume &&
                            _controlsVolume.css('display') != 'none'
                        ) {
                    ...
                    if (o.design_skin == 'skin-default') {
                        if (_currTime) {
                            ...
                            var _metaArtistCon_l = parseInt(
                                _metaArtistCon.css('left'),
                                10
                            );
                    ...
                    if (o.design_skin == 'skin-minion') {
                        ...
                        aux2 =
                            ...
                            parseInt(_conControls.eq(0).offset().left, 10) -
                            18;
                        _conControls
                            .find('.prev-btn')
                            .eq(0)
                ...
                function mouse_volumebar(e) {
                    ...
                    if (e.type == 'mousemove') {
                        ...
                        if (volume_dragging) {
                            ...
                            if (
                                _t.parent().hasClass('volume-holder') ||
                                _t.hasClass('volume-holder')
                            ) {
                            }
                ...
                function handle_mouse_scrubbar(e) {
                    ...
                    if (
                        $(e.target).hasClass('sample-block-start') ||
                        $(e.target).hasClass('sample-block-end')
                    ) {
                        return false;
                    }
                    ...
                    if (e.type == 'mousemove') {
                        ...
                        if (o.scrub_show_scrub_time == 'on') {
                            ...
                            if (time_total) {
                                var aux =
                                    ((mousex - _scrubbar.offset().left) /
                                        _scrubbar.outerWidth()) *
                                    time_total;
                    ...
                    if (e.type == 'click') {
                        ...
                        var aux =
                            ((e.pageX - _scrubbar.offset().left) / sw) *
                            time_total;
                        ...
                        if (o.fakeplayer) {
                            ...
                            setTimeout(function() {
                                if (
                                    ...
                                    o.fakeplayer
                                        .get(0)
                                        .api_seek_to_perc(aux / time_total, {
                ...
                function seek_to(arg, pargs) {
                    ...
                    if (o.fakeplayer) {
                        ...
                        if (
                            o.fakeplayer.length &&
                            o.fakeplayer.data('feeding-from') != cthis.get(0)
                        ) {
                            console.log('margs - ', margs, 'arg - ', arg);
                            if (
                                margs.call_from != 'handle_end' &&
                                margs.call_from != 'from_playfrom' &&
                                margs.call_from != 'last_pos'
                            ) {
                    ...
                    if (type == 'audio') {
                        if (audioCtx_buffer && audioCtx_buffer != 'waiting') {
                            ...
                            if (
                                _cmedia &&
                                typeof _cmedia.currentTime != 'undefined'
                            ) {
                                try {
                ...
                function set_volume(arg, pargs) {
                    ...
                    if (
                        margs.call_from ==
                        'from_fake_player_feeder_from_init_loaded'
                    ) {
                    ...
                    if (
                        margs.call_from == 'set_by_mouseclick' ||
                        margs.call_from == 'set_by_mousemove'
                    ) {
                        volume_set_by_user = true;
                    }
                ...
                function pause_media_visual(pargs) {
                    ...
                    if (
                        cthis.parent().hasClass('zoomsounds-wrapper-bg-center')
                    ) {
                    ...
                    if (margs.donot_change_media != true) {
                        ...
                        if (o.fakeplayer != null) {
                            ...
                            if (
                                o.fakeplayer &&
                                o.fakeplayer.length &&
                                o.fakeplayer.data('feeding-from') !=
                                    cthis.get(0)
                            ) {
                                args.call_from =
                                    'pause_media from player ' +
                                    cthis.attr('data-source');
                                o.fakeplayer
                                    .get(0)
                                    .api_change_media(cthis, args);
                            ...
                            if (
                                cthis
                                    .parent()
                                    .hasClass('zoomsounds-wrapper-bg-center')
                            ) {
                                cthis.parent().removeClass('is-playing');
                            }
                ...
                function play_media(pargs) {
                    ...
                    if (margs.call_from == 'api_sync_players_prev') {
                        ...
                        if (
                            ...
                            o.parentgallery
                                .get(0)
                                .api_goto_item(player_index_in_gallery);
                        }
                    }
                    if (is_ios() && audioCtx_buffer == 'waiting') {
                        setTimeout(function() {
                            pargs.call_from_aux =
                                'waiting audioCtx_buffer or ios';
                            play_media(pargs);
                        }, 500);
                        return false;
                    }
                    ...
                    if (
                        cthis.hasClass('media-setuped') == false &&
                        o.fakeplayer == null
                    ) {
                        console.log(
                            'warning: media not setuped, there might be issues',
                            cthis.attr('id')
                        );
                    }
                    ...
                    if (
                        o.google_analytics_send_play_event == 'on' &&
                        window._gaq &&
                        google_analytics_sent_play_event == false
                    ) {
                        ...
                        window._gaq.push([
                            ...
                            'ZoomSounds Play',
                            'Play',
                            'zoomsounds play - ' + cthis.attr('data-source')
                        ]);
                        ...
                        try {
                            ...
                            if (margs.call_from == 'click_playpause') {
                                ...
                                if (o.parentgallery) {
                                    ...
                                    o.fakeplayer
                                        .get(0)
                                        .api_regenerate_playerlist_inner();
                                }
                            ...
                            if (_cmedia && _cmedia.playVideo) {
                                ...
                                if (margs.retry_call < 5) {
                                    ...
                                    if (yt_inited == false) {
                                        ...
                                        yt_retry_play_timeout = setTimeout(
                                            function(args) {
                                                play_media(args);
                                            },
                                            500,
        ...
        $.fn.audiogallery = function(o) {
            ...
            this.each(function() {
                ...
                if (
                    ...
                    typeof window.dzsap_settings.str_alertBeforeRate !=
                        'undefined'
                ) {
                    str_alertBeforeRate =
                        window.dzsap_settings.str_alertBeforeRate;
                }
                ...
                function init() {
                    ...
                    if (cgallery.attr('data-player-options')) {
                        try {
                            if (o.settings_ap == 'default') {
                                o.settings_ap = JSON.parse(
                                    cgallery.attr('data-player-options')
                                );
                            }
                        } catch (err) {
                            console.log(
                                'json not correct .. data-player-options',
                                cgallery.attr('data-player-options')
                            );
                        }
                    }
                    ...
                    console.log(
                        'o.settings_ap after data-player-options - ',
                        Object.assign({}, o.settings_ap)
                    );
                    if (o.settings_ap == 'default') {
                        o.settings_ap = {};
                    }
                    ...
                    cgallery.addClass(
                        'menu-position-' + o.design_menu_position
                    );
                    ...
                    var auxlen = cgallery
                        .find('.items')
                        .children('.audioplayer-tobe').length;

                    // --- if there is a single audio player in the gallery - theres no point of a menu

                    o.settings_ap.disable_player_navigation =
                        o.disable_player_navigation;
                    ...
                    var aux =
                        '<div class="nav-main zoomsounds-nav ' +
                        o.design_skin +
                        ' nav-type-' +
                        o.menu_nav_type +
                    ...
                    if (o.settings_php_handler) {
                        ...
                        if (o.settings_ap.settings_php_handler) {
                            o.settings_php_handler =
                                o.settings_ap.settings_php_handler;
                        }
                    }
                    ...
                    cgallery.get(
                        0
                    ).api_skin_redlights_give_controls_right_to_all = function() {
                        // -- void f()
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                o.force_autoplay_when_coming_from_share_link ==
                                'on'
                            ) {
                                o.autoplay = 'on';
                            }
                    ...
                    if (o.settings_mode == 'mode-showall') {
                        ...
                        _sliderClipper.children().each(function() {
                            ...
                            if (_t.hasClass('audioplayer-tobe')) {
                                ...
                                if (
                                    o.mode_showall_layout == 'one-per-row' &&
                                    o.settings_mode_showall_show_number != 'off'
                                ) {
                                    _t.before(
                        ...
                        if (
                            ...
                            _sliderClipper
                                .find('.audioplayer,.audioplayer-tobe')
                                .addClass('isotope-item');
                            setTimeout(function() {
                                _sliderClipper.prepend(
                    ...
                    _navClipper.on(
                        'click',
                        '.menu-btn-like,.menu-facebook-share',
                        click_menuitem
                    );
                    _navClipper.on('click', '.menu-item', click_menuitem);
                    cgallery
                        .find('.download-after-rate')
                        .bind('click', click_downloadAfterRate);

                    cgallery.get(
                        0
                    ).api_regenerate_sync_players_with_this_playlist = regenerate_sync_players_with_this_playlist;
                    ...
                    cgallery.get(
                        0
                    ).api_player_commentSubmitted = player_commentSubmitted;
                    cgallery.get(
                        0
                    ).api_player_rateSubmitted = player_rateSubmitted;
                    ...
                    cgallery.get(
                        0
                    ).api_init_player_from_gallery = init_player_from_gallery;
                ...
                function regenerate_sync_players_with_this_playlist() {
                    ...
                    _sliderClipper
                        ...
                        .each(function() {
                            ...
                            if (
                                _t.attr('data-do-not-include-in-list') != 'on'
                            ) {
                            ...
                            _navMain.find('.menu-item-views').each(function() {
                                ...
                                if (aux && aux[1]) {
                                    ...
                                    for (var i in track_data) {
                                        ...
                                        if (
                                            id == track_data[i].label ||
                                            id == 'ap' + track_data[i].label
                                        ) {
                                            aux_html = aux_html.replace(
                                                aux[0],
                                                track_data[i].views
                                            );
                                            foundnr++;
                    ...
                    if (arg.attr('data-player-id')) {
                        ...
                        if (arg.attr('id')) {
                            ...
                            if (arg.attr('data-source')) {
                                return dzs_clean_string(
                                    arg.attr('data-source')
                                );
                            }
                        }
                    }
                ...
                function reinit() {
                    ...
                    for (i = 0; i < arr_menuitems.length; i++) {
                        var extra_class = '';
                        if (
                            arr_menuitems[i].menu_description &&
                            arr_menuitems[i].menu_description.indexOf(
                        ...
                        if (
                            cgallery.hasClass('skin-aura') &&
                            String(arr_menuitems[i].menu_description).indexOf(
                                'menu-item-views'
                            ) == 1
                        ) {
                    ...
                    if (
                        ...
                        if (
                            typeof _sliderClipper
                                .children()
                                .eq(currNr)
                                .get(0).api_play_media != 'undefined'
                        ) {
                            _sliderClipper
                                .children()
                                .eq(currNr)
                ...
                function calculateDims() {
                    ...
                    if (
                        o.settings_mode != 'mode-showall' &&
                        _sliderClipper.hasClass('isotoped') == false &&
                        o.mode_normal_video_mode != 'one'
                    ) {
                        ...
                        if (
                            _sliderClipper
                                .children()
                                .eq(currNr)
                                .hasClass('zoomsounds-wrapper-bg-bellow') ==
                            false
                        ) {
                            _sliderClipper.css(
                                'height',
                ...
                function calculate_on_interval() {
                    ...
                    if (
                        o.gallery_gapless_play == 'on' &&
                        time_total > 1 &&
                        time_curr >= time_total - 10 &&
                        time_curr > 5
                    ) {
                        var args = {
                        ...
                        if (
                            o.parentgallery &&
                            cthis.hasClass('active-from-gallery')
                        ) {
                            var _c = o.parentgallery;
                            // console.log(_c);
                            // console.log(_c.data('currNr'));

                            var _cach = _sliderClipper
                                .children()
                                .eq(Number(_c.data('currNr')) + 1);
                            ...
                            if (!(_cach.data('gapless-inited') == true)) {
                                ...
                                // console.log('time_curr - ',time_curr);
                                _c.get(0).api_init_player_from_gallery(
                                    _cach,
                                    args
                                );
                ...
                function navMain_mousemove(e) {
                    ...
                    viy =
                        (my / nc_maindim) *
                            -(nm_maindim - nc_maindim + 10 + aux_error * 2) +
                        aux_error;
                    //console.log(viy);
                    if (viy > 0) {
                        viy = 0;
                ...
                function transition_end() {
                    ...
                    _sliderClipper
                        .children()
                        .eq(lastCurrNr)
                        .removeClass('active active-from-gallery');
                ...
                function goto_item(arg, pargs) {
                        ...
                        if (
                            ...
                            if (
                                typeof _sliderClipper
                                    .children()
                                    .eq(currNr)
                                    .get(0).api_pause_media != 'undefined'
                            ) {
                                _sliderClipper
                                    .children()
                                    .eq(currNr)
                            ...
                            if (
                                typeof _sliderClipper
                                    .children()
                                    .eq(currNr)
                                    .get(0).api_get_last_vol != 'undefined'
                            ) {
                                currNr_last_vol = _sliderClipper
                                    .children()
                                    .eq(currNr)
                                    .get(0)
                                    .api_get_last_vol();
                    ...
                    o.settings_ap.design_menu_show_player_state_button =
                        o.design_menu_show_player_state_button;
                    ...
                    if (o.mode_normal_video_mode == 'one' && arg > 0) {
                        ...
                        if (_c) {
                            if (_c.api_play_media) {
                                console.log(
                                    '_sliderClipper.children().eq(arg) - ',
                                    _sliderClipper.children().eq(arg)
                                );
                                _c.api_change_media(
                                    _sliderClipper.children().eq(arg),
                                    {
                                        call_from:
                                            'goto_item -- mode_normal_video_mode'
                                        // ,'fakeplayer_is_feeder':'on'
                                    }
                                );
                    ...
                    if (o.settings_mode != 'mode-showall') {
                        ...
                        if (_cache.attr('data-type') != 'link') {
                            if (
                                margs.ignore_linking == false &&
                                o.settings_enable_linking == 'on'
                            ) {
                                var stateObj = { foo: 'bar' };
                                history.pushState(
                                    stateObj,
                    ...
                    _navClipper
                        .children()
                        .eq(arg)
                        .addClass('active active-from-gallery');
                    ...
                    if (
                        bgimage &&
                        cgallery.parent().hasClass('ap-wrapper') &&
                        cgallery.parent().children('.the-bg').length > 0
                    ) {
                    ...
                    if (
                        ...
                        _sliderClipper
                            .children()
                            .eq(currNr)
                            .get(0).api_handleResize &&
                        _sliderClipper
                            .children()
                            .eq(currNr)
                            .hasClass('media-setuped')
                    ) {
                        //console.log('_sliderClipper.children().eq(currNr) - ',_sliderClipper.children().eq(currNr));
                        _sliderClipper
                            .children()
    ...
    jQuery(document).ready(function($) {
        ...
        function handle_resize_dzsap_main_doit() {
            ...
            if (dzsap_sticktobottom_con) {
                ...
                aux += '{';
                aux +=
                    'bottom: -' + dzsap_sticktobottom_con.outerHeight() + 'px';
                aux += '}';
                    ...
                    if (window.dzsap_lasto.settings_php_handler) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (
                                    _t.find('.svg-icon').hasClass('fa-star-o')
                                ) {
                                    _t.find('.svg-icon')
                                        .eq(0)
                                        .attr('class', 'svg-icon fa fa-star');
                                } else {
                                    _t.find('.svg-icon')
                                        .eq(0)
                                        .attr('class', 'svg-icon fa fa-star-o');
                                }
                            },
                            error: function(arg) {
                                if (typeof window.console != 'undefined') {
        ...
        $(document).on(
            ...
            function() {
                ...
                $('.dzsap-sticktobottom .audioplayer')
                    .get(0)
                    .api_pause_media();
                ...
                console.log(
                    '_con - ',
                    _con,
                    _con.hasClass('audioplayer-loaded')
                );
        ...
        if (
            ...
            setInterval(function() {
                ...
                if (
                    ...
                    if (
                        $('.dzsap-sticktobottom').hasClass(
                            'audioplayer-was-loaded'
                        ) == false
                    ) {
                        $(
                            '.dzsap-sticktobottom.dzsap-sticktobottom-for-skin-silver'
        ...
        if (
            $('.dzsap-sticktobottom.dzsap-sticktobottom-for-skin-wave').length >
            0
        ) {
            setInterval(function() {
        ...
        function open_dzsap_lightbox(pargs) {
                ...
                if (_t.attr('data-post_id')) {
                    ...
                    if (
                        _t
                            ...
                            .parent()
                            .parent()
                            .hasClass('audioplayer')
                    ) {
                        // console.log("YES");
                        window.dzsap_currplayer_from_share = _t
                            .parent()
                            .parent()
                            .parent()
                            .parent()
            ...
            if (window.dzsap_box_main_con) {
                ...
                if (
                    window.dzsap_currplayer_from_share &&
                    dzsap_currplayer_from_share.data('embed_code')
                ) {
                    console.log(
                        'o.embed_code - ',
                        dzsap_currplayer_from_share.data('embed_code')
                    ...
                    if (aux_social) {
                        var replace_str = dzsap_currplayer_from_share.data(
                            'embed_code'
                        );
                        ...
                        aux_social = aux_social.replace(
                            '{{replacewithembedcode}}',
                            replace_str
                        );
        ...
        $(document).on('keydown.dzsapkeyup keypress.dzsapkeyup', function(e) {
            ...
            if (
                ...
                if (keyboard_controls.step_back.indexOf('ctrl+') > -1) {
                    if (e.ctrlKey) {
                        keyboard_controls.step_back = keyboard_controls.step_back.replace(
                            'ctrl+',
                            ''
                        );
...
function onYouTubeIframeAPIReady() {
    for (i = 0; i < dzsap_yt_list.length; i++) {
        ...
        if (
            dzsap_yt_list[i].get(0) != undefined &&
            typeof dzsap_yt_list[i].get(0).fn_yt_ready != 'undefined'
        ) {
...
var MD5 = function(e) {
    ...
    f = (function(b) {
        ...
        var a = c + 8;
        for (
            var d = 16 * ((a - (a % 64)) / 64 + 1), e = Array(d - 1), f, g = 0;
            g < c;
    ...
    for (e = 0; e < f.length; e += 16) {
        ...
        b = h(b, c, a, d, f[e + 6], 17, 2821735955);
...
window.dzs_open_social_link = function(arg, argthis) {
    ...
    var shareurl = encodeURIComponent(
        auxa[0] +
            '?fromsharer=on&audiogallery_startitem_' +
            cid_gallery +
            '=' +
            cid +
            ''
...
window.dzsap_init = function(selector, settings) {
    ...
    if (
        typeof settings != 'undefined' &&
        typeof settings.construct_player_list_for_sync != 'undefined' &&
        settings.construct_player_list_for_sync == 'on'
    ) {
        jQuery('.audioplayer,.audioplayer-tobe').each(function() {
            var _t2 = jQuery(this);
            if (_t2.attr('data-do-not-include-in-list') != 'on') {
                if (
                    _t2.attr('data-type') != 'fake' ||
                    _t2.attr('data-fakeplayer')
                ) {
