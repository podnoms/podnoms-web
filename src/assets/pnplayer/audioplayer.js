        ...
        this.each(function() {
            ...
            function init() {
                ...
                if(_sticktobottom){
                    ...
                    _sticktobottom.prev().addClass('pnplayer-sticktobottom-for-'+o.design_skin);

                    if(o.design_skin=='skin-wave'){
                        _sticktobottom.addClass('pnplayer-sticktobottom-for-'+o.design_skin+'--mode-'+skinwave_mode)
                        _sticktobottom.prev().addClass('pnplayer-sticktobottom-for-'+o.design_skin+'--mode-'+skinwave_mode)
                    }
                ...
                cthis.on('click','.pnplayer-repeat-button,.pnplayer-loop-button,.btn-pnplayer-download,.pnplayer-btn-step-backward,.pnplayer-btn-step-forward,.pnplayer-btn-go-beginning,.pnplayer-btn-slow-playback,.pnplayer-btn-reset, .playlist-menu-item, .tooltip-indicator--btn-footer-playlist',handle_mouse);
            ...
            function change_media(arg, pargs) {
                ...
                if(_feed_fakePlayer){
                    ...
                    if(_feed_fakePlayer.find('.feed-pnplayer-for-extra-html-right').length){
                        cthis.find('.extrahtml-in-float-right').eq(0).html(_feed_fakePlayer.find('.feed-pnplayer-for-extra-html-right').html());
            ...
            function add_comments_placeholder(sposarg){
                ...
                _commentsHolder.append('<style class="pnplayer-style-comments">.dzstooltip-con:not(.placeholder) { opacity: 0.5; }</style>')
                _commentsHolder.find('.dzstooltip-con.placeholder').remove();
            ...
            function comment_submit(comment_text, comment_email, comment_username){
                ...
                if (o.skinwave_comments_process_in_php != 'on') {
                    ...
                    aux += '<span class="dzstooltip-con pnplayer-comment" style="left:' + sposarg + '"><div class="the-avatar tooltip-indicator" style="background-image: url(' + o.skinwave_comments_avatar + ')"></div><span class="dzstooltip style-rounded color-dark-light talign-start  transition-slidein arrow-bottom " style="width: 250px;"><span class="the-comment-author">@' + comm_author + '</span> says:<br>';
            ...
            function playlist_goto_item(arg,pargs) {
                ...
                if(playerid && $('.audioplayer[data-playerid="'+playerid+'"]').length && $('.audioplayer[data-playerid="'+playerid+'"]').eq(0).get(0).api_play_media){
            ...
            function setup_playlist_inner(pargs) {
                ...
                console.info('setup_playlist_inner() pnplayer_list_for_sync_players -4 ',pnplayer_list_for_sync_players,margs);
                ...
                $(document).on('mousemove.pnplayer_playlist_item',function(e){
                    ...
                    if(window.pnplayer_moving_playlist_item){
                        ...
                        pnplayer_playlist_item_target.parent().children(':not(".target-playlist-item"):not(".cloner")').each(function(){
                            var _t = $(this);

                            var tmy = _t.offset().top - pnplayer_playlist_con.offset().top;
                        ...
                        if(my<50){
                            pnplayer_playlist_item_target.parent().prepend(pnplayer_playlist_item_target);
                        }
                    }
                });
                $(document).on('mouseup.pnplayer_playlist_item',function(e){
                    ...
                    if(window.pnplayer_moving_playlist_item){
                        ...
                        pnplayer_playlist_item_moving.parent().children('.cloner').remove();
                        pnplayer_playlist_item_target.removeClass('target-playlist-item');
            ...
            function setup_structure(pargs) {
                    ...
                    if(cthis.hasClass('pnplayer-no-wrapper')==false){
                        ...
                        img.onload = function(){
                            ...
                            setTimeout(function(){
                                ...
                                if(cthis.hasClass('pnplayer-wrapper-bg-bellow')){
                ...
                if(cthis.find('.feed-pnplayer-before-playpause').length){
                    struct_con_playpause+=cthis.find('.feed-pnplayer-before-playpause').eq(0).html();
                ...
                if(keyboard_controls.show_tooltips=='on'){
                    struct_con_playpause+=pnplayer_generate_keyboard_tooltip(keyboard_controls,'pause_play');
                }



                struct_con_playpause+='<div class="playbtn"><div class="the-icon-bg"></div><div class="pnplayer-play-icon">';
                ...
                if(cthis.find('.feed-pnplayer-after-playpause').length){
                    struct_con_playpause+=cthis.find('.feed-pnplayer-after-playpause').eq(0).html();
                ...
                if (o.design_skin == 'skin-wave' && skinwave_mode == 'small') {
                    aux_str_con_controls = '<div class="the-bg"></div><div class="ap-controls-left">'+struct_con_playpause+'</div>'+aux_str_scrubbar+'<div class="ap-controls-right">'+aux_str_con_volume+'<div class="extrahtml-in-float-right for-skin-wave-small">'+o.settings_extrahtml_in_float_right+'</div></div>';
                    ...
                    if (o.design_skin == 'skin-aria' || o.design_skin == 'skin-silver' || o.design_skin == 'skin-redlights' || o.design_skin == 'skin-steel') {
                        ...
                        if(o.design_skin == 'skin-silver'){
                            ...
                            if(keyboard_controls.show_tooltips=='on'){
                                aux_str_con_controls+=pnplayer_generate_keyboard_tooltip(keyboard_controls,'pause_play');
                            }


                            aux_str_con_controls+='<div class="playbtn"><div class="pnplayer-play-icon">' + playbtn_svg + '</div><div class="play-icon-hover"></div></div><div class="pausebtn" style="display:none"><div class="pause-icon">' + pausebtn_svg + '</div><div class="pause-icon-hover"></div></div></div>'; // -- enc con-playpause
                        ...
                        if(cthis.find('.feed-pnplayer-after-playpause').length){
                            aux_str_con_controls+=cthis.find('.feed-pnplayer-after-playpause').eq(0).html();
                ...
                if (o.settings_extrahtml_in_float_right) {
                    ...
                    if(String(o.settings_extrahtml_in_float_right).indexOf('pnplayer-multisharer-but')>-1){
                    ...
                    if (o.design_skin == 'skin-wave' && skinwave_mode == 'small') {
                        ...
                        finstring += '<div class="extrahtml-in-float-right from-setup_structure">'+o.settings_extrahtml_in_float_right+'</div>';
                    }
                ...
                if(o.footer_btn_playlist=='on'){
                    ...
                    _apControlsRight.appendOnce('<div class="btn-footer-playlist dzstooltip-con player-but"> <div class="tooltip-indicator tooltip-indicator--btn-footer-playlist"><div class="the-icon-bg"></div> <svg class="svg-icon" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="13.25px" height="13.915px" viewBox="0 0 13.25 13.915" enable-background="new 0 0 13.25 13.915" xml:space="preserve"> <path d="M1.327,4.346c-0.058,0-0.104-0.052-0.104-0.115V2.222c0-0.063,0.046-0.115,0.104-0.115H11.58 c0.059,0,0.105,0.052,0.105,0.115v2.009c0,0.063-0.046,0.115-0.105,0.115H1.327z"/> <path d="M1.351,8.177c-0.058,0-0.104-0.051-0.104-0.115V6.054c0-0.064,0.046-0.115,0.104-0.115h10.252 c0.058,0,0.105,0.051,0.105,0.115v2.009c0,0.063-0.047,0.115-0.105,0.115H1.351z"/> <path d="M1.351,12.182c-0.058,0-0.104-0.05-0.104-0.115v-2.009c0-0.064,0.046-0.115,0.104-0.115h10.252 c0.058,0,0.105,0.051,0.105,0.115v2.009c0,0.064-0.047,0.115-0.105,0.115H1.351z"/> </svg>    </div><div class="dzstooltip playlist-tooltip style-default color-light-dark arrow-bottom talign-end transition-scaleup active2"><div class="dzstooltip--inner"> </div></div></div>');
                ...
                if(cthis.find('.feed-pnplayer-after-con-controls').length){
                    _apControls.append(cthis.find('.feed-pnplayer-after-con-controls').eq(0).html());
                ...
                if (o.settings_extrahtml != '') {
                    ...
                    setTimeout(function() {
                        ...
                        if(cthis.find('.extra-html').html().indexOf('pnplayer-multisharer-but')>-1){
                            sw_enable_multisharer=true;
                ...
                if(cthis.hasClass('pnplayer-wrapper-bg-bellow') && cthis.find('.pnplayer-wrapper-buts').length==0){
                    ...
                    cthis.find('.temp-wrapper').children('*:not(.pnplayer-wrapper-but)').remove();
                    ...
                    cthis.children('.pnplayer-wrapper-but').each(function(){
                        ...
                        if($(this).get(0) && $(this).get(0).outerHTML.indexOf('pnplayer-multisharer-but')>-1){
                            sw_enable_multisharer=true;
            ...
            function check_multisharer(){
                ...
                if(sw_enable_multisharer){
                    setTimeout(function(){
                        ...
                        if(window.pnplayer_multisharer_assets_loaded){

                        }else{
                            if (window.pnplayer_multisharer_assets_loaded != true && o.settings_php_handler && window.loading_multi_sharer!=true) {
                                ...
                                setTimeout(function(){
                                    ...
                                    if(pnplayer_box_main_con==null){
                                        ...
                                        $('body').append('<div class="pnplayer-main-con skin-default gallery-skin-default transition-slideup "> <div class="overlay-background"></div> <div class="box-mains-con"> <div class="box-main box-main-for-share" style=""> <div class="box-main-media-con transition-target"> <div class="close-btn-con"> <svg enable-background="new 0 0 40 40" id="" version="1.1" viewBox="0 0 40 40" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M28.1,26.8c0.4,0.4,0.4,1,0,1.4c-0.2,0.2-0.5,0.3-0.7,0.3s-0.5-0.1-0.7-0.3l-6.8-6.8l-6.8,6.8c-0.2,0.2-0.5,0.3-0.7,0.3 s-0.5-0.1-0.7-0.3c-0.4-0.4-0.4-1,0-1.4l6.8-6.8l-6.8-6.8c-0.4-0.4-0.4-1,0-1.4c0.4-0.4,1-0.4,1.4,0l6.8,6.8l6.8-6.8 c0.4-0.4,1-0.4,1.4,0c0.4,0.4,0.4,1,0,1.4L21.3,20L28.1,26.8z"></path></g><g><path d="M19.9,40c-11,0-20-9-20-20s9-20,20-20c4.5,0,8.7,1.5,12.3,4.2c0.4,0.3,0.5,1,0.2,1.4c-0.3,0.4-1,0.5-1.4,0.2 c-3.2-2.5-7-3.8-11-3.8c-9.9,0-18,8.1-18,18s8.1,18,18,18s18-8.1,18-18c0-3.2-0.9-6.4-2.5-9.2c-0.3-0.5-0.1-1.1,0.3-1.4 c0.5-0.3,1.1-0.1,1.4,0.3c1.8,3.1,2.8,6.6,2.8,10.2C39.9,31,30.9,40,19.9,40z"></path></g></svg></div> <div class="box-main-media type-inlinecontent" style="width: 530px; height: 280px;"><div class=" real-media" style=""><div class="hidden-content share-content" > <div class="social-networks-con"></div> <div class="share-link-con"></div> <div class="embed-link-con"></div> </div> </div> </div> <div class="box-main-under"></div> </div> </div> </div><!-- end .box-mains-con--> </div>');


                                        pnplayer_box_main_con = $('.pnplayer-main-con').eq(0);
                        ...
                        $(document).on('click.pnplayer','.pnplayer-main-con .close-btn-con,.pnplayer-main-con .overlay-background', function(){
...
//                            console.info(auxa);
                ...
                if (type == 'youtube') {
                    if (o.settings_exclude_from_list != 'on' && pnplayer_list && pnplayer_list.indexOf(cthis) == -1) {
                        if (pnplayer_list) {
            ...
            function init_loaded(pargs) {
                ...
                if (isNaN(Number(o.default_volume)) == false) {
                    ...
                    if (o.default_volume == 'last') {
                        ...
                        if (localStorage != null && the_player_id) {
                            ...
                            if (localStorage.getItem('pnplayer_last_volume_' + the_player_id)) {

                                defaultVolume = localStorage.getItem('pnplayer_last_volume_' + the_player_id);
                            } else {
                ...
                if (playfrom == 'last') {
                    ...
                    if (typeof Storage != 'undefined') {
                        ...
                        if (typeof localStorage['pnplayer_' + the_player_id + '_lastpos'] != 'undefined') {
                ...
                if (margs.do_not_autoplay != true) {
                    ...
                    if (o.autoplay == 'on' && o.cue=='on') {
                        console.info('margs.do_not_autoplay - ', margs.do_not_autoplay, margs,o);
                        play_media({
                ...
                if ( (type == 'audio' || ( type=='fake' && o.fakeplayer)) ) {
                    if (o.type != 'shoutcast') {
                        ...
                        if (playfrom == 'last' && playfrom_ready) {
                            if (typeof Storage != 'undefined') {
                                localStorage['pnplayer_' + the_player_id + '_lastpos'] = time_curr;
            ...
            function check_time(pargs) {
                ...
                if (type == 'youtube') {
                    try {
                        ...
                        if (playfrom == 'last' && playfrom_ready) {
                            if (typeof Storage != 'undefined') {
                                localStorage['pnplayer_' + the_player_id + '_lastpos'] = time_curr_for_real;
                            }
                        }
                    } catch (err) {
                ...
                if(_playlistTooltip && _playlistTooltip.children('.dzstooltip--inner').length){
                    ...
                    if (pnplayer_list_for_sync_players.length > 0) {
                        for (var i24 in pnplayer_list_for_sync_players) {
                            ...
                            if (pnplayer_list_for_sync_players[i24].get(0) == _ctarget.get(0)) {
            ...
            function play_media(pargs) {
                ...
                for (i = 0; i < pnplayer_list.length; i++) {
                    ...
                    // -- pause other players
                    if (pnplayer_list[i].get(0)  && pnplayer_list[i].get(0).api_pause_media && ( pnplayer_list[i].get(0) != cthis.get(0)) ) {
                        ...
                        if (pnplayer_list[i].data('type_audio_stop_buffer_on_unfocus') && pnplayer_list[i].data('type_audio_stop_buffer_on_unfocus') == 'on') {
                ...
                if (o.google_analytics_send_play_event == 'on' && window._gaq && google_analytics_sent_play_event == false) {
                    ...
                    window._gaq.push(['_trackEvent', 'pnplayer Play', 'Play', 'pnplayer play - ' + cthis.attr('data-source')]);
    ...
    $.fn.audiogallery = function(o) {
        ...
        this.each(function() {
            ...
            if (window.pnplayer_settings && typeof(window.pnplayer_settings.str_alertBeforeRate) != 'undefined') {
            ...
            function init() {
                ...
                var aux = '<div class="nav-main pnplayer-nav '+o.design_skin+' nav-type-'+o.menu_nav_type+'"><div class="nav-clipper"></div></div>';
            ...
            function calculateDims() {
                ...
                if(_sliderClipper.children().eq(currNr).hasClass('pnplayer-wrapper-bg-bellow')==false){
...
jQuery(document).ready(function($) {
    ...
    $(document).on( 'click.pnplayer_metas','.audioplayer-song-changer, .pnplayer-wishlist-but', function() {
        var _t = $(this);
    ...
    if ($('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-silver').length > 0) {
        setInterval(function() {
            ...
            if ($('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-silver  .audioplayer').eq(0).hasClass('pnplayer-loaded')) {
                $('.pnplayer-sticktobottom-placeholder').eq(0).addClass('active');

                if ($('.pnplayer-sticktobottom').hasClass('audioplayer-was-loaded') == false) {

                    $('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-silver').addClass('audioplayer-loaded')
                }
            }
        }, 1000);
    }
    if ($('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-wave').length > 0) {
        setInterval(function() {
            ...
            if ($('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-wave  .audioplayer').eq(0).hasClass('pnplayer-loaded')) {
                $('.pnplayer-sticktobottom-placeholder').eq(0).addClass('active');

                if ($('.pnplayer-sticktobottom').hasClass('audioplayer-was-loaded') == false) {

                    $('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-wave').addClass('audioplayer-loaded')
                }
            }
    ...
    $(document).on('click.pnplayer_multisharer','.pnplayer-multisharer-but', click_open_embed_ultibox);
    ...
    function open_pnplayer_lightbox(pargs) {
        ...
        if(cthis){
            ...
            if(_t.attr('data-post_id')){
                window.pnplayer_currplayer_from_share = $('.audioplayer[data-playerid="'+_t.attr('data-post_id')+'"]')
            }else{

                if(_t.parent().parent().parent().parent().parent().parent().hasClass('audioplayer')){

                    // console.info("YES");
                    window.pnplayer_currplayer_from_share = _t.parent().parent().parent().parent().parent().parent();
                }
            }
        }
        ...
        if(window.pnplayer_box_main_con){
            ...
            if(window.pnplayer_currplayer_from_share && pnplayer_currplayer_from_share.data('embed_code') ){
    ...
    $(document).on('keydown.pnplayerkeyup,keypress.pnplayerkeyup',function(e){
        ...
        if(pnplayer_currplayer_focused && pnplayer_currplayer_focused.api_pause_media){
            ...
            if(sw_pressed){
                ...
                if($(pnplayer_currplayer_focused).hasClass('comments-writer-active')==false){
            ...
            if(sw_pressed){
                ...
                pnplayer_currplayer_focused.api_step_forward(keyboard_controls.step_back_amount);
            ...
            if(sw_pressed){
                if(pnplayer_currplayer_focused && pnplayer_currplayer_focused.api_sync_players_goto_next){
            ...
            if(sw_pressed){
                if(pnplayer_currplayer_focused && pnplayer_currplayer_focused.api_sync_players_goto_prev){
...
function onYouTubeIframeAPIReady() {
    ...
    for (i = 0; i < pnplayer_yt_list.length; i++) {
        ...
        if (pnplayer_yt_list[i].get(0) != undefined && typeof pnplayer_yt_list[i].get(0).fn_yt_ready != 'undefined') {
