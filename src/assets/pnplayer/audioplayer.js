...
function pnplayer_generate_keyboard_tooltip(keyboard_controls, lab) {
    console.info('keyboard_controls - ', keyboard_controls, lab, keyboard_controls.lab);
    var fout =
        '<span class="dzstooltip arrow-from-start transition-slidein arrow-bottom skin-black" style="width: auto;  white-space:nowrap;">Shortcut: ' +
        keyboard_controls[lab] + '</span>';
    // left: 5px;
...
function pnplayer_generate_keyboard_controls() {
    ...
    if (window.pnplayer_keyboard_controls) {
        // console.info('keyboard_controls - ',keyboard_controls);
        // console.info('window.pnplayer_keyboard_controls - ',window.pnplayer_keyboard_controls);
        keyboard_controls = jQuery.extend(keyboard_controls, window.pnplayer_keyboard_controls);
    }
...
var pnplayer_list = []; // -- this is for the players
var pnplayer_yt_list = []; // -- this is for the yt players
var pnplayer_ytapiloaded = false;
var pnplayer_globalidind = 20;
var pnplayer_list_for_sync_players = []; // this is for next / prev buttons
var pnplayer_list_for_sync_sw_built = false;
var pnplayer_list_for_sync_inter_build = 0;
window.loading_multi_sharer = false;
window.pnplayer_moving_playlist_item = false;
window.pnplayer_playlist_con = null;
window.pnplayer_playlist_item_moving = null;
window.pnplayer_playlist_item_target = null;
window.pnplayer_player_interrupted_by_pnplayer = null;
window.pnplayer_audio_ctx = null;
window.pnplayer__style = null;
window.pnplayer_sticktobottom_con = null;
window.pnplayer_self_options = {};
window.pnplayer_generating_pcm = false;
window.pnplayer_box_main_con = null;
window.pnplayer_lasto = null;
window.pnplayer_player_index = 0; // -- the player index on the page
(function($) {
    window.pnplayer_list_for_sync_build = function() {};
    var svg_play_icon =
    ...
    var svg_arrow_resize =
        '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="12px" height="12px" viewBox="0 0 511.626 511.627" style="enable-background:new 0 0 511.626 511.627;" xml:space="preserve"> <g><path d="M328.906,401.994h-36.553V109.636h36.553c4.948,0,9.236-1.809,12.847-5.426c3.613-3.615,5.421-7.898,5.421-12.845 c0-4.949-1.801-9.231-5.428-12.851l-73.087-73.09C265.044,1.809,260.76,0,255.813,0c-4.948,0-9.229,1.809-12.847,5.424 l-73.088,73.09c-3.618,3.619-5.424,7.902-5.424,12.851c0,4.946,1.807,9.229,5.424,12.845c3.619,3.617,7.901,5.426,12.85,5.426 h36.545v292.358h-36.542c-4.952,0-9.235,1.808-12.85,5.421c-3.617,3.621-5.424,7.905-5.424,12.854 c0,4.945,1.807,9.227,5.424,12.847l73.089,73.088c3.617,3.617,7.898,5.424,12.847,5.424c4.95,0,9.234-1.807,12.849-5.424 l73.087-73.088c3.613-3.62,5.421-7.901,5.421-12.847c0-4.948-1.808-9.232-5.421-12.854 C338.142,403.802,333.857,401.994,328.906,401.994z" fill="#363636"/> </g></svg>';
    var svg_share_icon =
    ...
    var pausebtn_svg =
        '<svg version="1.2" baseProfile="tiny" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="30px" viewBox="0 0 25 30" xml:space="preserve"> <path d="M9.812,29.7c0,0.166-0.178,0.3-0.398,0.3H2.461c-0.22,0-0.398-0.134-0.398-0.3V0.3c0-0.166,0.178-0.3,0.398-0.3h6.953 c0.22,0,0.398,0.134,0.398,0.3V29.7z"/> <path d="M23.188,29.7c0,0.166-0.178,0.3-0.398,0.3h-6.953c-0.22,0-0.398-0.134-0.398-0.3V0.3c0-0.166,0.178-0.3,0.398-0.3h6.953 c0.22,0,0.398,0.134,0.398,0.3V29.7z"/> </svg>';
    ...
    $.fn.audioplayer = function(o) {
        var defaults = {
            ...
            fakeplayer: null // -- if this is a fake player, it will feed
                ,
            failsafe_repair_media_element: '' // -- some scripts might effect the media element used by pnplayer, this is how we replace the media element in a certain time
                ,
        ...
        if (typeof o == 'undefined') {
            if ($(this).attr('data-options')) {
                ...
                aux = 'window.pnplayer_self_options  = ' + aux;
                try {
                    eval(aux);
                } catch (err) {
                    console.warn('eval error', err);
                }
                // console.info($(this), $(this).attr('data-options'), window.pnplayer_self_options);
                o = $.extend({}, window.pnplayer_self_options);
                window.window.pnplayer_self_options = $.extend({}, {});
            }
        }
        o = $.extend(defaults, o);
        ...
        this.each(function() {
            ...
            var _audioplayerInner, _apControls = null,
                ...
                _controlsVolume, _scrubbar, _scrubbarbg_canvas, __scrubbProg,
                _scrubbarhover_canvas, _scrubbarprog_canvas, _theMedia, _cmedia = null,
                _cwatermark = null,
                _commentsSelector = null,
                _theThumbCon, _metaArtistCon, _scrubBgReflect = null,
                _extra_html, _playlistTooltip = null,
            ...
            var last_vol = 1,
                ...
                the_player_id = '',
                pcm_identifier =
                '' // -- can be either player id or source if player id is not set
            ;
            var inter_check, inter_checkReady, inter_check_yt_ready,
            ...
            var data_source = '',
                ...
                ,
                original_real_mp3 =
                '' // -- this is the original real mp3 for sainvg and identifying in the database
            ;
            var res_thumbh = false,
                ...
                ended = false,
                sw_mouse_over = false; // resize thumb height
            ...
            var action_audio_end = null,
                ...
                action_audio_comment =
                null; // -- set a outer ended function ( for example for tracking your analytics
            ...
            window.pnplayer_player_index++;
            settle_sample_times();
            if (o.autoplay == 'on' && o.cue == 'on') {
                o.preload_method = 'auto';
            }
            var keyboard_controls = pnplayer_generate_keyboard_controls();
            ...
            if (cthis.children('.extra-html-in-controls-right').length > 0) {
                o.settings_extrahtml_in_float_right += cthis.children(
                    '.extra-html-in-controls-right').eq(0).html();
            }
            if (cthis.children('.extra-html-in-controls-left').length > 0 && o
                .settings_extrahtml_in_float_left == '') {
                o.settings_extrahtml_in_float_left = cthis.children(
                    '.extra-html-in-controls-left').eq(0).html();
            }
            if (o.settings_extrahtml_in_float_right) {
                // console.info('o.settings_extrahtml_in_float_right - ',o.settings_extrahtml_in_float_right);
                o.settings_extrahtml_in_float_right = String(o
                    .settings_extrahtml_in_float_right).replace(/{{svg_share_icon}}/g,
                    svg_share_icon);
            }
            init();
            ...
            function settle_sample_times() {
                ...
                if (o.sample_time_start) {} else {
                    ...
                    if (cthis.attr('data-pseudo-sample_time_start')) {
                        pseudo_sample_time_start = Number(cthis.attr(
                            'data-pseudo-sample_time_start'));
                    }
                    if (cthis.attr('data-pseudo-sample_time_end')) {
                        pseudo_sample_time_end = Number(cthis.attr(
                            'data-pseudo-sample_time_end'));
                    }
                ...
                if (isNaN(Number(o.sample_time_start)) == false && Number(o
                    .sample_time_start) > 0) {
                ...
                if ((sample_time_total && sample_time_start) || (pseudo_sample_time_start &&
                        pseudo_sample_time_end)) {
                    is_sample = true;
                } else {
                    is_sample = false;
                }
            ...
            function init() {
                ...
                if (cthis.hasClass('pnplayer-inited')) {
                    return false;
                }
                cthis.addClass('pnplayer-inited')
                window.pnplayer_player_index++;
                ...
                var regexr = / skin-/g;
                if (regexr.test(cthis.attr('class'))) {} else {
                ...
                if (pnplayer_is_mobile()) {
                    $('body').addClass('is-mobile');
                }
                if (o.mobile_delete == 'on') {
                    if (pnplayer_is_mobile()) {
                        var _con = null;
                        if (cthis.parent().parent().hasClass('pnplayer-sticktobottom')) {
                            _con = cthis.parent().parent();
                        }
                        if (_con) {
                            if (_con.prev().hasClass("pnplayer-sticktobottom-placeholder")) {
                                _con.prev().remove();
                            }
                            _con.remove();
                        }
                ...
                pnplayer_can_canvas = can_canvas();
                ...
                if (cthis.attr('data-playerid')) {} else {
                    // console.info('the_player_id - ',the_player_id);
                    if (the_player_id == '') {
                ...
                if (o.mobile_disable_fakeplayer == 'on' && pnplayer_is_mobile()) {
                    ...
                    if (_c.length == 0) {
                        ...
                        if (_c.length) {
                            o.fakeplayer = $(String(cthis.attr('data-fakeplayer')).replace(
                                '#', '.'));
                            cthis.attr('data-fakeplayer', String(cthis.attr(
                                'data-fakeplayer')).replace('#', '.'));
                        }
                    }
                    if (_c.length == 0) {
                        cthis.attr('data-fakeplayer', '');
                ...
                if (cthis.children('.extra-html').length > 0 && o.settings_extrahtml == '') {
                    ...
                    if (re_ratesubmitted.test(String(o.settings_extrahtml))) {
                        ...
                        o.settings_extrahtml = String(o.settings_extrahtml).replace(
                            re_ratesubmitted, '');
                        if (o.parentgallery && $(o.parentgallery).get(0) != undefined && $(o
                                .parentgallery).get(0).api_player_rateSubmitted !=
                            undefined) {
                ...
                if (o.construct_player_list_for_sync == 'on') {
                    if (pnplayer_list_for_sync_sw_built == false) {
                        pnplayer_list_for_sync_players = [];
                        pnplayer_list_for_sync_sw_built = true;
                        $('.audioplayer.is-single-player,.audioplayer-tobe.is-single-player')
                            .each(function() {
                                var _t23 = $(this);
                                if (_t23.hasClass('pnplayer_footer')) {
                                    return;
                                }
                                // console.info(_t23);
                                pnplayer_list_for_sync_players.push(_t23);
                            })
                        // console.info(pnplayer_list_for_sync_players);
                        clearTimeout(pnplayer_list_for_sync_inter_build);
                        pnplayer_list_for_sync_inter_build = setTimeout(function() {
                            pnplayer_list_for_sync_sw_built = false;
                        }, 500);
                    }
                }
                // console.info('pnplayer_list_for_sync_players - ',pnplayer_list_for_sync_players);
                playfrom = o.playfrom;
                ...
                if (playfrom == 'off' || playfrom == '') {
                    if (get_query_arg(window.location.href, 'audio_time')) {
                        playfrom = sanitize_from_point_time(get_query_arg(window.location
                            .href, 'audio_time'));
                    }
                }
                ...
                if (cthis.attr('id') != undefined) {
                    ...
                    cthisId = 'ap' + pnplayer_globalidind++;
                }
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if (response.indexOf('a-comment') > -1) {
                                        response = response.replace(/a-comment/g,
                                            'a-comment dzstooltip-con');
                                        response = response.replace(
                                            /dzstooltip arrow-bottom/g,
                                            'dzstooltip arrow-from-start transition-slidein arrow-bottom'
                                            );
                                    }
                                    cthis.find('.the-comments').eq(0).html(
                                        response);
                                    _commentsChildren = cthis.find(
                                        '.the-comments').eq(0).children();
                ...
                if (cthis.attr('data-source') != undefined && String(cthis.attr(
                        'data-source')).indexOf('https://soundcloud.com/') > -1) {
                    type = 'soundcloud';
                }
                //console.info(o.type);
                if (type == 'soundcloud') {
                ...
                if (o.design_skin == 'skin-wave' && (type == 'audio' || type ==
                        'soundcloud' || type == 'fake') && o.skinwave_comments_enable ==
                    'on') {
                    var str_comments_holder = '<div class="comments-holder">';
                    if (o.skinwave_comments_links_to) {
                        str_comments_holder += '<a href="' + o.skinwave_comments_links_to +
                            '" target="_blank" class="the-bg"></a>';
                    } else {
                        str_comments_holder += '<div class="the-comments-holder-bg"></div>';
                    }
                    str_comments_holder +=
                        '</div><div class="clear"></div><div class="comments-writer"><div class="comments-writer-inner"><div class="setting"><div class="setting-label"></div><textarea name="comment-text" placeholder="Your comment.." type="text" class="comment-input"></textarea><div class="float-right"><button class="submit-ap-comment dzs-button-pnplayer float-right">Submit</button><button class="cancel-ap-comment dzs-button-pnplayer float-right">Cancel</button></div><div class="overflow-it"><input placeholder="Your email.." name="comment-email" type="text" class="comment-input"/></div><div class="clear"></div></div></div></div>';
                    ...
                    _commentsWriter.find('.cancel-ap-comment').bind('click',
                        click_cancel_comment);
                    _commentsWriter.find('.submit-ap-comment').bind('click',
                        click_submit_comment);
                }
                if (o.settings_extrahtml != '') {
                    // console.info('_feed_extra_html - ',_feed_extra_html);
                    if (_feed_extra_html) {
                        // console.info('_feed_extra_html.attr(\'data-playerid\') - ' , _feed_extra_html.attr('data-playerid'));
                    }
                    cthis.append('<div class="extra-html">' + o.settings_extrahtml +
                    '</div>');
                ...
                if (type == 'youtube' && is_ios() && 1 == 0) {
                    ...
                    aux = '<iframe width="100%" height="100%" src="//www.youtube.com/embed/' +
                        data_source + '" frameborder="0" allowfullscreen></iframe>';
                    cthis.html(aux);
                    return;
                } else {
                ...
                if (cthis.parent().hasClass('pnplayer-sticktobottom')) {
                ...
                if (_sticktobottom) {
                    ...
                    _sticktobottom.addClass('pnplayer-sticktobottom-for-' + o.design_skin);
                    _sticktobottom.prev().addClass('pnplayer-sticktobottom-for-' + o
                        .design_skin);
                    if (o.design_skin == 'skin-wave') {
                        _sticktobottom.addClass('pnplayer-sticktobottom-for-' + o
                            .design_skin + '--mode-' + skinwave_mode)
                        _sticktobottom.prev().addClass('pnplayer-sticktobottom-for-' + o
                            .design_skin + '--mode-' + skinwave_mode)
                    }
                ...
                cthis.get(0).api_destroy =
                destroy_it; // -- destroy the player and the listeners
                cthis.get(0).api_play = play_media; // -- play the media
                cthis.get(0).api_get_last_vol = get_last_vol; // -- play the media
                cthis.get(0).api_click_for_setup_media =
                click_for_setup_media; // -- play the media
                cthis.get(0).api_init_loaded = init_loaded; // -- force resize event
                cthis.get(0).api_handleResize = handleResize; // -- force resize event
                cthis.get(0).api_set_playback_speed =
                set_playback_speed; // -- set the playback speed, only works for local hosted mp3
                cthis.get(0).api_change_media =
                change_media; // -- change the media file from the API
                cthis.get(0).api_seek_to_perc =
                seek_to_perc; // -- seek to percentage ( for example seek to 0.5 skips to half of the song )
                cthis.get(0).api_seek_to =
                seek_to; // -- seek to percentage ( for example seek to 0.5 skips to half of the song )
                cthis.get(0).api_seek_to_visual =
                seek_to_visual; // -- seek to perchange but only visually ( does not actually skip to that ) , good for a fake player
                ...
                cthis.get(0).api_pause_media_visual =
                pause_media_visual; // -- pause the media, but only visually
                cthis.get(0).api_play_media = play_media; // -- play the media
                cthis.get(0).api_play_media_visual =
                play_media_visual; // -- play the media, but only visually
                cthis.get(0).api_handle_end =
                handle_end; // -- play the media, but only visually
                cthis.get(0).api_change_visual_target =
                change_visual_target; // -- play the media, but only visually
                cthis.get(0).api_change_design_color_highlight =
                change_design_color_highlight; // -- play the media, but only visually
                ...
                cthis.get(0).api_set_time_curr = function(arg) {
                    ...
                    if (pseudo_sample_time_start == 0) {
                        if (sample_time_start > 0) {
                            time_curr_for_visual = sample_time_start +
                                time_curr_for_visual;
                        }
                    }
                ...
                cthis.on('click',
                    '.pnplayer-repeat-button,.pnplayer-loop-button,.btn-pnplayer-download,.pnplayer-btn-step-backward,.pnplayer-btn-step-forward,.pnplayer-btn-go-beginning,.pnplayer-btn-slow-playback,.pnplayer-btn-reset, .playlist-menu-item, .tooltip-indicator--btn-footer-playlist',
                    handle_mouse);
                ...
                $(window).on('resize.pnplayer', handleResize);
                handleResize();
                ...
                if (o.skinwave_comments_mode_outer_selector) {
                    ...
                    if (_commentsSelector.data) {
                        ...
                        if (o.skinwave_comments_account && o.skinwave_comments_account !=
                            'none') {
                            _commentsSelector.find('.comment_email,*[name=comment_user]')
                                .remove();
                        }
                        _commentsSelector.on('click',
                            '.comments-btn-cancel,.comments-btn-submit',
                            comments_selector_event);
                        ...
                        console.warn('data not available .. ', $(o
            ...
            function check_every_05_secs() {
                ...
                if (cthis.hasClass('first-played') == false) {
                    if (!(cthis.attr('data-playfrom')) || cthis.attr('data-playfrom') ==
                        '0') {
                        time_total_for_real = 0;
                        time_total = 0;
                        if ($(_cmedia) && $(_cmedia).html() && $(_cmedia).html().indexOf(
                                'api.soundcloud.com') > -1) {
            ...
            function load_yt_api() {
                ...
                if (pnplayer_ytapiloaded == false) {
                    var tag = document.createElement('script');
                    tag.src = "https://www.youtube.com/iframe_api";
                    var firstScriptTag = document.getElementsByTagName('script')[0];
                    firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);
                    pnplayer_ytapiloaded = true;
                }
            }
            ...
            function comments_selector_event(e) {
                var _t = $(this);
                var _con = null;
                if (_t.parent().parent().hasClass('pnplayer-comment-wrapper')) {
                    _con = _t.parent().parent();
                }
                if (_t.parent().parent().parent().hasClass('pnplayer-comment-wrapper')) {
                ...
                if (o.design_skin == 'skin-wave') {
                    ...
                    if (_commentsHolder) {
                        if (reflection_size == 0) {
                            ...
                            _commentsHolder.css('top', _scrubbar.offset().top - cthis.offset()
                                .top + scrubbarh * reflection_size - _commentsHolder
                                .height());
                        } else {
                            ...
                            _commentsHolder.css('top', _scrubbar.offset().top - _scrubbar
                                .parent().offset().top + scrubbarh * reflection_size);
                            _commentsWriter.css('top', _scrubbar.offset().top - _scrubbar
                                .parent().offset().top + scrubbarh * reflection_size);
                        }
                    }
                    ...
                    if (_currTime) {
                        ...
                        // console.info('reflection_size - ',reflection_size);
                        // console.info('_currTime.outerHeight() - ',_currTime.outerHeight());
                        _currTime.css('top', scrubbarh * reflection_size - _currTime
                            .outerHeight());
                    }
                    if (_totalTime) {
                        _totalTime.css('top', scrubbarh * reflection_size - _totalTime
                            .outerHeight());
                    }
                }
                //console.info('reflection_size - ',reflection_size);
            ...
            function select_all(el) {
                if (typeof window.getSelection != "undefined" && typeof document
                    ...
                    sel.removeAllRanges();
                    sel.addRange(range);
                } else if (typeof document.selection != "undefined" && typeof document.body
            ...
            function change_visual_target(arg, pargs) {
                ...
                if (_feed_fakePlayer && _feed_fakePlayer.get(0) && _feed_fakePlayer.get(0)
                    .api_pause_media_visual) {
            ...
            function change_design_color_highlight(arg) {
                ...
                if (o.skinwave_wave_mode == 'canvas') {
                    draw_canvas(_scrubbarbg_canvas.get(0), cthis.attr('data-pcm'), "#" + o
                        .design_wave_color_bg, {
                            call_from: 'canvas_change_pcm_bg'
                        });
                    draw_canvas(_scrubbarprog_canvas.get(0), cthis.attr('data-pcm'), "#" + o
            ...
            function change_media(arg, pargs) {
                ...
                $('.current-feeder-for-parent-player').removeClass(
                    'current-feeder-for-parent-player');
                ...
                if (margs.fakeplayer_is_feeder == 'on') {
                    ...
                    if (_feed_fakePlayer.attr('data-sample_time_start')) {
                        cthis.attr('data-sample_time_start', _arg.attr(
                            'data-sample_time_start'));
                    } else {
                    ...
                    if (_feed_fakePlayer.attr('data-pseudo-sample_time_start')) {
                        cthis.attr('data-pseudo-sample_time_start', _feed_fakePlayer.attr(
                            'data-pseudo-sample_time_start'));
                    } else {
                        cthis.attr('data-pseudo-sample_time_start', '');
                    }
                    if (_feed_fakePlayer.attr('data-pseudo-sample_time_end')) {
                        cthis.attr('data-pseudo-sample_time_end', _feed_fakePlayer.attr(
                            'data-pseudo-sample_time_end'));
                    } else {
                        cthis.attr('data-pseudo-sample_time_end', '');
                    }
                    if (_feed_fakePlayer.attr('data-sample_time_total')) {
                        cthis.attr('data-sample_time_total', _arg.attr(
                            'data-sample_time_total'));
                    } else {
                ...
                if (_arg) {
                    ...
                    if (_arg.find('.meta-artist').length > 0 || _arg.find('.meta-artist-con')
                        .length > 0) {
                    ...
                    if (_arg.find('.feed-song-name').length > 0 || _arg.find(
                            '.feed-artist-name').length > 0) {
                ...
                if (o.design_skin == 'skin-wave') {
                    ...
                    if (margs.thumb) {
                        if (cthis.find('.the-thumb').length) {
                            cthis.find('.the-thumb').css('background-image', 'url(' + margs
                                .thumb + ')');
                        } else {
                ...
                if (_feed_fakePlayer) {
                    if (_feed_fakePlayer.find('.feed-pnplayer-for-extra-html-right').length) {
                        cthis.find('.extrahtml-in-float-right').eq(0).html(_feed_fakePlayer
                            .find('.feed-pnplayer-for-extra-html-right').html());
                    } else {}
                }
                ...
                if (original_type == 'soundcloud' && margs.source.indexOf('api.soundcloud') ==
                    -1) {
                ...
                //console.info("IS MOBILE - ",pnplayer_is_mobile());
                if (margs.autoplay == 'on' && pnplayer_is_mobile() == false) {
                    play_media_visual();
                    setTimeout(function() {
                        play_media({
            ...
            function setup_controls_commentsHolder() {
                if (_commentsChildren) {
                    // console.info(' _commentsChildren - ',_commentsChildren, cthis);
                    _commentsChildren.each(function() {
                        var _c = $(this);
                        // console.warn(' _c -> - ',_c, cthis);
                        if (o.skinwave_comments_process_in_php == 'on') {
                            if (_c && _c.hasClass && _c.hasClass('dzstooltip-con')) {
                                if (_c.find('.dzstooltip > .dzstooltip--inner')
                                    .length) {} else {
                                    // -- convert
                                    // console.error("CONVERT");
                                    _c.find('.dzstooltip').wrapInner(
                                        '<div class="dzstooltip--inner"></div>');
                                    _c.find('.the-avatar').addClass(
                                        'tooltip-indicator');
                                    _c.find('.dzstooltip').before(_c.find(
                                        '.tooltip-indicator'));
                                    _c.find('.dzstooltip').addClass(
                                        'talign-start style-rounded color-dark-light'
                                        );
                                }
                            }
                        }
            ...
            function click_comments_bg(e) {
                ...
                if (o.skinwave_comments_allow_post_if_not_logged_in == 'off' && o
                    .skinwave_comments_account == 'none') {
                    return false;
                }
                var sw = true;
                ...
                if (aux3 < comments_offset) {
                    ...
                    // console.error(aux4);
                    cthis.append(
                        '<style class="comments-writter-temp-css">.audioplayer.skin-wave .comments-writer .comments-writer-inner:before{ left:' +
                        aux4 + 'px  }</style>');
                } else {
                    if (aux3 > tw - comments_offset - (_commentsWriter.width() / 2)) {
                        aux4 = lmx - (_commentsWriter.offset().left - cthis.offset().left) + (
                            _commentsWriter.width() / 3);
                ...
                if (_commentsWriter.hasClass('active') == false) {
                    _commentsWriter.css({
                        'height': _commentsWriter.find('.comments-writer-inner').eq(0)
                            .outerHeight() + 20
                    });
                    _commentsWriter.addClass('active');
                    cthis.addClass('comments-writer-active');
                    if (o.parentgallery && $(o.parentgallery).get(0) != undefined && $(o
                            .parentgallery).get(0).api_handleResize != undefined) {
            ...
            function add_comments_placeholder(sposarg) {
                _commentsHolder.remove('.pnplayer-style-comments');
                _commentsHolder.append(
                    '<style class="pnplayer-style-comments">.dzstooltip-con:not(.placeholder) { opacity: 0.5; }</style>'
                    )
                _commentsHolder.find('.dzstooltip-con.placeholder').remove();
                _commentsHolder.append(
                    '<span class="dzstooltip-con placeholder" style="left:' + sposarg +
                    ';"><div class="the-avatar" style="background-image: url(' + o
                    .skinwave_comments_avatar + ')"></div></span>');
            }
            ...
            function comment_submit(comment_text, comment_email, comment_username) {
                ...
                if (comment_email) {
                    ...
                    if (_commentsSelector) {
                        _commentsSelector.find('*[name=comment_email],*[name=comment_user]')
                            .remove();
                    }
                    o.skinwave_comments_avatar = 'https://secure.gravatar.com/avatar/' + MD5(
                        String(cthis.find('input[name=comment-email]').eq(0).val())
                        .toLowerCase()) + '?s=20';
                } else {}
                ...
                if (o.skinwave_comments_process_in_php != 'on') {
                    ...
                    aux += '<span class="dzstooltip-con pnplayer-comment" style="left:' +
                        sposarg +
                        '"><div class="the-avatar tooltip-indicator" style="background-image: url(' +
                        o.skinwave_comments_avatar +
                        ')"></div><span class="dzstooltip style-rounded color-dark-light talign-start  transition-slidein arrow-bottom " style="width: 250px;"><span class="the-comment-author">@' +
                        comm_author + '</span> says:<br>';
                ...
                cthis.find('.comments-writter-temp-css,.pnplayer-style-comments').remove();
                skinwave_comment_publish(aux)
                hide_comments_writer();
                if (o.parentgallery && $(o.parentgallery).get(0) != undefined && $(o
                        .parentgallery).get(0).api_player_commentSubmitted != undefined) {
            ...
            function hide_comments_writer() {
                ...
                setTimeout(function() {
                    cthis.find('.comments-writter-temp-css,.pnplayer-style-comments')
                        .remove();
                }, 300);
                //cthis.unbind('focusout', blur_ap);
            }
            ...
            function change_yt_state(arg) {
                ...
                if (arg.data == 1) {
                    ...
                    cthis.addClass('pnplayer-loaded');
                }
                if (arg.data == -1) {
            ...
            function wave_mode_canvas_try_to_get_pcm(pargs) {
                ...
                if (cthis.attr('data-pcm')) {} else {
                    var data = {
                        action: 'pnplayer_get_pcm',
                        postdata: '1',
                    ...
                    if (o.settings_php_handler) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response) {
                                    if (response != '0' && response.indexOf(',') >
                                        -1) {
                                    ...
                                    if (o.cue == 'on') {
                                        ...
                                        pcm_promise_generate_on_meta_load =
                                        true; // -- we are promising generating on meta load
                                        if (o
                                            .pcm_data_try_to_generate_wait_for_real_pcm ==
                                            'on') {
                                            ...
                                            for (var i3 = 0; i3 < 200; i3++) {
                                                default_pcm[i3] = Number(Math
                                                    .random()).toFixed(3);
                                            }
                                            default_pcm = JSON.stringify(
                                                default_pcm);
                                            generate_wave_data_animate(
                                                default_pcm);
                                            pcm_is_real = false;
                                        }
                                    }
            ...
            function send_pcm(ar_str) {
                ...
                console.info("which is fake player ? ", cthis, o.fakeplayer,
                _feed_fakePlayer);
            ...
            function generate_wave_data(pargs) {
                ...
                if (src_real_mp3 != 'fake') {} else {
                    return false;
                }
                if (window.pnplayer_generating_pcm) {
                    setTimeout(function() {
                        generate_wave_data(margs)
                    }, 1000);
                    return false;
                }
                window.pnplayer_generating_pcm = true;
                // console.info('generate_wave_data margs - ', margs);
                ...
                if (String(cthis.attr('data-source')).indexOf('https://soundcloud.com') ==
                    0 || cthis.attr('data-source') == 'fake') {
                    return;
                }
                if (String(cthis.attr('data-source')).indexOf('https://api.soundcloud.com') ==
                    0) {}
                ...
                wavesurfer.on('ready', function() {
                    ...
                    var ar_str = wavesurfer.exportPCM(o.wavesurfer_pcm_length,
                        accuracy, true);
            ...
            function generate_wave_data_animate(argpcm) {
                ...
                _scrubbar.find('.scrub-bg-img,.scrub-prog-img').removeClass(
                    'transitioning-in');
                ...
                draw_canvas(_scrubbarprog_canvas.get(0), argpcm, '#' + o
                    .design_wave_color_progress, {
                ...
                _scrubbar.find(
                    ...
                    .animate({
                        ...
                        complete: function() {
                            ...
                            _con.children('.transitioning-in').removeClass(
                                'transitioning-in');
                        }
                    });
            ...
            function struct_generate_thumb() {
                ...
                if (cthis.attr('data-thumb')) {
                    ...
                    aux_thumb_con_str +=
                        ' class="the-thumb-con"><div class="the-thumb" style=" background-image:url(' +
                        cthis.attr('data-thumb') + ')"></div>';
                    if (cthis.attr('data-thumb_link')) {
                        aux_thumb_con_str += '</a>';
                    } else {
                        aux_thumb_con_str += '</div>';
            ...
            function apply_skinwave_mode_class() {
                ...
                if (o.design_skin == 'skin-wave') {
                    ...
                    cthis.addClass('skin-wave-wave-mode-canvas-mode-' + o
                        .skinwave_wave_mode_canvas_mode);
                }
            }
            ...
            function retrieve_soundcloud_url(pargs) {
                ...
                var aux = 'http://api.' + 'soundcloud.com' + '/resolve?url=' + data_source +
                    '&format=json&consumer_key=' + o.soundcloud_apikey;
                //console.info(aux);
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            if (data == '') {
                                cthis.addClass('errored-out');
                                cthis.append(
                                    '<div class="feedback-text">soundcloud track does not seem to serve via api</div>'
                                    );
                            }
                            //console.info('o.design_skin - ', o.design_skin);
                            original_real_mp3 = cthis.attr('data-source');
                            if (data.stream_url) {
                                cthis.attr('data-source', data.stream_url +
                                    '?consumer_key=' + o.soundcloud_apikey +
                                    '&origin=localhost');
                                if (_feed_fakeButton) {
                                    _feed_fakeButton.attr('data-source', cthis
                                        .attr('data-source'));
                                }
                                if (_feed_fakePlayer) {
                                    _feed_fakePlayer.attr('data-source', cthis
                                        .attr('data-source'));
                                }
                            } else {
                                cthis.addClass('errored-out');
                                cthis.append(
                                    '<div class="feedback-text ">this soundcloud track does not allow streaming  </div>'
                                    );
                            }
                            src_real_mp3 = cthis.attr('data-source');
                            ...
                            console.log('soduncloud parse error -', response,
                                ' - ', soundcloud_retriever);
                        }
                    }
                });
            }
            ...
            function playlist_goto_item(arg, pargs) {
                ...
                console.info('playlist_goto_item - margs - ', margs);
                var _cach_con = _playlistTooltip.find('.dzstooltip--inner');
                var _cach = _cach_con.children().eq(arg);
                // console.info(_cach);
                var playerid = _cach.attr('data-playerid');
                if (playerid && $('.audioplayer[data-playerid="' + playerid + '"]').length &&
                    $('.audioplayer[data-playerid="' + playerid + '"]').eq(0).get(0)
                    .api_play_media) {
                    $('.audioplayer[data-playerid="' + playerid + '"]').eq(0).get(0)
                        .api_play_media({
            ...
            function setup_playlist_inner(pargs) {
                ...
                console.info('setup_playlist_inner() pnplayer_list_for_sync_players -4 ',
                    pnplayer_list_for_sync_players, margs);
                _playlistTooltip.find('.dzstooltip--inner').html('');
                var aux = '';
                for (var lab in pnplayer_list_for_sync_players) {
                    var _c = pnplayer_list_for_sync_players[lab];
                    ...
                    $.each(_c.get(0).attributes, function() {
                        ...
                        if (this.specified && this.name && this.name != 'id' && this
                            .name != 'style') {
                    ...
                    aux += '<div class="pi-thumb divimage" style="background-image: url(' + _c
                        .attr('data-thumb') + ')">';
                    aux += '</div>'
                    aux += '</div>'
                ...
                $(document).on('mousemove.pnplayer_playlist_item', function(e) {
                    if (window.pnplayer_moving_playlist_item) {
                        var my = e.clientY;
                        my -= pnplayer_playlist_con.offset().top;
                        // console.info(mx,my);
                        pnplayer_playlist_item_moving.css('top', my - 20);
                        pnplayer_playlist_item_target.parent().children(
                            ':not(".target-playlist-item"):not(".cloner")').each(
                            function() {
                                var _t = $(this);
                                var tmy = _t.offset().top - pnplayer_playlist_con
                                    .offset().top;
                                // console.info(my,tmy);
                                if (my > tmy) {
                                    _t.after(pnplayer_playlist_item_target);
                                }
                            })
                        if (my < 50) {
                            pnplayer_playlist_item_target.parent().prepend(
                                pnplayer_playlist_item_target);
                        }
                    }
                });
                $(document).on('mouseup.pnplayer_playlist_item', function(e) {
                    if (window.pnplayer_moving_playlist_item) {
                        window.pnplayer_moving_playlist_item = false;
                        pnplayer_playlist_item_moving.parent().children('.cloner')
                            .remove();
                        pnplayer_playlist_item_target.removeClass(
                            'target-playlist-item');
                        pnplayer_playlist_item_moving.remove();
                        pnplayer_playlist_item_moving = null;
                        pnplayer_playlist_item_target = null;
                    }
                })
            }
            ...
            function setup_structure(pargs) {
                ...
                if (o.design_skin == 'skin-customcontrols') {
                    ...
                    cthis.html(String(cthis.html()).replace('{{svg_play_icon}}',
                        svg_play_icon));
                    cthis.html(String(cthis.html()).replace('{{svg_pause_icon}}',
                        pausebtn_svg));
                }
                ...
                if (cthis.attr('data-wrapper-image')) {
                    ...
                    if (cthis.hasClass('pnplayer-no-wrapper') == false) {
                        img.onload = function() {
                            // console.info('image loaded', this, this.src);
                            cthis.css('background-image', 'url(' + this.src + ')');
                            // _audioplayerInner.prepend('<div class="pnplayer-bg" style="background-image: url('+this.src+'); "></div>');
                            setTimeout(function() {
                                cthis.find('.pnplayer-bg').addClass('loaded');
                                //var tw = cthis.width();
                                if (tw > 300) {
                                    tw = 300;
                                }
                                if (cthis.hasClass(
                                    'pnplayer-wrapper-bg-bellow')) {
                ...
                aux_str_scrubbar +=
                    '<div class="scrub-bg"></div><div class="scrub-buffer"></div><div class="scrub-prog"></div><div class="scrubBox"></div><div class="scrubBox-prog"></div><div class="scrubBox-hover"></div>';
                ...
                if (sample_perc_start) {
                    aux_str_scrubbar += '<div class="sample-block-start" style="width: ' + (
                        sample_perc_start * 100) + '%"></div>'
                }
                if (sample_perc_end) {
                    aux_str_scrubbar += '<div class="sample-block-end" style="left: ' + (
                        sample_perc_end * 100) + '%; width: ' + (100 - (sample_perc_end *
                        100)) + '%"></div>'
                }
                ...
                // console.info(cthis.find('.feed-pnplayer-before-playpause'));
                struct_con_playpause += '<div class="con-playpause-con">';
                if (cthis.find('.feed-pnplayer-before-playpause').length) {
                    struct_con_playpause += cthis.find('.feed-pnplayer-before-playpause').eq(
                        0).html();
                    cthis.find('.feed-pnplayer-before-playpause').remove();
                }
                ...
                if (keyboard_controls.show_tooltips == 'on') {
                    struct_con_playpause += pnplayer_generate_keyboard_tooltip(
                        keyboard_controls, 'pause_play');
                }
                struct_con_playpause +=
                    '<div class="playbtn"><div class="the-icon-bg"></div><div class="pnplayer-play-icon">';
                var has_svg_icons = false;
                if (cthis.hasClass('button-aspect-noir') || cthis.hasClass('skin-pro') ||
                    cthis.hasClass('skin-silver') || cthis.hasClass('skin-default')) {
                    has_svg_icons = true;
                }
                ...
                struct_con_playpause +=
                    '<div class="pausebtn" style="display:none"><div class="the-icon-bg"></div><div class="pause-icon"><div class="pause-part-1"></div><div class="pause-part-2"></div>';
                if (has_svg_icons) {
                    // console.info("HMM dada2", cthis);
                ...
                struct_con_playpause += '</div>';
                if (cthis.find('.feed-pnplayer-after-playpause').length) {
                    struct_con_playpause += cthis.find('.feed-pnplayer-after-playpause').eq(0)
                        .html();
                    // console.warn('cthis.find(\'.feed-pnplayer-after-playpause\') - ',cthis.find('.feed-pnplayer-after-playpause'));
                    cthis.find('.feed-pnplayer-after-playpause').remove();
                }
                struct_con_playpause += '</div>';
                // struct_con_playpause = '';
                aux_str_con_controls +=
                    '<div class="con-controls"><div class="the-bg"></div>' +
                    struct_con_playpause;
                ...
                if (o.design_skin == 'skin-wave' && skinwave_mode == 'small') {
                    aux_str_con_controls =
                        ...
                        struct_con_playpause + '</div>' + aux_str_scrubbar +
                        '<div class="ap-controls-right">' + aux_str_con_volume +
                        '<div class="extrahtml-in-float-right for-skin-wave-small">' + o
                        .settings_extrahtml_in_float_right + '</div></div>';
                    _apControls.append(aux_str_con_controls);
                } else {
                    // -- other skins
                    if (o.design_skin == 'skin-aria' || o.design_skin == 'skin-silver' || o
                        .design_skin == 'skin-redlights' || o.design_skin == 'skin-steel') {
                        ...
                        if (o.design_skin == 'skin-redlights' || o.design_skin ==
                            'skin-steel') {
                            playbtn_svg = '';
                            pausebtn_svg = '';
                        }
                        ...
                        if (o.design_skin == 'skin-silver') {
                            ...
                            aux_str_con_controls += '">';
                            if (keyboard_controls.show_tooltips == 'on') {
                                aux_str_con_controls += pnplayer_generate_keyboard_tooltip(
                                    keyboard_controls, 'pause_play');
                            }
                            aux_str_con_controls +=
                                '<div class="playbtn"><div class="pnplayer-play-icon">' +
                                playbtn_svg +
                                '</div><div class="play-icon-hover"></div></div><div class="pausebtn" style="display:none"><div class="pause-icon">' +
                                pausebtn_svg +
                                '</div><div class="pause-icon-hover"></div></div></div>'; // -- enc con-playpause
                        }
                        // console.info('cthis.find(\'.feed-pnplayer-after-playpause\') - ',cthis.find('.feed-pnplayer-after-playpause'));
                        if (cthis.find('.feed-pnplayer-after-playpause').length) {
                            aux_str_con_controls += cthis.find(
                                '.feed-pnplayer-after-playpause').eq(0).html();
                            cthis.find('.feed-pnplayer-after-playpause').remove();
                        }
                        if (o.design_skin == 'skin-silver') {
                        ...
                        if (o.settings_extrahtml_in_float_right) {
                            aux_str_con_controls += '<div class="controls-right">' + o
                                .settings_extrahtml_in_float_right + '</div>';
                        ...
                        if (o.design_skin == 'skin-silver') {
                            ...
                            if (o.design_skin == 'skin-redlights') {
                                if (o.disable_volume != 'on') {
                                    aux_str_con_controls +=
                                        '<div class="controls-volume"><div class="volumeicon"></div><div class="volume_static">' +
                                        svg_volume_static +
                                        '</div><div class="volume_active"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="57px" height="12px" viewBox="0 0 57 12" enable-background="new 0 0 57 12" xml:space="preserve"> <rect y="9" fill="#414042" width="3" height="3"/> <rect x="6" y="8" fill="#414042" width="3" height="4"/> <rect x="12" y="7" fill="#414042" width="3" height="5"/> <rect x="18" y="5.958" fill="#414042" width="3" height="6"/> <rect x="24" y="4.958" fill="#414042" width="3" height="7"/> <rect x="30" y="4" fill="#414042" width="3" height="8"/> <rect x="36" y="3" fill="#414042" width="3" height="9"/> <rect x="42" y="2" fill="#414042" width="3" height="10"/> <rect x="48" y="1" fill="#414042" width="3" height="11"/> <rect x="54" fill="#414042" width="3" height="12"/> </svg></div><div class="volume_cut"></div></div>';
                                }
                                aux_str_con_controls += '<div class="clear"></div>';
                            }
                ...
                if (o.settings_extrahtml_in_float_right) {
                    // aux_str_con_controls += ;
                    if (String(o.settings_extrahtml_in_float_right).indexOf(
                            'pnplayer-multisharer-but') > -1) {
                        sw_enable_multisharer = true;;
                    }
                    var finstring = '';
                    if (o.design_skin == 'skin-wave' && skinwave_mode == 'small') {} else {
                        finstring +=
                            '<div class="extrahtml-in-float-right from-setup_structure">' + o
                            .settings_extrahtml_in_float_right + '</div>';
                    }
                    if (o.design_skin == 'skin-wave' || o.design_skin == 'skin-default') {
                        cthis.find('.ap-controls-right').eq(0).append(finstring);
                        // console.info('cthis.find(\'.ap-controls-right\') - ', cthis.find('.ap-controls-right'));
                    }
                    if (o.design_skin == 'skin-pro') {
                ...
                if (o.footer_btn_playlist == 'on') {
                    _apControlsRight.appendOnce(
                        '<div class="btn-footer-playlist dzstooltip-con player-but"> <div class="tooltip-indicator tooltip-indicator--btn-footer-playlist"><div class="the-icon-bg"></div> <svg class="svg-icon" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="13.25px" height="13.915px" viewBox="0 0 13.25 13.915" enable-background="new 0 0 13.25 13.915" xml:space="preserve"> <path d="M1.327,4.346c-0.058,0-0.104-0.052-0.104-0.115V2.222c0-0.063,0.046-0.115,0.104-0.115H11.58 c0.059,0,0.105,0.052,0.105,0.115v2.009c0,0.063-0.046,0.115-0.105,0.115H1.327z"/> <path d="M1.351,8.177c-0.058,0-0.104-0.051-0.104-0.115V6.054c0-0.064,0.046-0.115,0.104-0.115h10.252 c0.058,0,0.105,0.051,0.105,0.115v2.009c0,0.063-0.047,0.115-0.105,0.115H1.351z"/> <path d="M1.351,12.182c-0.058,0-0.104-0.05-0.104-0.115v-2.009c0-0.064,0.046-0.115,0.104-0.115h10.252 c0.058,0,0.105,0.051,0.105,0.115v2.009c0,0.064-0.047,0.115-0.105,0.115H1.351z"/> </svg>    </div><div class="dzstooltip playlist-tooltip style-default color-light-dark arrow-bottom talign-end transition-scaleup active2"><div class="dzstooltip--inner"> </div></div></div>'
                        );
                ...
                if (cthis.find('.feed-pnplayer-after-con-controls').length) {
                    _apControls.append(cthis.find('.feed-pnplayer-after-con-controls').eq(0)
                        .html());
                    cthis.find('.feed-pnplayer-after-con-controls').remove();
                }
                ...
                if (cthis.attr("data-type") == 'fake') {
                    if (cthis.find('.meta-artist').length == 0) {
                        cthis.append(
                            '<span class="meta-artist"><span class="the-artist"></span><span class="the-name"></span></span>'
                            )
                    }
                }
                ...
                if (!_metaArtistCon || margs.call_from == 'reconstruct') {
                    ...
                    _audioplayerInner.find('.meta-artist').eq(0).wrap(
                        '<div class="meta-artist-con"></div>');
                    //console.info('ceva');
                    ...
                    if (o.design_skin == 'skin-wave') {
                        ...
                        if (cthis.find('.pnplayer-repeat-button').length) {
                            cthis.find('.pnplayer-repeat-button').after(_metaArtistCon);
                        } else {
                            if (cthis.find('.pnplayer-loop-button').length) {
                                cthis.find('.pnplayer-loop-button').after(_metaArtistCon);
                            } else {
                ...
                if (o.design_skin == 'skin-wave' && o.parentgallery && typeof(o
                    .parentgallery) != 'undefined' && o
                    .design_menu_show_player_state_button == 'on') {
                    if (o.design_skin == 'skin-wave') {
                        if (_apControlsRight) {
                            _apControlsRight.appendOnce(
                                '<div class="btn-menu-state player-but"> <div class="the-icon-bg"></div> <svg class="svg-icon" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="13.25px" height="13.915px" viewBox="0 0 13.25 13.915" enable-background="new 0 0 13.25 13.915" xml:space="preserve"> <path d="M1.327,4.346c-0.058,0-0.104-0.052-0.104-0.115V2.222c0-0.063,0.046-0.115,0.104-0.115H11.58 c0.059,0,0.105,0.052,0.105,0.115v2.009c0,0.063-0.046,0.115-0.105,0.115H1.327z"/> <path d="M1.351,8.177c-0.058,0-0.104-0.051-0.104-0.115V6.054c0-0.064,0.046-0.115,0.104-0.115h10.252 c0.058,0,0.105,0.051,0.105,0.115v2.009c0,0.063-0.047,0.115-0.105,0.115H1.351z"/> <path d="M1.351,12.182c-0.058,0-0.104-0.05-0.104-0.115v-2.009c0-0.064,0.046-0.115,0.104-0.115h10.252 c0.058,0,0.105,0.051,0.105,0.115v2.009c0,0.064-0.047,0.115-0.105,0.115H1.351z"/> </svg>    </div></div>'
                                );
                        } else {
                ...
                if (o.settings_extrahtml_after_artist) {
                    _metaArtistCon.find('.the-artist').append(o
                ...
                if (o.design_skin == 'skin-wave' && o.embed_code != '') {
                    if (o.design_skin == 'skin-wave') {
                        if (o.enable_embed_button == 'on') {
                            if (_apControlsRight) {
                                _apControlsRight.appendOnce(
                                    '<div class="btn-embed-code-con dzstooltip-con "><div class="btn-embed-code player-but"> <div class="the-icon-bg"></div> ' +
                                    svg_embed_button +
                                    '</div><span class="dzstooltip transition-slidein arrow-bottom align-right skin-black " style="width: 350px; "><span style="max-height: 150px; overflow:hidden; display: block;">' +
                                    o.embed_code + '</span></span></div>');
                            }
                        }
                    } else {
                        if (o.enable_embed_button == 'on') {
                ...
                if (cthis.hasClass('skin-minimal')) {
                    ...
                    cthis.find('.the-bg').before(
                        '<div class="skin-minimal-bg skin-minimal--outer-bg"></div><div class="skin-minimal-bg skin-minimal--inner-bg-under"></div><div class="skin-minimal-bg skin-minimal--inner-bg"></div><div class="skin-minimal-bg skin-minimal--inner-inner-bg"></div>'
                        )
                    cthis.find('.the-bg').append(
                ...
                if (typeof(o.parentgallery) != 'undefined' && o.disable_player_navigation !=
                    'on') {
                ...
                if (cthis.hasClass('skin-minion')) {
                    if (cthis.find('.menu-description').length > 0) {
                        ...
                        _conPlayPause.prepend('<span class="dzstooltip" style="left:-7px;">' +
                            cthis.find('.menu-description').html() + '</span>');
                        //console.info(_conPlayPause.children('span').eq(0), _conPlayPause.children('span').eq(0).textWidth());
                        _conPlayPause.children('span').eq(0).css('width', _conPlayPause
                            .children('span').eq(0).textWidth() + 10);
                    }
                }
                ...
                if (o.player_navigation == 'on') {
                    var prev_btn_str =
                        '<div class="prev-btn player-but"><div class="the-icon-bg"></div><svg class="svg-icon" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="14px" height="14px" viewBox="0 0 12.5 12.817" enable-background="new 0 0 12.5 12.817" xml:space="preserve"> <g> <g> <g> <path fill="#D2D6DB" d="M2.581,7.375c-0.744-0.462-1.413-0.94-1.486-1.061C1.021,6.194,1.867,5.586,2.632,5.158l2.35-1.313 c0.765-0.427,1.505-0.782,1.646-0.789s0.257,1.03,0.257,1.905V7.87c0,0.876-0.051,1.692-0.112,1.817 C6.711,9.81,5.776,9.361,5.032,8.898L2.581,7.375z"/> </g> </g> </g> <g> <g> <g> <path fill="#D2D6DB" d="M6.307,7.57C5.413,7.014,4.61,6.441,4.521,6.295C4.432,6.15,5.447,5.42,6.366,4.906l2.82-1.577 c0.919-0.513,1.809-0.939,1.979-0.947s0.309,1.236,0.309,2.288v3.493c0,1.053-0.061,2.033-0.135,2.182S10.144,9.955,9.25,9.4 L6.307,7.57z"/> </g> </g> </g> </svg> </div>';
                    var next_btn_str =
                        '<div class="next-btn player-but"><div class="the-icon-bg"></div><svg class="svg-icon" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="14px" height="14px" viewBox="0 0 12.5 12.817" enable-background="new 0 0 12.5 12.817" xml:space="preserve"> <g> <g> <g> <path fill="#D2D6DB" d="M9.874,5.443c0.744,0.462,1.414,0.939,1.486,1.06c0.074,0.121-0.771,0.729-1.535,1.156L7.482,8.967 C6.719,9.394,5.978,9.75,5.837,9.756C5.696,9.761,5.581,8.726,5.581,7.851V4.952c0-0.875,0.05-1.693,0.112-1.816 c0.062-0.124,0.995,0.326,1.739,0.788L9.874,5.443z"/> </g> </g> </g> <g> <g> <g> <path fill="#D2D6DB" d="M6.155,5.248c0.893,0.556,1.696,1.129,1.786,1.274c0.088,0.145-0.928,0.875-1.847,1.389l-2.811,1.57 c-0.918,0.514-1.808,0.939-1.978,0.947c-0.169,0.008-0.308-1.234-0.308-2.287V4.66c0-1.052,0.061-2.034,0.135-2.182 s1.195,0.391,2.089,0.947L6.155,5.248z"/> </g> </g> </g> </svg>  </div>';
                    if (o.design_skin == 'skin-steel') {
                        prev_btn_str =
                            '<div class="prev-btn player-but"><svg class="svg1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="13.325px" viewBox="0 0 10 13.325" enable-background="new 0 0 10 13.325" xml:space="preserve"> <g id="Layer_2"> <polygon opacity="0.5" fill="#E6E7E8" points="3.208,7.674 5.208,9.104 5.208,5.062 3.208,5.652 "/> </g> <g id="Layer_1"> <rect x="0.306" y="3.074" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -1.4203 4.7299)" fill="#E6E7E8" width="9.386" height="2.012"/> <rect x="0.307" y="8.29" transform="matrix(0.7072 0.707 -0.707 0.7072 8.0362 -0.8139)" fill="#E6E7E8" width="9.387" height="2.012"/> </g> </svg> <svg class="svg2"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="13.325px" viewBox="0 0 10 13.325" enable-background="new 0 0 10 13.325" xml:space="preserve"> <g id="Layer_2"> <polygon opacity="0.5" fill="#E6E7E8" points="3.208,7.674 5.208,9.104 5.208,5.062 3.208,5.652 "/> </g> <g id="Layer_1"> <rect x="0.306" y="3.074" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -1.4203 4.7299)" fill="#E6E7E8" width="9.386" height="2.012"/> <rect x="0.307" y="8.29" transform="matrix(0.7072 0.707 -0.707 0.7072 8.0362 -0.8139)" fill="#E6E7E8" width="9.387" height="2.012"/> </g> </svg></div>';
                        next_btn_str =
                            '<div class="next-btn player-but"><svg class="svg1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="13.325px" viewBox="0 0 10 13.325" enable-background="new 0 0 10 13.325" xml:space="preserve"> <g id="Layer_2"> <polygon opacity="0.5" fill="#E6E7E8" points="7.035,5.695 5.074,4.292 5.074,8.257 7.035,7.678 "/> </g> <g id="Layer_1"> <rect x="0.677" y="8.234" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 15.532 12.0075)" fill="#E6E7E8" width="9.204" height="1.973"/> <rect x="0.674" y="3.118" transform="matrix(-0.7072 -0.707 0.707 -0.7072 6.1069 10.7384)" fill="#E6E7E8" width="9.206" height="1.974"/> </g> </svg><svg class="svg2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="13.325px" viewBox="0 0 10 13.325" enable-background="new 0 0 10 13.325" xml:space="preserve"> <g id="Layer_2"> <polygon opacity="0.5" fill="#E6E7E8" points="7.035,5.695 5.074,4.292 5.074,8.257 7.035,7.678 "/> </g> <g id="Layer_1"> <rect x="0.677" y="8.234" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 15.532 12.0075)" fill="#E6E7E8" width="9.204" height="1.973"/> <rect x="0.674" y="3.118" transform="matrix(-0.7072 -0.707 0.707 -0.7072 6.1069 10.7384)" fill="#E6E7E8" width="9.206" height="1.974"/> </g> </svg></div>';
                    }
                    ...
                    if (o.design_skin == 'skin-wave' && skinwave_mode == 'small') {
                        ...
                        if (o.design_skin == 'skin-wave') {
                            ...
                            if (_apControlsLeft.children('.the-thumb-con').length > 0) {
                                ...
                                if (_apControlsLeft.children('.the-thumb-con').eq(0).length >
                                    0) {
                                    if (_apControlsLeft.children('.the-thumb-con').eq(0)
                                        .prev().hasClass('next-btn') == false) {
                                        _apControlsLeft.children('.the-thumb-con').eq(0)
                                            .before(next_btn_str);
                                    }
                                }
                            } else {
                ...
                if (o.settings_extrahtml != '') {
                    ...
                    o.settings_extrahtml = String(o.settings_extrahtml).replace(
                        '{{heart_svg}}', svg_heart_icon);
                    o.settings_extrahtml = String(o.settings_extrahtml).replace(
                        '{{embed_code}}', o.embed_code);
                    ...
                    setTimeout(function() {
                        ...
                        // cthis.find('.extra-html-extra').removeClass('pnplayer-feed');
                        if (cthis.find('.float-left').length == 0) {
                            cthis.find('.extra-html').append(cthis.find(
                                '.extra-html-extra'));
                        } else {
                            cthis.find('.extra-html .float-left').append(cthis.find(
                                '.extra-html-extra'));
                        }
                        ...
                        if (cthis.find('.extra-html').html().indexOf(
                                'pnplayer-multisharer-but') > -1) {
                            sw_enable_multisharer = true;
                        }
                    }, 2000);
                ...
                if (cthis.hasClass('pnplayer-wrapper-bg-bellow') && cthis.find(
                        '.pnplayer-wrapper-buts').length == 0) {
                    ...
                    cthis.find('.temp-wrapper').children('*:not(.pnplayer-wrapper-but)')
                        .remove();
                    cthis.find('.temp-wrapper > .pnplayer-wrapper-but').unwrap();
                    cthis.children('.pnplayer-wrapper-but').each(function() {
                        var aux = $(this).html();
                        // console.info('aux - ',aux);
                        aux = aux.replace('{{heart_svg}}', svg_heart_icon);
                        aux = aux.replace('{{svg_share_icon}}', svg_share_icon);
                        if ($(this).get(0) && $(this).get(0).outerHTML.indexOf(
                                'pnplayer-multisharer-but') > -1) {
                            sw_enable_multisharer = true;
                            console.info("sw_enable_multisharer",
                                sw_enable_multisharer);
                        }
                        $(this).html(aux);
                    }).wrapAll('<div class="pnplayer-wrapper-buts"></div>');
                }
                if (cthis.hasClass('skinvariation-wave-bigtitles')) {
                    if (cthis.find('.controls-volume').length && _metaArtistCon.find(
                            '.controls-volume').length == 0) {
            ...
            function check_multisharer() {
                cthis.find('.pnplayer-multisharer-but').data('cthis', cthis);
                // console.warn("WE SETUP HERE", cthis.find('.pnplayer-multisharer-but').data('cthis'));
                if (sw_enable_multisharer) {
                    setTimeout(function() {
                        ...
                        // console.info('window.pnplayer_multisharer_assets_loaded - ',window.pnplayer_multisharer_assets_loaded);
                        if (window.pnplayer_multisharer_assets_loaded) {} else {
                            if (window.pnplayer_multisharer_assets_loaded != true && o
                                .settings_php_handler && window
                                .loading_multi_sharer != true) {
                                // -- only if settings_php_handler is set
                                window.loading_multi_sharer = true;
                                var head = document.getElementsByTagName('head')[0];
                                var link = document.createElement('link');
                                link.id = 'pnplayer-load-multi-sharer';
                                link.rel = 'stylesheet';
                                link.type = 'text/css';
                                link.href = add_query_arg(o.settings_php_handler,
                                    'load-lightbox-css', 'on');
                                link.media = 'all';
                                head.appendChild(link);
                                // console.warn("APPEND MULTISHARER STYLE");
                                setTimeout(function() {
                                    if (pnplayer_box_main_con == null) {
                                        $('body').append(
                                            '<div class="pnplayer-main-con skin-default gallery-skin-default transition-slideup "> <div class="overlay-background"></div> <div class="box-mains-con"> <div class="box-main box-main-for-share" style=""> <div class="box-main-media-con transition-target"> <div class="close-btn-con"> <svg enable-background="new 0 0 40 40" id="" version="1.1" viewBox="0 0 40 40" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M28.1,26.8c0.4,0.4,0.4,1,0,1.4c-0.2,0.2-0.5,0.3-0.7,0.3s-0.5-0.1-0.7-0.3l-6.8-6.8l-6.8,6.8c-0.2,0.2-0.5,0.3-0.7,0.3 s-0.5-0.1-0.7-0.3c-0.4-0.4-0.4-1,0-1.4l6.8-6.8l-6.8-6.8c-0.4-0.4-0.4-1,0-1.4c0.4-0.4,1-0.4,1.4,0l6.8,6.8l6.8-6.8 c0.4-0.4,1-0.4,1.4,0c0.4,0.4,0.4,1,0,1.4L21.3,20L28.1,26.8z"></path></g><g><path d="M19.9,40c-11,0-20-9-20-20s9-20,20-20c4.5,0,8.7,1.5,12.3,4.2c0.4,0.3,0.5,1,0.2,1.4c-0.3,0.4-1,0.5-1.4,0.2 c-3.2-2.5-7-3.8-11-3.8c-9.9,0-18,8.1-18,18s8.1,18,18,18s18-8.1,18-18c0-3.2-0.9-6.4-2.5-9.2c-0.3-0.5-0.1-1.1,0.3-1.4 c0.5-0.3,1.1-0.1,1.4,0.3c1.8,3.1,2.8,6.6,2.8,10.2C39.9,31,30.9,40,19.9,40z"></path></g></svg></div> <div class="box-main-media type-inlinecontent" style="width: 530px; height: 280px;"><div class=" real-media" style=""><div class="hidden-content share-content" > <div class="social-networks-con"></div> <div class="share-link-con"></div> <div class="embed-link-con"></div> </div> </div> </div> <div class="box-main-under"></div> </div> </div> </div><!-- end .box-mains-con--> </div>'
                                            );
                                        pnplayer_box_main_con = $(
                                            '.pnplayer-main-con').eq(0);
                                        // console.info('pnplayer_box_main_con - ',pnplayer_box_main_con);
                                    }
                                }, 1000);
                            }
                        }
                        $(document).on('click.pnplayer',
                            '.pnplayer-main-con .close-btn-con,.pnplayer-main-con .overlay-background',
                            function() {
                                var _c = $('.pnplayer-main-con').eq(0);
            ...
            function setup_pcm_random_for_now(pargs) {
                ...
                var default_pcm = [];
                if ((o.pcm_data_try_to_generate == 'on' && o
                        .pcm_data_try_to_generate_wait_for_real_pcm == 'on') == false) {
                    for (var i3 = 0; i3 < 200; i3++) {
            ...
            function setup_structure_scrub_canvas(pargs) {
                ...
                aux += '" ></canvas>';
                if (_scrubbar.children('.scrub-prog').eq(0).find('.scrub-prog-img').length ==
                    0) {}
                ...
                if (o.skinwave_enableSpectrum != 'on') {
                    if (o.skinwave_wave_mode == 'canvas') {
                        ...
                        if (o.skinwave_wave_mode == 'image') {
                            var aux = '<img class="scrub-bg--img" src="' + cthis.attr(
                                'data-scrubbg') + '"/>'
                            _scrubbar.children('.scrub-bg').eq(0).append(aux);
                            setTimeout(function() {
                                show_scrubbar();
                            }, 300);
                            aux = '<img class="scrub-prog--img" src="' + cthis.attr(
                                'data-scrubprog') + '"/>'
                            _scrubbar.children('.scrub-prog').eq(0).append(aux);
                            setTimeout(function() {
                                show_scrubbar();
            ...
            function draw_canvas(_arg, pcm_arr, hexcolor, pargs) {
                ...
                for (var i = 0; i < bar_len; i++) {
                    ...
                    if (ar.length > bar_len * 2.5 && i > 0 && i < ar.length - 1) {
                        ar[searched_index] = Math.abs(ar[searched_index] + ar[searched_index -
                            1] + ar[searched_index + 1]) / 3
                    }
                    ...
                    if (is_progress) {
                        ...
                        if (is_sample) {
                            ...
                            if ((i / bar_len < sample_time_start / sample_time_total) || i /
                                bar_len > sample_time_end / sample_time_total) {
                        ...
                        // console.info('ctx.fillStyle - ',ctx.fillStyle);
                        if (is_sample) {
                            ...
                            //     // console.warn("BIGGER");
                            // }
                            console.info('sample_time_start - ', sample_time_start);
                            if ((i / bar_len < sample_time_start / sample_time_total) || i /
                                bar_len > sample_time_end / sample_time_total) {
                ...
                if (reflection_size > 0) {
                    for (var i = 0; i < bar_len; i++) {
                        ...
                        //            var barh =
                        ctx.beginPath();
                        ctx.rect(i * bar_w, chh * normal_size_ratio, bar_w - bar_space,
                            barh_ref);
                        ...
                        if (is_progress) {
                            ...
                            if (is_sample) {
                                if ((i / bar_len < sample_time_start / sample_time_total) ||
                                    i / bar_len > sample_time_end / sample_time_total) {
                                    ctx.fillStyle = hexToRgb(static_hexcolor, 0.5);
                                    if (margs.call_from.indexOf('pcm_prog') > -1) {
                                        sw_draw = false;
                                    }
                ...
                if (o.settings_php_handler) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            index_extrahtml_toloads--;
                            if (auxls) {
                                cthis.find('.extra-html').find('.btn-like')
                                    .addClass('active');
                            }
                ...
                if (o.settings_php_handler) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            cthis.find('.extra-html .counter-rates .the-number')
                                .eq(0).html(starrating_nrrates);
                            index_extrahtml_toloads--;
                            cthis.find('.star-rating-set-clip').width(auxresponse[
                                0] * (parseInt(cthis.find(
                                '.star-rating-bg').width(), 10) / 5));
                            //===ratesubmitted
                            if (typeof(auxresponse[2]) != 'undefined') {
                                starrating_alreadyrated = auxresponse[2];
                                if (o.parentgallery && $(o.parentgallery).get(
                                    0) != undefined && $(o.parentgallery).get(0)
                                    .api_player_rateSubmitted != undefined) {
                                    $(o.parentgallery).get(0)
                ...
                if (o.settings_php_handler) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var aux = cthis.find('.star-rating-set-clip')
                                .outerWidth() / cthis.find('.star-rating-bg')
                                .outerWidth();
                            var nrrates = parseInt(cthis.find(
                                '.counter-rates .the-number').html(), 10);
                            nrrates++;
                            var aux2 = ((nrrates - 1) * (aux * 5) +
                                starrating_index) / (nrrates)
                            //                        console.info(aux, aux2, nrrates);
                            setTimeout(function() {
                                cthis.find('.star-rating-con')
                                    .removeClass('just-rated');
                            }, 100);
                            cthis.find('.counter-rates .the-number').html(resp_arr
                                .number);
                            cthis.find('.star-rating-con').attr(
                                'data-initial-rating-index', Number(resp_arr
                                    .index) / 5);
                            cthis.find('.star-rating-con .rating-prog').css(
                                'width', (Number(resp_arr.index) / 5 * 100) +
                                '%');
                            if (o.parentgallery && $(o.parentgallery).get(0) !=
                                undefined && $(o.parentgallery).get(0)
                                .api_player_rateSubmitted != undefined) {
                                $(o.parentgallery).get(0)
                                    .api_player_rateSubmitted();
                            }
                        ...
                        error: function(arg) {
                            ...
                            cthis.find('.star-rating-set-clip').width(aux2 * (
                                parseInt(cthis.find('.star-rating-bg')
                                    .width(), 10) / 5));
                            cthis.find('.counter-rates .the-number').html(
                            nrrates);
                            if (o.parentgallery && $(o.parentgallery).get(0) !=
                                undefined && $(o.parentgallery).get(0)
                                .api_player_rateSubmitted != undefined) {
            ...
            function ajax_submit_download(argp) {
                ...
                var mainarg = argp;
                var data = {
                    action: 'pnplayer_submit_download',
                    postdata: mainarg,
                    playerid: the_player_id
                };
                if (starrating_alreadyrated > -1) {
                ...
                if (o.settings_php_handler) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var auxnr = cthis.find('.counter-hits .the-number')
                                .html();
                        ...
                        error: function(arg) {
                            ...
                            var auxlikes = cthis.find('.counter-hits .the-number')
                                .html();
                            auxlikes = parseInt(auxlikes, 10);
                            auxlikes++;
                            cthis.find('.counter-hits .the-number').html(
                            auxlikes);
                            ajax_view_submitted = 'on';
                        }
                    });
                ...
                if (o.settings_php_handler || cthis.hasClass('is-preview')) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var auxlikes = cthis.find(
                                '.counter-likes .the-number').html();
                            auxlikes = parseInt(auxlikes, 10);
                            auxlikes++;
                            cthis.find('.counter-likes .the-number').html(
                                auxlikes);
                        },
                        error: function(arg) {
                            if (typeof window.console != "undefined") {
            ...
            function skinwave_comment_publish(argp) {
                ...
                var mainarg = argp;
                var data = {
                    action: 'pnplayer_front_submitcomment',
                    postdata: mainarg,
                    playerid: the_player_id,
                ...
                if (o.settings_php_handler) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            _commentsHolder.children().each(function() {
                                var _t2 = $(this);
                                if (_t2.hasClass('dzstooltip-con') ==
                                    false) {
            ...
            function setup_media(pargs) {
                ...
                if (type == 'youtube') {
                    if (o.settings_exclude_from_list != 'on' && pnplayer_list && pnplayer_list
                        .indexOf(cthis) == -1) {
                        if (pnplayer_list) {
                            pnplayer_list.push(cthis);
                        }
                    }
                    pnplayer_yt_list.push(cthis);
                ...
                if (type == 'audio' || type == 'normal' || type == 'soundcloud') {
                    ...
                    if (cthis.attr('data-source')) {
                        ...
                        if (data_source != 'fake') {
                            aux_source += '<source src="' + data_source +
                                '" type="audio/mpeg">';
                            if (cthis.attr('data-sourceogg') != undefined) {
                                aux_source += '<source src="' + cthis.attr('data-sourceogg') +
                                    '" type="audio/ogg">';
                            }
                        } else {
                    ...
                    if (cthis.attr('data-soft-watermark')) {
                        ...
                        _theMedia.append(
                            '<audio class="the-watermark" preload="metadata" loop><source src="' +
                            cthis.attr('data-soft-watermark') + '" /></audio>');
                    ...
                    if (_cmedia && _cmedia.addEventListener && cthis.attr('data-source') !=
                        'fake') {
                        _cmedia.addEventListener('error', function(e) {
                            console.info('errored out', this, this.audioElement, this
                                .duration, e, e.target.error);
                            var noSourcesLoaded = (this.networkState ===
                                HTMLMediaElement.NETWORK_NO_SOURCE);
                            if (noSourcesLoaded && pnplayer_is_mobile() == false) {
                                if (cthis.hasClass('errored-out') == false) {
                                    console.warn("could not load audio source - ",
                ...
                if (type != 'youtube') {
                    ...
                    if (o.preload_method == 'none') {
                        // console.info(window.pnplayer_player_index);
                        setTimeout(function() {
                            if (_cmedia) {
                                $(_cmedia).attr('preload', 'metadata');
                            }
                        }, (Number(window.pnplayer_player_index) + 1 * 18000));
                    }
                    // -- hmm
                    // console.info("ASSIGN HERE", cthis, _conPlayPause);
                    if (o.design_skin == 'skin-customcontrols' || o.design_skin ==
                        'skin-customhtml') {
                        cthis.find('.custom-play-btn,.custom-pause-btn').off('click');
                        cthis.find('.custom-play-btn,.custom-pause-btn').on('click',
                            click_playpause);
                    }
                    if (o.failsafe_repair_media_element) {
                        setTimeout(function() {
                            if (_theMedia.children().eq(0).get(0) && _theMedia
                                .children().eq(0).get(0).nodeName == "AUDIO") {
                                //console.info('ceva');
                                return false;
                            }
                            _theMedia.html('');
            ...
            function setup_listeners() {
                ...
                if (o.settings_trigger_resize > 0) {
                    inter_trigger_resize = setInterval(handleResize, o
            ...
            function init_loaded(pargs) {
                ...
                if (cthis.hasClass('pnplayer-loaded')) {
                    return;
                }
                var margs = {
                    'do_not_autoplay': false,
                ...
                if (cthis.parent().hasClass("vc_tta-panel-body")) {
                    ...
                    if (cthis.parent().parent().parent().parent().parent().hasClass(
                            "vc_tta-panel-body")) {
                ...
                setup_listeners();
                //console.info('setuped_listeners', cthis.hasClass('pnplayer-loaded'), cthis)
                setTimeout(function() {
                ...
                if (o.design_skin == 'skin-wave') {
                    if (o.skinwave_enableSpectrum == 'on') {
                        ...
                        if (window.pnplayer_audio_ctx == null) {
                            if (typeof AudioContext !== 'undefined') {
                                audioCtx = new AudioContext();
                                window.pnplayer_audio_ctx = audioCtx;
                            ...
                            audioCtx = window.pnplayer_audio_ctx;
                        }
                        ...
                        if (audioCtx) {
                            ...
                            if (is_android()) {
                                ...
                                javascriptNode.onaudioprocess = function(event) {
                                    ...
                                    //}
                                    // -- android
                                    var array = new Uint8Array(analyser
                                    .frequencyBinCount);
                                ...
                                if (javascriptNode) {
                                    ...
                                    if (type == 'audio') {
                                        ...
                                        webaudiosource = audioCtx.createMediaElementSource(
                                            _cmedia);
                                        webaudiosource.connect(analyser)
                                        analyser.connect(audioCtx.destination);
                                        // console.info(audioCtx);
                            ...
                            if (is_ios()) {
                                ...
                                fr.onload = function(e) {
                                    ...
                                    audioCtx.decodeAudioData(fileResult, function(
                                    buffer) {
                ...
                if (isNaN(Number(o.default_volume)) == false) {
                    ...
                    if (o.default_volume == 'last') {
                        if (localStorage != null && the_player_id) {
                            ...
                            if (localStorage.getItem('pnplayer_last_volume_' +
                                the_player_id)) {
                                defaultVolume = localStorage.getItem('pnplayer_last_volume_' +
                                    the_player_id);
                            } else {
                                defaultVolume = 1;
                            }
                ...
                // TODO: debug
                // localStorage['pnplayer_' + the_player_id + '_lastpos'] = 10;
                if (playfrom == 'last') {
                    ...
                    if (typeof Storage != 'undefined') {
                        ...
                        if (typeof localStorage['pnplayer_' + the_player_id + '_lastpos'] !=
                            'undefined') {
                            // console.warn("LETS SEEK TO lastposition -3 ",localStorage['pnplayer_' + the_player_id + '_lastpos'])
                            seek_to(localStorage['pnplayer_' + the_player_id + '_lastpos'], {
                                'call_from': 'last_pos'
                            });
                        }
                    }
                ...
                if (margs.do_not_autoplay != true) {
                    if (o.autoplay == 'on' && o.cue == 'on') {
                        console.info('margs.do_not_autoplay - ', margs.do_not_autoplay, margs,
                            o);
                        play_media({
                ...
                // console.info('init_loaded - ',o.action_video_contor_60secs);
                if (inter_60_secs_contor == 0 && o.action_video_contor_60secs) {
                    inter_60_secs_contor = setInterval(count_60secs, 3000);
                }
            }

            function count_60secs() {
                // console.info('count it',o.action_video_contor_60secs,cthis.hasClass('is-playing'));
            ...
            function handle_mouse(e) {
                var _t = $(this);
                // console.info('handle_mouse() _t - ',_t);
                if (e.type == 'click') {
                    ...
                    if (_t.hasClass('pnplayer-btn-go-beginning')) {
                        var _target = cthis;
                        if (o.fakeplayer) {
                    ...
                    if (_t.hasClass('pnplayer-btn-step-backward')) {
                        var _target = cthis;
                        if (o.fakeplayer) {
                            _target = o.fakeplayer;
                        }
                    ...
                    if (_t.hasClass('pnplayer-btn-step-forward')) {
                        var _target = cthis;
                        if (o.fakeplayer) {
                            _target = o.fakeplayer;
                        }
                    ...
                    if (_t.hasClass('pnplayer-btn-slow-playback')) {
                        var _target = cthis;
                        if (o.fakeplayer) {
                            _target = o.fakeplayer;
                        }
                    ...
                    if (_t.hasClass('pnplayer-btn-reset')) {
                        var _target = cthis;
                        if (o.fakeplayer) {
                            _target = o.fakeplayer;
                        }
                    ...
                    if (_t.hasClass('btn-pnplayer-download')) {
                        ajax_submit_download();
                    }
                    if (_t.hasClass('pnplayer-repeat-button')) {
                        // console.info("REPEAT");
                        if (player_playing) {}
                        seek_to(0, {
                            call_from: "repeat"
                    ...
                    if (_t.hasClass('pnplayer-loop-button')) {
                        if (_t.hasClass('active')) {
                ...
                if (e.type == 'mousedown') {
                    ...
                    pnplayer_playlist_con = _con.parent();
                    pnplayer_moving_playlist_item = true;
                    pnplayer_playlist_item_target = _con;
                    pnplayer_playlist_item_moving = _clone;
                ...
                if (e.type == 'mouseenter') {
                    ...
                    window.pnplayer_mouseover = true;
                }
                if (e.type == 'mouseleave') {
                    ...
                    window.pnplayer_mouseover = false;
                }
            }

            function mouse_starrating(e) {
                var _t = $(this);
                // console.info('mouse_starrating ' , e.type, _t);
                if (cthis.has(_t).length == 0) {
                    return;
                }
                if (e.type == 'mouseleave') {
                    var auxnr = Number(cthis.find('.star-rating-con').eq(0).attr(
                        'data-initial-rating-index')) * 100;
                ...
                if (e.type == 'mousemove') {
                    ...
                    // console.info('Math.round(mx/ (_t.outerWidth()/5)) - ' , Math.round(mx/ (_t.outerWidth()/5)) );
                    // console.info('starrating_alreadyrated - ' , starrating_alreadyrated );
                    ...
                    // console.info('starrating_index - ',starrating_index);
                    // console.info('(starrating_index/5 * 100) - ',(starrating_index/5 * 100));
                    cthis.find('.rating-prog').css({
            ...
            function drawSpectrum(argarray) {
                ...
                if (_scrubbarbg_canvas) {
                    draw_canvas(_scrubbarbg_canvas.get(0), argarray, o.design_wave_color_bg, {
                        call_from: 'draw_spectrum_pcm_bg'
                    });
                ...
                if (o.design_skin == 'skin-wave') {
                    if (o.skinwave_enableSpectrum == 'on') {
                        ...
                        var drawMeter = function() {
                            ...
                            if (debug_var) {
                                ...
                                // console.info(lastarray);
                                if (lastarray[0] == 0 && lastarray[Math.round(lastarray
                                        .length / 4)] == 0 && lastarray[Math.round(
                                        lastarray.length / 2)] == 0 && lastarray[Math
                                        .round(lastarray.length / 3 / 4)] == 0) {
                            ...
                            if (lastarray && lastarray.length) {
                                ...
                                if (last_lastarray) {
                                    for (var i3 = 0; i3 < last_lastarray.length; i3++) {
                                        ...
                                        change_viy = lastarray[i3] -
                                        begin_viy; // -- target value - last value
                                        duration_viy = 3;
                                        lastarray[i3] = Math.easeIn(1, begin_viy,
                                            change_viy, duration_viy);
                                    }
                                }
                                // -- easing END
                                // last_lastarray = [];
                                ...
                                var step = Math.round(lastarray.length /
                                meterNum); //sample limited data from the total array
                                draw_canvas(_scrubBgCanvas.get(0), lastarray, '' + o
                                    .design_wave_color_bg, {
                                        'call_from': 'spectrum'
                                    })
                                if (lastarray) {
                    ...
                    if (_currTime && _currTime.length) {
                        ...
                        if (o.skinwave_timer_static != 'on') {
                            ...
                            if (spos < 2 && cthis.data(
                                'promise-to-play-footer-player-from')) {
            ...
            function draw_scrub_prog() {
                ...
                if (audioBuffer == null) {
                    if (__scrubbProg) {
                        ...
                        //     'width': spos+'px'
                        // })
                        // console.info('spos ( normal mode )  - ',spos);
            ...
            function click_next_btn() {
                // console.info('click_next_btn()', pnplayer_list, pnplayer_list_for_sync_players);
                if (o.parentgallery && (o.parentgallery.get(0))) {
            ...
            function get_times() {
                ...
                if ((type == 'audio' || (type == 'fake' && o.fakeplayer))) {
                    if (o.type != 'shoutcast') {
                        if (audioBuffer && audioBuffer != 'placeholder' && audioBuffer !=
                            'waiting') {
                            //                                console.info(time_curr);
                        ...
                        if (playfrom == 'last' && playfrom_ready) {
                            if (typeof Storage != 'undefined') {
                                localStorage['pnplayer_' + the_player_id + '_lastpos'] =
                                    time_curr;
                                //                                    console.info(localStorage['pnplayer_'+the_player_id+'_lastpos']);
                            }
                        }
                    }
                }
            ...
            function check_time(pargs) {
                ...
                if (o.design_skin == 'skin-wave') {
                    if (o.skinwave_comments_displayontime == 'on') {
                        var timer_curr_perc = Math.round((real_time_curr / real_time_total) *
                            100) / 100;
                        if (type == 'fake') {
                            timer_curr_perc = Math.round((time_curr / time_total) * 100) /
                            100;
                        }
                        ...
                        if (_commentsHolder) {
                            _commentsHolder.children().each(function() {
                                ...
                                if (_t.hasClass('dzstooltip-con')) {
                                    var aux = Math.round((parseFloat(_t.css('left')) /
                                        _commentsHolder.outerWidth()) * 100) / 100;
                                    // console.info('aux - ',aux);
                                    ...
                                    if (aux) {
                                        if (Math.abs(aux - timer_curr_perc) < 0.02) {
                                            _commentsHolder.find('.dzstooltip')
                                                .removeClass('active');
                                            _t.find('.dzstooltip').addClass('active');
                                        } else {
                                            _t.find('.dzstooltip').removeClass(
                                                'active');
                                        }
                                    }
                                }
                ...
                if (_feed_fakePlayer) {
                    ...
                    if (_feed_fakePlayer.get(0)) {
                        if (_feed_fakePlayer.get(0).api_get_time_curr) {
                            ...
                            if (isNaN(_feed_fakePlayer.get(0).api_get_time_total()) ||
                                _feed_fakePlayer.get(0).api_get_time_total() == '' ||
                                _feed_fakePlayer.get(0).api_get_time_total() < 1) {
                                // console.warn('setting time total');
                                // console.info("SET TIME CUR - ",time_curr);
                                // console.error('SET time_total - ',time_total_for_visual);
                                _feed_fakePlayer.get(0).api_set_time_total(
                    ...
                    //
                    // }
                    if (_feed_fakePlayer.get(0) && _feed_fakePlayer.get(0)
                        .api_seek_to_visual) {
                        ...
                        //
                        // }
                        _feed_fakePlayer.get(0).api_seek_to_visual(temp_time_curr /
                            time_total);
                    } else {
                        console.warn('hmm');
                    }
                ...
                if (o.design_skin == 'skin-minimal') {
                    // if(debug_var){
                    //     console.info('player_playing - ',player_playing);
                    //     console.info('pnplayer_can_canvas - ',pnplayer_can_canvas);
                    //     console.info('skin_minimal_canvasplay - ',skin_minimal_canvasplay);
                    //
                    //     debug_var = false;
                    // }
                    if (!pnplayer_can_canvas) {
                        ...
                        if (player_playing || first_drawn_canvas == false) {
                            if (skin_minimal_canvasplay) {
                                ...
                                ctx_minimal.arc((50 * pw), (50 * ph), (40 * pw), 0, Math.PI *
                                    2, false);
                                ctx_minimal.fillStyle = "rgba(0,0,0,0.1)";
                                ctx_minimal.fill();
                                // console.log(spos);
                                ctx_minimal.beginPath();
                                ctx_minimal.arc((50 * pw), (50 * ph), (34 * pw), 0, spos,
                                    false);
            ...
            function click_playpause(e) {
                ...
                //console.log(_t);
                if (cthis.hasClass('listeners-setuped')) {} else {
                    $(_cmedia).attr('preload', 'auto');
                    setup_listeners();
                    init_loaded();
                    var it3 = setInterval(function() {
                        // console.info(_cmedia, _cmedia.duration);
                        if (_cmedia && _cmedia.duration && isNaN(_cmedia.duration) ==
                            false) {
                ...
                if (o.design_skin == 'skin-minimal') {
                    ...
                    var AB = Math.sqrt(Math.pow((mouse_x - center_x), 2) + Math.pow((mouse_y -
                        center_y), 2));
                    var AC = Math.sqrt(Math.pow((pzero_x - center_x), 2) + Math.pow((pzero_y -
                        center_y), 2));
                    var BC = Math.sqrt(Math.pow((pzero_x - mouse_x), 2) + Math.pow((pzero_y -
                        mouse_y), 2));
                    var angle = Math.acos((AB + AC + BC) / (2 * AC * AB));
                    var angle2 = Math.acos((mouse_x - center_x) / (skin_minimal_button_size /
                        2));
                    //console.info(AB, AC, BC, angle, (mouse_x - center_x), angle2, Math.PI);
                    var perc = -(mouse_x - center_x - (skin_minimal_button_size / 2)) *
                    0.005; //angle2 / Math.PI / 2;
                    if (mouse_y < center_y) {
                        perc = 0.5 + (0.5 - perc)
                    }
                    ...
                    if (Math.abs(mouse_y - center_y) > 20 || Math.abs(mouse_x - center_x) >
                        20) {
                        // console.info('perc - ',perc);
                        seek_to_perc(perc, {
            ...
            function sync_players_goto_prev() {
                // console.info('sync_players_goto_prev ', pnplayer_list_for_sync_players);
                if (o.fakeplayer) {
                    o.fakeplayer.get(0).api_sync_players_goto_prev();
                    return false;
                }
                if (_playlistTooltip && _playlistTooltip.children('.dzstooltip--inner')
                    .length) {
                    ...
                    if (pnplayer_list_for_sync_players.length > 0) {
                        for (var i24 in pnplayer_list_for_sync_players) {
                            var _ctarget = cthis;
                            if (_feed_fakePlayer) {
                                _ctarget = _feed_fakePlayer;
                            }
                            if (pnplayer_list_for_sync_players[i24].get(0) == _ctarget.get(
                                0)) {
                                // console.info('THIS IS ',i24,pnplayer_list_for_sync_players.length-1, pnplayer_list_for_sync_players);
                                i24 = parseInt(i24, 10);
                                if (i24 > 0) {
                                    var _c_ = pnplayer_list_for_sync_players[i24 - 1].get(0);
                                    // console.info('THIS IS _c ',_c);
                                    // console.info(_c_, i24, pnplayer_list_for_sync_players[i24+1]);
            ...
            function sync_players_goto_next() {
                // console.info('sync_players_goto_next() - ', cthis, 'o.fakeplayer - ',o.fakeplayer);
                if (o.fakeplayer) {
                ...
                if (_playlistTooltip && _playlistTooltip.find('.playlist-menu-item').length) {
                    var tempNr = playlist_inner_currNr + 1;
                    // console.warn('tempNr - ',tempNr, tempNr-1, _playlistTooltip.children('.tooltip--inner').children(), _playlistTooltip.find('.playlist-menu-item').length,_playlistTooltip.children('.dzstooltip--inner'));
                    if (tempNr - 1 > _playlistTooltip.find('.playlist-menu-item')
                        .length) {} else {
                        playlist_goto_item(tempNr, {
                            'call_from': 'api_sync_players_prev'
                        });
                    ...
                    if (pnplayer_list_for_sync_players.length > 0) {
                        for (var i24 in pnplayer_list_for_sync_players) {
                            ...
                            if (pnplayer_list_for_sync_players[i24].get(0) == _ctarget.get(
                                ...
                                i24 = parseInt(i24, 10);
                                var tempNr = i24 + 1;
                                if (tempNr > pnplayer_list_for_sync_players.length - 1) {
                                    // tempNr = 0;
                                }
                                if (tempNr < pnplayer_list_for_sync_players.length) {
                                    var _c_ = pnplayer_list_for_sync_players[tempNr].get(0);
                                    if (_c_) {
                                        // console.info('THIS IS _c ',_c);
                                        // console.info(_c_, i24, pnplayer_list_for_sync_players[i24+1]);
                                        if (_c_ && _c_.api_play_media) {
            ...
            function handle_end(pargs) {
                ...
                console.info('handle_end', cthis, margs, o.fakeplayer, 'action_audio_end - ',
                    action_audio_end, 'time_total - ', time_total, cthis);
                // time_curr  = 0;
                ended = true;
                inter_ended = setTimeout(function() {
                    ended = false;
                ...
                setTimeout(function() {
                    ...
                    if (_feed_fakePlayer && (_feed_fakePlayer.hasClass(
                            'is-single-player') || _feed_fakePlayer.hasClass(
                            'feeded-whole-playlist'))) {
            ...
            function handleResize(e, pargs) {
                ...
                if (res_thumbh == true) {
                    ...
                    if (o.design_skin == 'skin-default') {
                        ...
                        if (typeof cthis.attr('data-initheight') == 'undefined' && cthis.attr(
                                'data-initheight') != '') {
                ...
                if (o.design_skin == 'skin-wave') {
                    ...
                    if (o.parentgallery && typeof(o.parentgallery) != 'undefined' && o
                    ...
                    if (o.skinwave_wave_mode == 'canvas') {
                        if (cthis.attr('data-pcm')) {
                            ...
                            if (_scrubbarbg_canvas && _theThumbCon && _apControls.parent(),
                                _scrubbar) {
                            ...
                            if (data_source != 'fake') {
                                ...
                                if (draw_canvas_inter) {
                                    ...
                                    draw_canvas_inter = setTimeout(draw_canvas_inter_func,
                                        500);
                                } else {
                ...
                if (o.design_skin == 'skin-minimal') {
                    ...
                    console.info('skin_minimal_button_size - ', skin_minimal_button_size);
                ...
                if (o.design_skin == 'skin-minion') {
                    //console.info();
                    aux2 = parseInt(_conControls.find('.con-playpause').eq(0).offset().left,
                        10) - parseInt(_conControls.eq(0).offset().left, 10) - 18;
            ...
            function mouse_volumebar(e) {
                ...
                if (e.type == 'mousemove') {
                    ...
                    if (volume_dragging) {
                        aux = (e.pageX - (_controlsVolume.find('.volume_static').eq(0)
                        .offset().left)) / (_controlsVolume.find('.volume_static').eq(0)
                            .width());
                        if (_t.parent().hasClass('volume-holder') || _t.hasClass(
                                'volume-holder')) {}
                        if (o.design_skin == 'skin-redlights') {
                            aux *= 10;
                            aux = Math.round(aux);
                ...
                if (e.type == 'click') {
                    ...
                    aux = (e.pageX - (_controlsVolume.find('.volume_static').eq(0).offset()
                        .left)) / (_controlsVolume.find('.volume_static').eq(0).width());
                    if (_t.parent().hasClass('volume-holder')) {
                        aux = 1 - ((e.pageY - (_controlsVolume.find('.volume_static').eq(0)
                            .offset().top)) / (_controlsVolume.find('.volume_static')
                            .eq(0).height()));
                    }
            ...
            function handle_mouse_scrubbar(e) {
                var mousex = e.pageX;
                if ($(e.target).hasClass('sample-block-start') || $(e.target).hasClass(
                        'sample-block-end')) {
                    return false;
                }
                if (e.type == 'mousemove') {
                    ...
                    if (o.scrub_show_scrub_time == 'on') {
                        ...
                        if (time_total) {
                            var aux = (mousex - _scrubbar.offset().left) / _scrubbar
                                .outerWidth() * time_total;
                            if (_currTime) {
                ...
                if (e.type == 'click') {
                    ...
                    if (o.fakeplayer) {
                        ...
                        setTimeout(function() {
                            if (o.fakeplayer.get(0) && o.fakeplayer.get(0)
                                .api_pause_media) {
                                o.fakeplayer.get(0).api_seek_to_perc(aux /
                                time_total, {
            ...
            function seek_to(arg, pargs) {
                ...
                if (o.fakeplayer) {
                    ...
                    if (o.fakeplayer.length && o.fakeplayer.data('feeding-from') != cthis.get(
                            0)) {
                        console.info('margs - ', margs, 'arg - ', arg);
                        if (margs.call_from != 'handle_end' && margs.call_from !=
                            'from_playfrom' && margs.call_from != 'last_pos') {
                            // -- if it is not user action
                            args.call_from = 'seek_to from player ' + cthis.attr(
                                'data-source');
                            o.fakeplayer.get(0).api_change_media(cthis, args);
                        } else {
                            time_curr = arg;
                    ...
                    setTimeout(function() {
                        if (o.fakeplayer.get(0) && o.fakeplayer.get(0)
                            .api_pause_media) {
                            if (margs.call_from != 'from_playfrom' && margs
                                .call_from != 'last_pos') {
            ...
            function set_volume(arg, pargs) {
                ...
                if (margs.call_from == 'set_by_mouseclick' || margs.call_from ==
                    'set_by_mousemove') {
                    volume_set_by_user = true;
                }
                ...
                if (_feed_fakePlayer) {
                    ...
                    if (_feed_fakePlayer.get(0) && _feed_fakePlayer.get(0)
                        .api_visual_set_volume(arg, margs)) {
                ...
                if (o.fakeplayer) {
                    ...
                    if (margs.call_from != ('from_fake_player')) {
                        ...
                        if (_feed_fakePlayer && _feed_fakePlayer.get(0) && _feed_fakePlayer
                            .get(0).api_set_volume(arg, margs)) {
            ...
            function visual_set_volume(arg, margs) {
                if (_controlsVolume.hasClass('controls-volume-vertical')) {
                    ...
                    _controlsVolume.find('.volume_active').eq(0).css({
                        'height': (_controlsVolume.find('.volume_static').eq(0)
                            .height() * arg)
                    });
                } else {
                    _controlsVolume.find('.volume_active').eq(0).css({
                        'width': (_controlsVolume.find('.volume_static').eq(0)
                        .width() * arg)
                    });
                }
                ...
                if (localStorage != null && the_player_id) {
                    //console.info(the_player_id);
                    localStorage.setItem('pnplayer_last_volume_' + the_player_id, arg);
                }
                last_vol = arg;
            }
            ...
            function pause_media_visual(pargs) {
                ...
                if (cthis.parent().hasClass('pnplayer-wrapper-bg-center')) {
            ...
            function pause_media(pargs) {
                ...
                if (margs.donot_change_media != true) {
                    ...
                    if (o.fakeplayer != null) {
                        ...
                        // o.fakeplayer.get(0).api_change_media(cthis, args);
                        if (o.fakeplayer && o.fakeplayer.length && o.fakeplayer.data(
                                'feeding-from') != cthis.get(0)) {
                            args.call_from = 'pause_media from player ' + cthis.attr(
                                'data-source');
                            o.fakeplayer.get(0).api_change_media(cthis, args);
                        }
                        setTimeout(function() {
            ...
            function play_media(pargs) {
                ...
                if (cthis.hasClass('media-setuped') == false && o.fakeplayer == null) {
                    console.info('warning: media not setuped, there might be issues', cthis
                        .attr('id'));
                }
                if (margs.call_from == 'feed_to_feeder') {
                    // console.info('play from - ',_feed_fakePlayer, margs);
                    if (cthis.hasClass('pnplayer-loaded') == false) {
                        init_loaded();
                        var delay = 300;
                        if (is_ios()) {}
                        if (is_android_good()) {
                ...
                for (i = 0; i < pnplayer_list.length; i++) {
                    //console.info('comparing pnplayer_list - ', pnplayer_list[i].get(0), cthis.get(0));
                    //console.info(pnplayer_list[i].get(0) != cthis.get(0));
                    // -- pause other players
                    if (pnplayer_list[i].get(0) && pnplayer_list[i].get(0).api_pause_media &&
                        (pnplayer_list[i].get(0) != cthis.get(0))) {
                        //console.error("LETS PAUSE");
                        //console.info('try to pause', pnplayer_list[i].get(0),pnplayer_list[i].data('type_audio_stop_buffer_on_unfocus'))
                        if (pnplayer_list[i].data('type_audio_stop_buffer_on_unfocus') &&
                            pnplayer_list[i].data('type_audio_stop_buffer_on_unfocus') == 'on'
                            ) {
                            pnplayer_list[i].get(0).api_destroy_for_rebuffer();
                        } else {
                            pnplayer_list[i].get(0).api_pause_media({
                                'audioapi_setlasttime': false
                            });
                        }
                    }
                ...
                if (o.google_analytics_send_play_event == 'on' && window._gaq &&
                    google_analytics_sent_play_event == false) {
                    //if(window.console){ console.info( 'sent event'); }
                    window._gaq.push(['_trackEvent', 'pnplayer Play', 'Play',
                        'pnplayer play - ' + cthis.attr('data-source')
                    ]);
                ...
                if (o.google_analytics_send_play_event == 'on' && window.ga &&
                    google_analytics_sent_play_event == false) {
                    if (window.console) {
                    ...
                    window.ga('send', {
                        hitType: 'event',
                        eventCategory: 'pnplayer play - ' + cthis.attr('data-source'),
                        eventAction: 'play',
                        eventLabel: 'pnplayer play - ' + cthis.attr('data-source')
                    });
                }
                //===media functions
                if (_feed_fakePlayer) {
                ...
                if (o.fakeplayer) {
                    ...
                    try {
                        ...
                        if (margs.call_from == 'click_playpause') {
                            // -- let us resetup the playlist
                            if (o.parentgallery) {
                                o.parentgallery.get(0)
                                    .api_regenerate_sync_players_with_this_playlist();
                        ...
                        if (o.fakeplayer && o.fakeplayer.length && o.fakeplayer.data(
                                'feeding-from') != cthis.get(0)) {
                            args.call_from = 'play_media from player ' + cthis.attr(
                                'data-source');
                            o.fakeplayer.get(0).api_change_media(cthis, args);
                            if (cthis.hasClass('first-played') == false) {
                                // console.info("YES");
                ...
                //console.info(ajax_view_submitted);
                if (_feed_fakePlayer) {
                    pnplayer_currplayer_focused = _feed_fakePlayer.get(0);
                    _feed_fakePlayer.get(0).api_try_to_submit_view();
                } else {
                    pnplayer_currplayer_focused = cthis.get(0);
                    try_to_submit_view();
                }
                // console.info('keyboard_controls.play_trigger_step_back - ',keyboard_controls);
                if (keyboard_controls.play_trigger_step_back == 'on') {
                    if (pnplayer_currplayer_focused) {
                        pnplayer_currplayer_focused.api_step_back(keyboard_controls
                            .step_back_amount);
                    }
                }
            }
    ...
    window.pnplayer_init = function(selector, settings) {
        //console.info(selector);
        if (typeof(settings) != "undefined" && typeof(settings.init_each) != "undefined" && settings
            .init_each == true) {
            var element_count = 0;
            ...
            $(selector).each(function() {
                ...
                if (settings && typeof(settings.call_from) == 'undefined') {
                    settings.call_from = 'pnplayer_init';
                }
        ...
        pnplayer_lasto = settings;
        pnplayer_list_for_sync_players = [];
        if (typeof(settings) != "undefined" && typeof(settings.construct_player_list_for_sync) !=
            "undefined" && settings.construct_player_list_for_sync == 'on') {
            $('.audioplayer,.audioplayer-tobe').each(function() {
                ...
                if (_t2.attr('data-do-not-include-in-list') != 'on') {
                    if (_t2.attr('data-type') != 'fake' || _t2.attr('data-fakeplayer')) {
                        pnplayer_list_for_sync_players.push(_t2);
                    }
                }
            })
            // console.info('pnplayer_list_for_sync_players -5 ',pnplayer_list_for_sync_players);
        }
    };
    //////=======
    // -- the nav
    /////========
    $.fn.pnplayer_nav = function(o) {
        var defaults = {}
        if (typeof o == 'undefined') {
    ...
    $.fn.audiogallery = function(o) {
        ...
        this.each(function() {
            ...
            var busy = true;
            var i = 0;
            var ww, wh, tw, th, nc_maindim // -- nav clip size
            ...
            var busy = false,
                ...
                loaded = false,
                first = true,
                skin_redlight_give_controls_right_to_all_players =
                false // -- if the mode is mode-showall and the skin of the player is redlights, then make all players with controls right
            ;
            var time_total = 0,
                time_curr = 0;
            var last_vol = 1,
            ...
            var finish_viy = 0;
            var change_viy = 0;
            if (window.pnplayer_settings && typeof(window.pnplayer_settings
                    .str_alertBeforeRate) != 'undefined') {
                str_alertBeforeRate = window.pnplayer_settings.str_alertBeforeRate;
            }
            ...
            function init() {
                ...
                var aux = '<div class="nav-main pnplayer-nav ' + o.design_skin +
                    ' nav-type-' + o.menu_nav_type +
                    '"><div class="nav-clipper"></div></div>';
                ...
                if (o.settings_php_handler) {} else {
                ...
                if (get_query_arg(window.location.href, 'audiogallery_startitem_' + cid)) {
                    tempNr = Number(get_query_arg(window.location.href,
                        'audiogallery_startitem_' + cid));
                    lastCurrNr = tempNr;
                    if (Number(get_query_arg(window.location.href, 'audiogallery_startitem_' +
                            cid)) && Number(get_query_arg(window.location.href,
                            'audiogallery_startitem_' + cid)) > 0) {
                ...
                if (o.settings_mode == 'mode-showall') {
                    _sliderClipper.children().each(function() {
                        var _t = $(this);
                        //console.log(_t);
                        var ind = _t.parent().children(
                            '.audioplayer,.audioplayer-tobe').index(_t);
                        if (_t.hasClass('audioplayer-tobe')) {
                            ...
                            o.settings_ap.action_audio_play =
                                mode_showall_listen_for_play;
                            ...
                            if (o.settings_mode_showall_show_number != 'off') {
                                _t.before(
                                    ...
                                    ind + '</span></div>')
                                _t.after(
                                    '<div class="clear for-number-wrapper"></div>'
                                    )
                            }
                        }
                    })
                    ...
                    if (o.settings_mode == 'mode-showall') {
                        if (skin_redlight_give_controls_right_to_all_players) {
                            _sliderClipper.children('.audioplayer').each(function() {
                                var _t = $(this);
                                //console.info(_t);
                                if (_t.find('.ap-controls-right').eq(0).prev()
                                    .hasClass('controls-right') == false) {
                                    _t.find('.ap-controls-right').eq(0).before(
                ...
                _navClipper.on('click', '.menu-btn-like,.menu-facebook-share',
                click_menuitem);
                _navClipper.on('click', '.menu-item', click_menuitem);
                cgallery.find('.download-after-rate').bind('click', click_downloadAfterRate);
                cgallery.get(0).api_regenerate_sync_players_with_this_playlist =
                    regenerate_sync_players_with_this_playlist;
            ...
            function regenerate_sync_players_with_this_playlist() {
                ...
                _sliderClipper.children('.audioplayer,.audioplayer-tobe').each(function() {
                    ...
                    pnplayer_list_for_sync_players.push(_t);
                })
            }
                        ...
                        _navMain.find('.menu-item-views').each(function() {
                            ...
                            if (aux && aux[1]) {
                                ...
                                for (var i in track_data) {
                                    ...
                                    if (id == track_data[i].label || id == 'ap' +
                                        track_data[i].label) {
                                        aux_html = aux_html.replace(aux[0],
                                            track_data[i].views);
                                        foundnr++;
                                        break;
                                    }
            ...
            function reinit() {
                ...
                var auxlen = cgallery.find('.items').eq(0).children('.audioplayer-tobe')
                    .length;
                arr_menuitems = [];
                var player_id = '';
                ...
                for (i = 0; i < arr_menuitems.length; i++) {
                    var extra_class = '';
                    if (arr_menuitems[i].menu_description && arr_menuitems[i].menu_description
                        .indexOf(
                            '<div class="menu-item-thumb-con"><div class="menu-item-thumb" style="'
                            ) == -1) {
                        extra_class += ' no-thumb';
                    }
                    var aux = '<div class="menu-item' + extra_class + '"  data-menu-index="' +
                        i + '" data-gallery-id="' + cid + '" data-playerid="' + arr_menuitems[
                            i].player_id + '">'
                    if (cgallery.hasClass('skin-aura')) {
                        aux += '<div class="menu-item-number">' + (++nrChildren) + '</div>';
                    }
                    aux += arr_menuitems[i].menu_description;
                    if (cgallery.hasClass('skin-aura') && String(arr_menuitems[i]
                            .menu_description).indexOf('menu-item-views') == 1) {
                        if (track_data && track_data.length > 0) {
                            aux += '<div class="menu-item-views"></div>';
                        } else {
                            init_parse_track_data();
                            aux += '<div class="menu-item-views">' + svg_play_icon + ' ' +
                                '<span class="the-count">{{views_' + arr_menuitems[i]
                                .player_id + '}}' + '</span></div>';
                        }
                    }
                    aux += '</div>';
                    ...
                    if (cgallery.hasClass('skin-aura')) {
                        if (arr_menuitems[i] && arr_menuitems[i].menu_description &&
                            arr_menuitems[i].menu_description.indexOf('float-right') > -1) {
            ...
            function play_curr_media() {
                if (typeof(_sliderClipper.children().eq(currNr).get(0)) != 'undefined') {
                    if (typeof(_sliderClipper.children().eq(currNr).get(0).api_play_media) !=
                        'undefined') {
            ...
            function mode_showall_listen_for_play(arg) {
                ...
                if (o.settings_mode == 'mode-showall') {
                    var ind = _sliderClipper.children('.audioplayer,.audioplayer-tobe').index(
                        arg);
                    //console.log(ind);
                    currNr = ind;
            ...
            function player_commentSubmitted() {
                _navClipper.children('.menu-item').eq(currNr).find('.download-after-rate')
                    .addClass('active');
            }
            ...
            function calculateDims() {
                ...
                if (_sliderClipper.children().eq(currNr).hasClass(
                        'pnplayer-wrapper-bg-bellow') == false) {
                    _sliderClipper.css('height', _sliderClipper.children().eq(currNr)
                        .outerHeight());
                }
                setTimeout(function() {
            ...
            function calculate_on_interval() {
                ...
                if (o.gallery_gapless_play == 'on' && time_total > 1 && time_curr >=
                    time_total - 10 && time_curr > 5) {
                    var args = {
                    ...
                    if (o.parentgallery && cthis.hasClass('active-from-gallery')) {
                        ...
                        var _cach = _c.find('.slider-clipper').children().eq(Number(_c.data(
                            'currNr')) + 1);
            ...
            function navMain_mousemove(e) {
                ...
                var vix = 0;
                var viy = 0;
                viy = (my / nc_maindim) * -(nm_maindim - nc_maindim + 10 + aux_error * 2) +
                    aux_error;
                //console.log(viy);
                if (viy > 0) {
                    viy = 0;
            ...
            function transition_end() {
                ...
                _sliderClipper.children().eq(lastCurrNr).removeClass(
                    'active active-from-gallery');
            ...
            function goto_item(arg, pargs) {
                ...
                if (currNr == arg) {
                    if (_sliderClipper && _sliderClipper.children().eq(currNr).get(0) &&
                        _sliderClipper.children().eq(currNr).get(0).api_play_media) {
                        _sliderClipper.children().eq(currNr).get(0).api_play_media({
                            'call_from': 'gallery'
                        });
                ...
                if (currNr > -1) {
                    if (typeof(_sliderClipper.children().eq(currNr).get(0)) != 'undefined') {
                        if (typeof(_sliderClipper.children().eq(currNr).get(0)
                                .api_pause_media) != 'undefined') {
                            _sliderClipper.children().eq(currNr).get(0).api_pause_media();
                        }
                        if (typeof(_sliderClipper.children().eq(currNr).get(0)
                                .api_get_last_vol) != 'undefined') {
                            currNr_last_vol = _sliderClipper.children().eq(currNr).get(0)
                                .api_get_last_vol();
                        }
                    }
                    if (o.settings_mode != 'mode-showall') {
                        ...
                        if (o.transition == 'fade') {
                            _sliderClipper.children().eq(currNr).removeClass(
                                'active active-from-gallery');
                            _navClipper.children().eq(currNr).removeClass(
                                'active active-from-gallery');
                            _sliderClipper.children().eq(currNr).addClass(
                            'transitioning-out');
                ...
                o.settings_ap.parentgallery = cgallery;
                o.settings_ap.design_menu_show_player_state_button = o
                ...
                pnplayer_currplayer_focused = _cache.get(0);
                if (o.settings_mode != 'mode-showall') {
                    if (o.transition == 'fade') {
                        _cache.css({})
                        _cache.animate({}, {
                    ...
                    if (_cache.attr('data-type') != 'link') {
                        if (margs.ignore_linking == false && o.settings_enable_linking ==
                            'on') {
                            var stateObj = {
                                foo: "bar"
                            };
                            history.pushState(stateObj, null, add_query_arg(window.location
                                .href, 'audiogallery_startitem_' + cid, (arg)));
                        }
                    }
                }
                ...
                if (bgimage && cgallery.parent().hasClass('ap-wrapper') && cgallery.parent()
                    .children('.the-bg').length > 0) {
                    console.warn("ENTER HIER");
                    cgallery.parent().children('.the-bg').eq(0).after(
                        '<div class="the-bg" style="background-image: url(' + bgimage +
                        ');"></div>')
                ...
                if (_sliderClipper.children().eq(currNr).get(0) && _sliderClipper.children()
                    .eq(currNr).get(0).api_handleResize && _sliderClipper.children().eq(
                        currNr).hasClass('media-setuped')) {
                    //console.info('_sliderClipper.children().eq(currNr) - ',_sliderClipper.children().eq(currNr));
...
jQuery(document).ready(function($) {
    ...
    $('body').append('<style class="pnplayer--style"></style>');
    window.pnplayer__style = $('.pnplayer--style');
    $(window).on('resize.pnplayermain', handle_resize_pnplayer_main);
    var inter_resize = 0;

    function handle_resize_pnplayer_main() {
        clearTimeout(inter_resize);
        inter_resize = setTimeout(function() {
            handle_resize_pnplayer_main_doit();
        }, 300)
    }

    function handle_resize_pnplayer_main_doit() {
        // console.info('$(\'.pnplayer-sticktobottom\') - ',$('.pnplayer-sticktobottom'));
        if ($('.pnplayer-sticktobottom').length) {
            pnplayer_sticktobottom_con = $('.pnplayer-sticktobottom').eq(0);
        }
        if (pnplayer_sticktobottom_con) {
            // console.info('pnplayer_sticktobottom_con - ',pnplayer_sticktobottom_con);
            var aux = 'body .pnplayer-sticktobottom:not(.audioplayer-loaded)';
            // console.warn('pnplayer_sticktobottom_con.outerHeight() - ',pnplayer_sticktobottom_con.outerHeight());
            aux += '{';
            aux += 'bottom: -' + (pnplayer_sticktobottom_con.outerHeight()) + 'px';
            aux += '}';
            window.pnplayer__style.html(aux);
        }
    }
    handle_resize_pnplayer_main();
    $('audio.pnplayer-from-audio').each(function() {
        var _t = $(this);
        //console.info(_t);
        _t.after('<div class="audioplayer-tobe auto-init skin-silver" data-source="' + _t
            .attr('src') + '"></div>');
        _t.remove();
    })
    $('.audioplayer,.audioplayer-tobe').each(function() {
    ...
    // console.info('we are hier');
    $(document).on('click.pnplayer_metas', '.audioplayer-song-changer, .pnplayer-wishlist-but',
        function() {
            var _t = $(this);
            // conso
            if (_t.hasClass('audioplayer-song-changer')) {
                // console.info('.audioplayer-song-changer', _t);
            ...
            if (_t.hasClass('pnplayer-wishlist-but')) {
                var data = {
                    action: 'pnplayer_add_to_wishlist',
                ...
                if (window.pnplayer_lasto.settings_php_handler) {
                    $.ajax({
                        type: "POST",
                        url: window.pnplayer_lasto.settings_php_handler,
                        data: data,
                        success: function(response) {
                            //if(typeof window.console != "undefined" ){ console.log('Ajax - get - comments - ' + response); }
                            if (_t.find('.svg-icon').hasClass('fa-star-o')) {
                                _t.find('.svg-icon').eq(0).attr('class',
                                    'svg-icon fa fa-star');
                            } else {
                                _t.find('.svg-icon').eq(0).attr('class',
                                    'svg-icon fa fa-star-o');
                            }
                        },
                        error: function(arg) {
                            if (typeof window.console != "undefined") {
    ...
    // console.warn('\'.pnplayer-sticktobottom .icon-hide\' -' ,$('.pnplayer-sticktobottom .icon-hide'));
    $(document).on('click.dzsiconhide', '.sticktobottom-close-con', function() {
        var _t = $(this);
        $('.pnplayer-sticktobottom .audioplayer').get(0).api_pause_media();
        // console.info('_t -',_t);
        var _con = null;
        if (_t.parent().hasClass("pnplayer-sticktobottom")) {
            _con = _t.parent();
        }
        if (_t.parent().parent().hasClass("pnplayer-sticktobottom")) {
            _con = _t.parent().parent();
        }
        if (_t.parent().parent().parent().hasClass("pnplayer-sticktobottom")) {
            _con = _t.parent().parent().parent();
        }
    ...
    $(document).on('click.dzsiconshow', '.pnplayer-sticktobottom .icon-show', function() {
        var _t = $(this);
    ...
    if ($('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-silver').length > 0) {
        setInterval(function() {
            //console.info($('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-silver > .audioplayer').eq(0).hasClass('pnplayer-loaded'));
            if ($(
                    '.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-silver  .audioplayer')
                .eq(0).hasClass('pnplayer-loaded')) {
                $('.pnplayer-sticktobottom-placeholder').eq(0).addClass('active');
                if ($('.pnplayer-sticktobottom').hasClass('audioplayer-was-loaded') ==
                    false) {
                    $('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-silver')
                        .addClass('audioplayer-loaded')
                }
            }
        }, 1000);
    }
    if ($('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-wave').length > 0) {
        setInterval(function() {
            // console.info($('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-wave  .audioplayer'), $('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-wave  .audioplayer').eq(0).hasClass('pnplayer-loaded'));
            if ($(
                    '.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-wave  .audioplayer')
                .eq(0).hasClass('pnplayer-loaded')) {
                $('.pnplayer-sticktobottom-placeholder').eq(0).addClass('active');
                if ($('.pnplayer-sticktobottom').hasClass('audioplayer-was-loaded') ==
                    false) {
                    $('.pnplayer-sticktobottom.pnplayer-sticktobottom-for-skin-wave')
                        .addClass('audioplayer-loaded')
                }
            }
        }, 1000);
    }
    // $(document).off('click.pnplayer_multisharer');
    $(document).on('click.pnplayer_multisharer', '.pnplayer-multisharer-but',
        click_open_embed_ultibox);
    ...
    function open_pnplayer_lightbox(pargs) {
        var margs = {
            'call_from': 'default',
            'lightbox_open': 'share',
            'overwrite_this': null
        ...
        // console.info('ceva');
        var _c_mc = window.pnplayer_box_main_con;
        var _t = $(this);
        if (margs.overwrite_this) {
            _t = $(margs.overwrite_this);
        }
        // console.info('open_pnplayer_lightbox() _c -> ',_c_mc, _c_mc.find('.social-networks-con'), 'margs - ',margs);
        if (_t.data('cthis')) {
            var cthis = _t.data('cthis');
            console.info('found cthis in data');
        }
        if (cthis) {
            window.pnplayer_currplayer_from_share = cthis;
        } else {
            if (_t.attr('data-post_id')) {
                window.pnplayer_currplayer_from_share = $('.audioplayer[data-playerid="' + _t.attr(
                    'data-post_id') + '"]')
            } else {
                if (_t.parent().parent().parent().parent().parent().parent().hasClass(
                    'audioplayer')) {
                    // console.info("YES");
                    window.pnplayer_currplayer_from_share = _t.parent().parent().parent().parent()
                        .parent().parent();
                }
            }
        }
        // console.info('window.pnplayer_currplayer_from_share -> ', window.pnplayer_currplayer_from_share);
        console.info('_t -> ', _t, _t.data('cthis'));
        console.info('window.pnplayer_currplayer_from_share -> ', window
            .pnplayer_currplayer_from_share);
        var aux = '';
        if (window.pnplayer_social_feed_for_social_networks) {
            aux = window.pnplayer_social_feed_for_social_networks;
        }
        // -- aux is feed from social_feed
        if (window.pnplayer_box_main_con) {
            console.info('window.pnplayer_box_main_con - ', window.pnplayer_box_main_con);
            window.pnplayer_box_main_con.find('.social-networks-con').html(aux);
            aux = '';
            if (window.pnplayer_social_feed_for_share_link) {
                aux = window.pnplayer_social_feed_for_share_link;
            }
            if (aux) {
                // console.warn('_t - ',_t);
                ...
                window.pnplayer_box_main_con.find('.share-link-con').html(aux);
            }
            var aux_social = '';
            if (window.pnplayer_social_feed_for_embed_link) {
                aux_social = window.pnplayer_social_feed_for_embed_link;
            }
            // console.info(' o - ',o, cthis,'pnplayer_currplayer_from_share - ',pnplayer_currplayer_from_share);
            if (window.pnplayer_currplayer_from_share && pnplayer_currplayer_from_share.data(
                    'embed_code')) {
                console.info('o.embed_code - ', pnplayer_currplayer_from_share.data('embed_code'));
                if (aux_social) {
                    var replace_str = pnplayer_currplayer_from_share.data('embed_code');
            ...
            // console.info('_c_mc - ',_c_mc);
            // console.info('o.embed_code - ',o.embed_code);
            // console.info('aux_social - ',aux_social);
            $(document).on('click.pnplayer', '.field-for-view', function() {
                console.info("select all test ", this);
                selectText(this);
                // $(this).select();
            });
    ...
    $(document).on('keydown.pnplayerkeyup,keypress.pnplayerkeyup', function(e) {
        // console.info('e - ',e);
        //console.info('pnplayer_currplayer_focused - ',pnplayer_currplayer_focused);
        // -- local .. step back / step forward
        var keyboard_controls = $.extend({}, pnplayer_generate_keyboard_controls());
        // console.info('keyboard_controls.pause_play - ',keyboard_controls.pause_play);
        // console.info('keyboard_controls - ',keyboard_controls);
        // console.info('e.keyCode - ',e.keyCode, keyboard_controls);
        if (pnplayer_currplayer_focused && pnplayer_currplayer_focused.api_pause_media) {
            var sw_pressed = false;
            sw_pressed = false;
            if (keyboard_controls.pause_play.indexOf('ctrl+') > -1) {
                if (e.ctrlKey) {
                    keyboard_controls.pause_play = keyboard_controls.pause_play.replace(
                        'ctrl+', '');
            ...
            if (sw_pressed) {
                if ($(pnplayer_currplayer_focused).hasClass('comments-writer-active') ==
                    false) {
                    if ($(pnplayer_currplayer_focused).hasClass('is-playing')) {
                        pnplayer_currplayer_focused.api_pause_media();
                    } else {
                        pnplayer_currplayer_focused.api_play_media();
                    }
                    if (window.pnplayer_mouseover) {
                        e.preventDefault();
                        return false;
                    }
                }
            ...
            if (sw_pressed) {
                pnplayer_currplayer_focused.api_step_back(keyboard_controls.step_back_amount);
            }
            sw_pressed = false;
            if (keyboard_controls.step_forward.indexOf('ctrl+') > -1) {
                if (e.ctrlKey) {
                    keyboard_controls.step_forward = keyboard_controls.step_forward.replace(
                        'ctrl+', '');
            ...
            if (sw_pressed) {
                pnplayer_currplayer_focused.api_step_forward(keyboard_controls
                    .step_back_amount);
            }
            sw_pressed = false;
            ...
            if (sw_pressed) {
                if (pnplayer_currplayer_focused && pnplayer_currplayer_focused
                    .api_sync_players_goto_next) {
                    pnplayer_currplayer_focused.api_sync_players_goto_next();
                }
            }
            sw_pressed = false;
            ...
            if (sw_pressed) {
                if (pnplayer_currplayer_focused && pnplayer_currplayer_focused
                    ...
                    pnplayer_currplayer_focused.api_sync_players_goto_prev();
                }
            }
        }
    })
    $(document).on('click', '.pnplayer-like-but', function(e) {
        var _t = $(this);
        window.pnplayer_submit_like(_t.attr('data-post_id'), e);
        return false;
    })
    $(document).on('click', '.pnplayer-rectract-like-but', function(e) {
        var _t = $(this);
        window.pnplayer_submit_like(_t.attr('data-post_id'), e);
        return false;
    })
    window.pnplayer_submit_like = function(argp, e) {
        //only handles ajax call + result
        var mainarg = argp;
        var data = {
            action: 'pnplayer_submit_like',
        ...
        if (window.pnplayer_settings && window.pnplayer_settings.ajax_url) {
            $.ajax({
                type: "POST",
                url: window.pnplayer_settings.ajax_url,
                data: data,
                success: function(response) {
                    if (typeof window.console != "undefined") {
                        console.log('Got this from the server: ' + response);
    ...
    window.pnplayer_retract_like = function(argp, e) {
        //only handles ajax call + result
        var mainarg = argp;
        var data = {
            action: 'pnplayer_retract_like',
...
function onYouTubeIframeAPIReady() {
    for (i = 0; i < pnplayer_yt_list.length; i++) {
        //console.log(pnplayer_list[i].get(0).fn_yt_ready);
        if (pnplayer_yt_list[i].get(0) != undefined && typeof pnplayer_yt_list[i].get(0).fn_yt_ready !=
            'undefined') {
            pnplayer_yt_list[i].get(0).fn_yt_ready();
        }
    }
}
...
var MD5 = function(e) {
    function g(a, d) {
        ...
        return e & f ? p ^ 2147483648 ^ b ^ c : e | f ? p & 1073741824 ? p ^ 3221225472 ^ b ^ c : p ^
            1073741824 ^ b ^ c : p ^ b ^ c
    }
    ...
    e = function(b) {
        ...
        for (var c = "", d = 0; d < b.length; d++) {
            ...
            128 > a ? c += String.fromCharCode(a) : (127 < a && 2048 > a ? c += String.fromCharCode(
                a >> 6 | 192) : (c += String.fromCharCode(a >> 12 | 224), c += String
                .fromCharCode(a >> 6 & 63 | 128)), c += String.fromCharCode(a & 63 | 128))
        }
        return c
    }(e);
    f = function(b) {
        ...
        var a = c + 8;
        for (var d =
                16 * ((a - a % 64) / 64 + 1), e = Array(d - 1), f, g = 0; g < c;) a = (g - g % 4) / 4,
...
window.pnplayer_currplayer_focused = null;
window.pnplayer_currplayer_from_share = null;
window.pnplayer_mouseover = false;
window.dzs_open_social_link = function(arg, argthis) {
    ...
    var windowFeatures = "status=no,height=" + h + ",width=" + w + ",resizable=yes,left=" + leftPosition +
        ",top=" + topPosition + ",screenX=" + leftPosition + ",screenY=" + topPosition +
        ",toolbar=no,menubar=no,scrollbars=no,location=no,directories=no";
    console.info('dzs_open_social_link()', arg, 'argthis - ', argthis);
    ...
    var cid_gallery = '';
    if (argthis) {} else {
        if (window.pnplayer_currplayer_from_share) {
            argthis = window.pnplayer_currplayer_from_share;
        }
    }
    // console.info('window.pnplayer_currplayer_from_share -> ', window.pnplayer_currplayer_from_share);
    ...
    var shareurl = encodeURIComponent(auxa[0] + '?fromsharer=on&audiogallery_startitem_' + cid_gallery +
        '=' + cid + '');
...
function pnplayer_send_total_time(argtime, argcthis) {
    // console.info('pnplayer_send_total_time()',argtime,argcthis);
    var data = {
        action: 'pnplayer_send_total_time_for_track',
        id_track: argcthis.attr('data-playerid'),
        postdata: parseInt(argtime, 10)
    };
    jQuery.post(window.pnplayer_ajaxurl, data, function(response) {
...
window.pnplayer_wp_send_contor_60_secs = function(argcthis, argtitle) {
    var data = {
        video_title: argtitle
            // ,video_analytics_id: argcthis.attr('data-analytics-id')
            ,
        video_analytics_id: argcthis.attr('data-playerid'),
        curr_user: window.pnplayer_curr_user
    };
    var theajaxurl = 'index.php?action=ajax_pnplayer_submit_contor_60_secs';
    if (window.pnplayer_settings.pnplayer_site_url) {
        theajaxurl = pnplayer_settings.pnplayer_site_url + theajaxurl;
    }
    // console.info('pnplayer_wp_send_contor_60_secs()',argcthis,argtitle);
    jQuery.ajax({
        type: "POST",
        url: theajaxurl,
        data: data,
