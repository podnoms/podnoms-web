if (!(window.pnplayer_init_calls)) {
    window.pnplayer_init_calls = [];
}
...
window.pnplayer_wavesurfer_load_attempt = 0;

window.pnplayer_player_index = 0; // -- the player index on the page

function register_pnplayer_plugin() {
    (function ($) {
        ...
        $.fn.audioplayer = function (o) {
            ...
            this.each(function () {
                ...
                var _audioplayerInner, _apControls = null,
                    ...
                    _controlsVolume, _scrubbar, _scrubbarbg_canvas, __scrubbProg, _scrubbarhover_canvas, _scrubbarprog_canvas, _theMedia, _cmedia = null,
                    _cwatermark = null,
                ...
                ;
                var inter_check, inter_checkReady, inter_check_yt_ready, inter_audiobuffer_workaround_id = 0,
                    inter_ended = 0,
                ...
                function init() {
                    ...
                    cthis.on('click', '.pnplayer-repeat-button,.pnplayer-loop-button,.btn-zoomsounds-download,.zoomsounds-btn-step-backward,.zoomsounds-btn-step-forward,.zoomsounds-btn-go-beginning,.zoomsounds-btn-slow-playback,.zoomsounds-btn-reset, .playlist-menu-item, .tooltip-indicator--btn-footer-playlist', handle_mouse);
                ...
                function icecast_shoutcast_get_data() {
                    ...
                    if (type_normal_stream_type == 'shoutcast') {
                        url = add_query_arg(o.settings_php_handler, 'action', 'pnplayer_shoutcast_get_streamtitle');
                ...
                function change_media(arg, pargs) {
                    ...
                    if (_feed_fakePlayer) {
                        // -- .feed-pnplayer-for-extra-html-right will be appended to the footer player
                ...
                function init_generate_wave_data(pargs) {
                    ...
                    if (window.WaveSurfer) {
                        ...
                        pnplayer_wavesurfer_load_attempt++;
                        if (pnplayer_wavesurfer_load_attempt > 2) {
                            url = 'https://unpkg.com/wavesurfer.js@2.1.3/dist/wavesurfer.min.js';
                        }
                        if (pnplayer_wavesurfer_load_attempt < 6) {
                            $.ajax({
                                url: url,
                                dataType: "script",
                ...
                function setup_structure(pargs) {
                    ...
                    if (o.design_skin == 'skin-wave' && skinwave_mode == 'small') {
                        ...
                        if (o.design_skin == 'skin-aria' || o.design_skin == 'skin-silver' || o.design_skin == 'skin-redlights' || o.design_skin == 'skin-steel') {
                            ...
                            if (o.design_skin == 'skin-silver') {
                                ...
                                aux_str_con_controls += '<div class="playbtn"><div class="pnplayer-play-icon">' + playbtn_svg + '</div><div class="play-icon-hover"></div></div><div class="pausebtn" ';
                    ...
                    if (settings_extrahtml_in_float_right) {
                        // aux_str_con_controls += ;
                        if (String(settings_extrahtml_in_float_right).indexOf('pnplayer-multisharer-but') > -1) {
                    ...
                    if (!_metaArtistCon || margs.call_from == 'reconstruct') {
                        ...
                        if (o.design_skin == 'skin-wave') {
                            ...
                            if (cthis.find('.pnplayer-repeat-button').length) {
                                ...
                                if (cthis.find('.pnplayer-loop-button').length && cthis.find('.pnplayer-loop-button').eq(0).parent().hasClass('feed-pnplayer-for-extra-html-right') == false) {
                    ...
                    if (cthis.hasClass('zoomsounds-wrapper-bg-bellow') && cthis.find('.pnplayer-wrapper-buts').length == 0) {
                ...
                function sync_players_goto_next() {
                    ...
                    if (_playlistTooltip && _playlistTooltip.find('.playlist-menu-item').length) {
                        ...
                        if (tempNr - 1 > _playlistTooltip.find('.playlist-menu-item').length) {} else {
                            playlist_goto_item(tempNr, {
                                'call_from': 'api_sync_players_prev'
                            });
                        }
        ...
        $.fn.audiogallery = function (o) {
            ...
            this.each(function () {
                ...
                function init() {
                    ...
                    cgallery.addClass('pnplayer-inited');
                ...
                function init_loaded() {
                    // -- gallery
                    cgallery.addClass('pnplayer-loaded');
                }
                ...
                function goto_item(arg, pargs) {
                    ...
                    if (currNr > -1) {
                        ...
                        if (o.mode_normal_video_mode == 'one') {} else {
                            if (o.settings_mode != 'mode-showall') {
...
function register_pnplayer_aux_script() {
    jQuery(document).ready(function ($) {
        ...
        $(document).on('focus.pnplayer', 'input', function () {
        ...
        pnplayer_init('.audiogallery.auto-init', {
            init_each: true
        });
        ...
        $(document).on('click', '.pnplayer-like-but', function (e) {
            ...
            window.pnplayer_submit_like(playerid, e);
            _t.removeClass('pnplayer-like-but').addClass('pnplayer-retract-like-but');
            return false;
        })
        $(document).on('click', '.pnplayer-retract-like-but', function (e) {
            var _t = $(this);
            var playerid = _t.attr('data-post_id');
            if (playerid && playerid != '0') {} else {
                if (_t.parent().parent().parent().parent().parent().hasClass('audioplayer')) {
            ...
            window.pnplayer_retract_like(playerid, e);
            _t.addClass('pnplayer-like-but').removeClass('pnplayer-retract-like-but');
            return false;
        })
...
function pnplayer_call_init_calls() {
    for (var key in window.pnplayer_init_calls) {
        window.pnplayer_init_calls[key](jQuery);
    }
    window.pnplayer_init_calls = [];
}
window.pnplayer_call_init_calls = pnplayer_call_init_calls;
if (window.jQuery) {
    register_pnplayer_plugin();
    register_pnplayer_aux_script();
    jQuery(document).ready(function ($) {
        pnplayer_call_init_calls()
    })
} else {
