...
export class PodcastsEffects {
    ...
    addPodcast$ = this.actions$
        .ofType(podcasts.ADD)
        .switchMap((action: podcasts.AddAction) =>
    ...
    getPodcast$ = this.actions$
        .ofType(podcasts.GET)
        .switchMap((action: podcasts.GetAction) =>
    ...
    @Effect()
    update$ = this.actions$
        .ofType(podcasts.UPDATE)
        .switchMap((action: podcasts.UpdateAction) =>
            this._service
    ...
    delete$ = this.actions$
        ...
        .switchMap((action: podcasts.DeleteAction) =>
            this._service
                ...
                .do((res) => this.router.navigate(['/podcasts']))
